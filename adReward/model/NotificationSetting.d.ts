...
export default class NotificationSetting implements IModel {
    ...
    getMobileNotificationMessages(): Gs2AdReward.MobileNotificationMessage[] | null;
    setMobileNotificationMessages(mobileNotificationMessages: Gs2AdReward.MobileNotificationMessage[] | null): this;
    withMobileNotificationMessages(mobileNotificationMessages: Gs2AdReward.MobileNotificationMessage[] | null): this;
