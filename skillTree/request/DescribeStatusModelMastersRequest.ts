...
export default class DescribeStatusModelMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeStatusModelMastersRequest {
