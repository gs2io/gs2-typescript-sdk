...
var Gs2SkillTreeRestClient = /** @class */ (function (_super) {
    ...
    Gs2SkillTreeRestClient.prototype.markRestrain = function (request) {
        ...
        var url = (model_1.Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/user/me/status/{propertyId}/node/restrain/mark')
            .replace('{service}', 'skill-tree')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'))
            .replace('{propertyId}', String((_c = request.getPropertyId()) !== null && _c !== void 0 ? _c : 'null') === "" ? "null" : String((_d = request.getPropertyId()) !== null && _d !== void 0 ? _d : 'null'));
        ...
        return axios_1.default.post(url, body, {
            ...
            return Result.MarkRestrainResult.fromDict(response.data);
        }).catch(function (error) {
            if (error.response) {
                throw JSON.parse(error.response.data.message);
            }
    ...
    Gs2SkillTreeRestClient.prototype.preUpdateCurrentTreeMaster = function (request) {
        ...
        return axios_1.default.post(url, body, {
            ...
            return Result.PreUpdateCurrentTreeMasterResult.fromDict(response.data);
        }).catch(function (error) {
            if (error.response) {
                throw JSON.parse(error.response.data.message);
            }
