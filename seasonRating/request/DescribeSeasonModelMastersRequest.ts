...
export default class DescribeSeasonModelMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeSeasonModelMastersRequest {
