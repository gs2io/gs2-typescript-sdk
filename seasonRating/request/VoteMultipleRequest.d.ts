...
export default class VoteMultipleRequest implements IRequest {
    ...
    getSignedBallots(): Gs2SeasonRating.SignedBallot[] | null;
    setSignedBallots(signedBallots: Gs2SeasonRating.SignedBallot[] | null): this;
    withSignedBallots(signedBallots: Gs2SeasonRating.SignedBallot[] | null): this;
