...
export default class UpdateCurrentSeasonModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): UpdateCurrentSeasonModelMasterRequest {
