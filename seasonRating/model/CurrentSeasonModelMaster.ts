...
const grnFormat: string = "grn:gs2:{region}:{ownerId}:seasonRating:{namespaceName}";

export default class CurrentSeasonModelMaster implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): CurrentSeasonModelMaster|null {
