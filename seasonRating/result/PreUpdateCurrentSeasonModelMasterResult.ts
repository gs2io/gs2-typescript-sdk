...
export default class PreUpdateCurrentSeasonModelMasterResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): PreUpdateCurrentSeasonModelMasterResult {
