...
export default class GetBallotByUserIdResult implements IResult {
    private item: Gs2SeasonRating.Ballot|null = null;
    private body: string|null = null;
    private signature: string|null = null;

    public getItem(): Gs2SeasonRating.Ballot|null {
        return this.item;
    }

    public setItem(item: Gs2SeasonRating.Ballot|null) {
        this.item = item;
        return this;
    }

    public withItem(item: Gs2SeasonRating.Ballot|null): this {
        this.item = item;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): GetBallotByUserIdResult {
