...
var CurrentDistributorMaster = /** @class */ (function () {
    ...
    CurrentDistributorMaster.getRegion = function (grn) {
    ...
    CurrentDistributorMaster.getOwnerId = function (grn) {
        var match = grn.match(grnFormat
            .replace('{region}', '.*')
            .replace('{ownerId}', '(.*)')
            .replace('{namespaceName}', '.*'));
    ...
    CurrentDistributorMaster.getNamespaceName = function (grn) {
        var match = grn.match(grnFormat
            .replace('{region}', '.*')
            .replace('{ownerId}', '.*')
            .replace('{namespaceName}', '(.*)'));
    ...
    CurrentDistributorMaster.isValid = function (grn) {
    ...
    CurrentDistributorMaster.createGrn = function (region, ownerId, namespaceName) {
        return grnFormat
...
exports.default = CurrentDistributorMaster;
