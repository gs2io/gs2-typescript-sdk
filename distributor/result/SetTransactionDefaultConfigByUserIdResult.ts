...
export default class SetTransactionDefaultConfigByUserIdResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): SetTransactionDefaultConfigByUserIdResult {
