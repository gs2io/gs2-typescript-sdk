...
export default class PreUpdateCurrentDistributorMasterResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): PreUpdateCurrentDistributorMasterResult {
