...
export default class RunVerifyTaskWithoutNamespaceResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): RunVerifyTaskWithoutNamespaceResult {
