...
export default class Gs2DistributorRestClient extends AbstractGs2RestClient {
    ...
    public createNamespace(request: Request.CreateNamespaceRequest): Promise<Result.CreateNamespaceResult> {
        ...
        const body: {[key: string]: any} = {
            ...
            'autoRunTransactionNotification': request.getAutoRunTransactionNotification()?.toDict() ?? null,
    ...
    public freezeMasterData(request: Request.FreezeMasterDataRequest): Promise<Result.FreezeMasterDataResult> {
        const url = (Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/user/me/masterdata/freeze')
            .replace('{service}', 'distributor')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String(request.getNamespaceName() ?? 'null') === "" ? "null" : String(request.getNamespaceName() ?? 'null'));
    ...
    public freezeMasterDataByUserId(request: Request.FreezeMasterDataByUserIdRequest): Promise<Result.FreezeMasterDataByUserIdResult> {
        const url = (Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/user/{userId}/masterdata/freeze')
            .replace('{service}', 'distributor')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String(request.getNamespaceName() ?? 'null') === "" ? "null" : String(request.getNamespaceName() ?? 'null'))
            .replace('{userId}', String(request.getUserId() ?? 'null') === "" ? "null" : String(request.getUserId() ?? 'null'));
    ...
    public freezeMasterDataByTimestamp(request: Request.FreezeMasterDataByTimestampRequest): Promise<Result.FreezeMasterDataByTimestampResult> {
        const url = (Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/user/me/masterdata/freeze/timestamp/raw')
            .replace('{service}', 'distributor')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String(request.getNamespaceName() ?? 'null') === "" ? "null" : String(request.getNamespaceName() ?? 'null'));
    ...
    public andExpressionByUserId(request: Request.AndExpressionByUserIdRequest): Promise<Result.AndExpressionByUserIdResult> {
        const url = (Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/expression/and')
            .replace('{service}', 'distributor')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String(request.getNamespaceName() ?? 'null') === "" ? "null" : String(request.getNamespaceName() ?? 'null'));
        ...
        const body: {[key: string]: any} = {
            'contextStack': request.getContextStack() ?? null,
            'userId': request.getUserId() ?? null,
            'actions': request.getActions()?.map((item) => item.toDict()) ?? null,
        };
        return axios.post(
            url,
            body,
    ...
    public orExpressionByUserId(request: Request.OrExpressionByUserIdRequest): Promise<Result.OrExpressionByUserIdResult> {
        const url = (Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/expression/or')
            .replace('{service}', 'distributor')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String(request.getNamespaceName() ?? 'null') === "" ? "null" : String(request.getNamespaceName() ?? 'null'));
    ...
    public runTransaction(request: Request.RunTransactionRequest): Promise<Result.RunTransactionResult> {
        const url = (Gs2Constant.ENDPOINT_HOST + '/system/{ownerId}/{namespaceName}/user/{userId}/transaction/run')
            .replace('{service}', 'distributor')
            .replace('{region}', this.session.region)
        ...
        const body: {[key: string]: any} = {
            'contextStack': request.getContextStack() ?? null,
            'transaction': request.getTransaction() ?? null,
        };
        return axios.post(
            url,
            body,
    ...
    public getTransactionResult(request: Request.GetTransactionResultRequest): Promise<Result.GetTransactionResultResult> {
        const url = (Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/user/me/transaction/{transactionId}/result')
            .replace('{service}', 'distributor')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String(request.getNamespaceName() ?? 'null') === "" ? "null" : String(request.getNamespaceName() ?? 'null'))
            .replace('{transactionId}', String(request.getTransactionId() ?? 'null') === "" ? "null" : String(request.getTransactionId() ?? 'null'));
    ...
    public getTransactionResultByUserId(request: Request.GetTransactionResultByUserIdRequest): Promise<Result.GetTransactionResultByUserIdResult> {
        const url = (Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/user/{userId}/transaction/{transactionId}/result')
            .replace('{service}', 'distributor')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String(request.getNamespaceName() ?? 'null') === "" ? "null" : String(request.getNamespaceName() ?? 'null'))
            .replace('{userId}', String(request.getUserId() ?? 'null') === "" ? "null" : String(request.getUserId() ?? 'null'))
