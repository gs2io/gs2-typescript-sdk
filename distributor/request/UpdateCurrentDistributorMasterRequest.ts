...
export default class UpdateCurrentDistributorMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): UpdateCurrentDistributorMasterRequest {
