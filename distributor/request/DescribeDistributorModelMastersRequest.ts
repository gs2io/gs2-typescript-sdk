...
export default class DescribeDistributorModelMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeDistributorModelMastersRequest {
