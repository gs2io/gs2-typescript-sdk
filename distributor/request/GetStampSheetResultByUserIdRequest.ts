...
export default class GetStampSheetResultByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetStampSheetResultByUserIdRequest {
