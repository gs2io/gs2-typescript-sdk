...
export default class RunStampSheetExpressWithoutNamespaceRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): RunStampSheetExpressWithoutNamespaceRequest {
