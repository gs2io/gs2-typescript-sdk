...
export default class SetTransactionDefaultConfigByUserIdRequest implements IRequest {
    ...
    public getConfig(): Gs2Distributor.Config[]|null {
        return this.config;
    }
    public setConfig(config: Gs2Distributor.Config[]|null) {
        this.config = config;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): SetTransactionDefaultConfigByUserIdRequest {
