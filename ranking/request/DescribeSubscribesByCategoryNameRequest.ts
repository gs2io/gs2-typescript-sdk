...
export default class DescribeSubscribesByCategoryNameRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeSubscribesByCategoryNameRequest {
