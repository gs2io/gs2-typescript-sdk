...
export default class PreUpdateCurrentRankingMasterResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): PreUpdateCurrentRankingMasterResult {
