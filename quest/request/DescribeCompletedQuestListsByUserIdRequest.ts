...
export default class DescribeCompletedQuestListsByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeCompletedQuestListsByUserIdRequest {
