...
export default class CreateQuestGroupModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): CreateQuestGroupModelMasterRequest {
