...
export default class DescribeCompletedQuestListsRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeCompletedQuestListsRequest {
