...
export default class DescribeProgressesByUserIdResult implements IResult {
    ...
    public getItems(): Gs2Quest.Progress[]|null {
        return this.items;
    }

    public setItems(items: Gs2Quest.Progress[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Quest.Progress[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2Quest.Progress) => {
                    return item.toDict();
                }
            ) : null,
