...
var CurrentQuestMaster = /** @class */ (function () {
    ...
    CurrentQuestMaster.getRegion = function (grn) {
    ...
    CurrentQuestMaster.getOwnerId = function (grn) {
        var match = grn.match(grnFormat
            .replace('{region}', '.*')
            .replace('{ownerId}', '(.*)')
            .replace('{namespaceName}', '.*'));
    ...
    CurrentQuestMaster.getNamespaceName = function (grn) {
        var match = grn.match(grnFormat
            .replace('{region}', '.*')
            .replace('{ownerId}', '.*')
            .replace('{namespaceName}', '(.*)'));
    ...
    CurrentQuestMaster.isValid = function (grn) {
    ...
    CurrentQuestMaster.createGrn = function (region, ownerId, namespaceName) {
        return grnFormat
