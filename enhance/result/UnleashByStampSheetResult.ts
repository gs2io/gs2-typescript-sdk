...
export default class UnleashByStampSheetResult implements IResult {
    private item: Gs2Enhance.UnleashRateModel|null = null;
    ...
    public getItem(): Gs2Enhance.UnleashRateModel|null {
        return this.item;
    }

    public setItem(item: Gs2Enhance.UnleashRateModel|null) {
        this.item = item;
        return this;
    }

    public withItem(item: Gs2Enhance.UnleashRateModel|null): this {
        this.item = item;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): UnleashByStampSheetResult {
