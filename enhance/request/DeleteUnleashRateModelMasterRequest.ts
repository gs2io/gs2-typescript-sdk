...
export default class DeleteUnleashRateModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteUnleashRateModelMasterRequest {
