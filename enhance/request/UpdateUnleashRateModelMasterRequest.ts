...
export default class UpdateUnleashRateModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): UpdateUnleashRateModelMasterRequest {
