...
export default class CreateProgressByStampSheetRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): CreateProgressByStampSheetRequest {
