...
export default class DescribeUnleashRateModelMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeUnleashRateModelMastersRequest {
