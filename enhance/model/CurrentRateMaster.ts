...
const grnFormat: string = "grn:gs2:{region}:{ownerId}:enhance:{namespaceName}";

export default class CurrentRateMaster implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): CurrentRateMaster|null {
