...
export default class Gs2GuildRestClient extends AbstractGs2RestClient {
    ...
    public createNamespace(request: Request.CreateNamespaceRequest): Promise<Result.CreateNamespaceResult> {
        ...
        const body: {[key: string]: any} = {
            ...
            'changeMemberNotificationIgnoreChangeMetadata': request.getChangeMemberNotificationIgnoreChangeMetadata() ?? null,
            ...
            'updateGuildScript': request.getUpdateGuildScript()?.toDict() ?? null,
            'joinGuildScript': request.getJoinGuildScript()?.toDict() ?? null,
            'receiveJoinRequestScript': request.getReceiveJoinRequestScript()?.toDict() ?? null,
