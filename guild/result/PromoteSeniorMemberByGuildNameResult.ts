...
export default class PromoteSeniorMemberByGuildNameResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): PromoteSeniorMemberByGuildNameResult {
