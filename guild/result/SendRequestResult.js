...
var SendRequestResult = /** @class */ (function () {
    ...
    SendRequestResult.prototype.getSendMemberRequest = function () {
        return this.sendMemberRequest;
    };
    SendRequestResult.prototype.setSendMemberRequest = function (sendMemberRequest) {
        this.sendMemberRequest = sendMemberRequest;
        return this;
    };
    SendRequestResult.prototype.withSendMemberRequest = function (sendMemberRequest) {
        this.sendMemberRequest = sendMemberRequest;
        return this;
    };
