...
export default class DeleteIgnoreUserByGuildNameRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteIgnoreUserByGuildNameRequest {
