...
export default class DecreaseMaximumCurrentMaximumMemberCountByGuildNameRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DecreaseMaximumCurrentMaximumMemberCountByGuildNameRequest {
