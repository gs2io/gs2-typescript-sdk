...
export default class VerifyCurrentMaximumMemberCountByStampTaskRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): VerifyCurrentMaximumMemberCountByStampTaskRequest {
