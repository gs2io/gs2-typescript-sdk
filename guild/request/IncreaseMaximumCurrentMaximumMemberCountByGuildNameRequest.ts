...
export default class IncreaseMaximumCurrentMaximumMemberCountByGuildNameRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): IncreaseMaximumCurrentMaximumMemberCountByGuildNameRequest {
