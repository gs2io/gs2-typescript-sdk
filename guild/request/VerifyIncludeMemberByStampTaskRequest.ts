...
export default class VerifyIncludeMemberByStampTaskRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): VerifyIncludeMemberByStampTaskRequest {
