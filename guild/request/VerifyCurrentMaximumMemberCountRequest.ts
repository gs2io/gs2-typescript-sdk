...
export default class VerifyCurrentMaximumMemberCountRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): VerifyCurrentMaximumMemberCountRequest {
