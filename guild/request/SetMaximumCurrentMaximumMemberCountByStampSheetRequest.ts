...
export default class SetMaximumCurrentMaximumMemberCountByStampSheetRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): SetMaximumCurrentMaximumMemberCountByStampSheetRequest {
