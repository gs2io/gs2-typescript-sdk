...
export default class IncreaseMaximumCurrentMaximumMemberCountByStampSheetRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): IncreaseMaximumCurrentMaximumMemberCountByStampSheetRequest {
