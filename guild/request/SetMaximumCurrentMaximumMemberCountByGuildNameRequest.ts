...
export default class SetMaximumCurrentMaximumMemberCountByGuildNameRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): SetMaximumCurrentMaximumMemberCountByGuildNameRequest {
