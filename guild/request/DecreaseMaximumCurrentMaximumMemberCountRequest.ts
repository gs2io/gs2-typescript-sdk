...
export default class DecreaseMaximumCurrentMaximumMemberCountRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DecreaseMaximumCurrentMaximumMemberCountRequest {
