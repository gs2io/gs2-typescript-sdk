...
export default class DecreaseMaximumCurrentMaximumMemberCountByStampTaskRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DecreaseMaximumCurrentMaximumMemberCountByStampTaskRequest {
