...
export default class PromoteSeniorMemberByGuildNameRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): PromoteSeniorMemberByGuildNameRequest {
