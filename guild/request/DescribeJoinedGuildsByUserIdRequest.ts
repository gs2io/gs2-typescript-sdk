...
export default class DescribeJoinedGuildsByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeJoinedGuildsByUserIdRequest {
