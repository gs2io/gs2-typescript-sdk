...
export default class GetLastGuildMasterActivityRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetLastGuildMasterActivityRequest {
