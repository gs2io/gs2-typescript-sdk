...
export default class PreUpdateCurrentStaminaMasterResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): PreUpdateCurrentStaminaMasterResult {
