...
export default class VerifyStaminaRecoverValueByStampTaskRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): VerifyStaminaRecoverValueByStampTaskRequest {
