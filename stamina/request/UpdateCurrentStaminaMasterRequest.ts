...
export default class UpdateCurrentStaminaMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): UpdateCurrentStaminaMasterRequest {
