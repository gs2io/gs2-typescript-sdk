...
export default class CreateRecoverValueTableMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): CreateRecoverValueTableMasterRequest {
