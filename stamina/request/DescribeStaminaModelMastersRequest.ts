...
export default class DescribeStaminaModelMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeStaminaModelMastersRequest {
