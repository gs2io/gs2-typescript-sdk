...
export default class RecoverStaminaByStampSheetRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): RecoverStaminaByStampSheetRequest {
