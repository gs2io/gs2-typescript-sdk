...
export default class VerifyStaminaRecoverIntervalMinutesByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): VerifyStaminaRecoverIntervalMinutesByUserIdRequest {
