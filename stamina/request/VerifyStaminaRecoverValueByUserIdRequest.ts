...
export default class VerifyStaminaRecoverValueByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): VerifyStaminaRecoverValueByUserIdRequest {
