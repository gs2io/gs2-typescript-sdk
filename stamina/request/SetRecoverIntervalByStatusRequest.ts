...
export default class SetRecoverIntervalByStatusRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): SetRecoverIntervalByStatusRequest {
