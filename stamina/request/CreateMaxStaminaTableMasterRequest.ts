...
export default class CreateMaxStaminaTableMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): CreateMaxStaminaTableMasterRequest {
