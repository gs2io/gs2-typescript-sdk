...
export default class VerifyStaminaRecoverIntervalMinutesRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): VerifyStaminaRecoverIntervalMinutesRequest {
