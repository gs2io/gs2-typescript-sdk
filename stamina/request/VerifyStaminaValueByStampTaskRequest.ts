...
export default class VerifyStaminaValueByStampTaskRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): VerifyStaminaValueByStampTaskRequest {
