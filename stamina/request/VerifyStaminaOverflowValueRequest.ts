...
export default class VerifyStaminaOverflowValueRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): VerifyStaminaOverflowValueRequest {
