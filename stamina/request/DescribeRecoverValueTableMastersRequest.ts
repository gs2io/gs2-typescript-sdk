...
export default class DescribeRecoverValueTableMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeRecoverValueTableMastersRequest {
