...
export default class DescribeRecoverIntervalTableMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeRecoverIntervalTableMastersRequest {
