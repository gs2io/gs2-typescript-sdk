...
export default class VerifyStaminaValueByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): VerifyStaminaValueByUserIdRequest {
