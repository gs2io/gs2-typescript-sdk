...
export default class SetRecoverIntervalByStampSheetRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): SetRecoverIntervalByStampSheetRequest {
