...
export default class VerifyStaminaMaxValueByStampTaskRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): VerifyStaminaMaxValueByStampTaskRequest {
