...
export default class DecreaseMaxValueByStampTaskRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DecreaseMaxValueByStampTaskRequest {
