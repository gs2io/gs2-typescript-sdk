...
export default class VerifyStaminaMaxValueByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): VerifyStaminaMaxValueByUserIdRequest {
