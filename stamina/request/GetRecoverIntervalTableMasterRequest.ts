...
export default class GetRecoverIntervalTableMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetRecoverIntervalTableMasterRequest {
