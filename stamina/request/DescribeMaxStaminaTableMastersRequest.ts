...
export default class DescribeMaxStaminaTableMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeMaxStaminaTableMastersRequest {
