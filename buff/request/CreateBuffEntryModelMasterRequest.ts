...
export default class CreateBuffEntryModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): CreateBuffEntryModelMasterRequest {
