...
export default class DescribeBuffEntryModelMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeBuffEntryModelMastersRequest {
