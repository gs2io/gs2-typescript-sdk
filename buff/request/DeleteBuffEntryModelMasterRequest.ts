...
export default class DeleteBuffEntryModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteBuffEntryModelMasterRequest {
