...
export default class DescribeBuffEntryModelMastersResult implements IResult {
    private items: Gs2Buff.BuffEntryModelMaster[]|null = null;
    private nextPageToken: string|null = null;

    public getItems(): Gs2Buff.BuffEntryModelMaster[]|null {
        return this.items;
    }

    public setItems(items: Gs2Buff.BuffEntryModelMaster[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Buff.BuffEntryModelMaster[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeBuffEntryModelMastersResult {
