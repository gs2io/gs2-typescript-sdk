...
export default class CreateTakeOverOpenIdConnectAndByUserIdRequest implements IRequest {
    ...
    public withIdToken(idToken: string|null): this {
        this.idToken = idToken;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): CreateTakeOverOpenIdConnectAndByUserIdRequest {
