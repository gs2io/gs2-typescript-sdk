...
export default class DeleteTakeOverTypeModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteTakeOverTypeModelMasterRequest {
