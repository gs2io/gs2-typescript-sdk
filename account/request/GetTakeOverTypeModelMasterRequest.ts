...
export default class GetTakeOverTypeModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetTakeOverTypeModelMasterRequest {
