...
export default class DeleteBnlinkRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteBnlinkRequest {
        return new DeleteBnlinkRequest()
