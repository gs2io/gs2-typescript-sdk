...
export default class RemoveBanRequest implements IRequest {
    ...
    private banStatusName: string|null = null;
    ...
    public getBanStatusName(): string|null {
        return this.banStatusName;
    }
    public setBanStatusName(banStatusName: string|null) {
        this.banStatusName = banStatusName;
        return this;
    }
    public withBanStatusName(banStatusName: string|null): this {
        this.banStatusName = banStatusName;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): RemoveBanRequest {
