...
export default class CreateTakeOverOpenIdConnectRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): CreateTakeOverOpenIdConnectRequest {
