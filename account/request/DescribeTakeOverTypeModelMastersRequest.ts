...
export default class DescribeTakeOverTypeModelMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeTakeOverTypeModelMastersRequest {
