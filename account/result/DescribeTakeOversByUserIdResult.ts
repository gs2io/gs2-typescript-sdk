...
export default class DescribeTakeOversByUserIdResult implements IResult {
    ...
    public getItems(): Gs2Account.TakeOver[]|null {
        return this.items;
    }

    public setItems(items: Gs2Account.TakeOver[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Account.TakeOver[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeTakeOversByUserIdResult {
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2Account.TakeOver) => {
                    return item.toDict();
                }
            ) : [],
