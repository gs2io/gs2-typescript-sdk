...
export default class DescribeTakeOverTypeModelMastersResult implements IResult {
    private items: Gs2Account.TakeOverTypeModelMaster[]|null = null;
    private nextPageToken: string|null = null;

    public getItems(): Gs2Account.TakeOverTypeModelMaster[]|null {
        return this.items;
    }

    public setItems(items: Gs2Account.TakeOverTypeModelMaster[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Account.TakeOverTypeModelMaster[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeTakeOverTypeModelMastersResult {
