...
var Gs2AccountRestClient = /** @class */ (function (_super) {
    ...
    Gs2AccountRestClient.prototype.describeAccounts = function (request) {
        var _a, _b, _c, _d, _e;
        var url = (model_1.Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/account')
            .replace('{service}', 'account')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'));
        var headers = this.createAuthorizedHeaders();
    ...
    Gs2AccountRestClient.prototype.updateTimeOffset = function (request) {
        ...
        var body = {
            ...
            'timeOffset': (_h = request.getTimeOffset()) !== null && _h !== void 0 ? _h : null,
        };
        return axios_1.default.put(url, body, {
            headers: headers,
        }).then(function (response) {
    ...
    Gs2AccountRestClient.prototype.updateBanned = function (request) {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        var url = (model_1.Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/account/{userId}/banned')
            .replace('{service}', 'account')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'))
            .replace('{userId}', String((_c = request.getUserId()) !== null && _c !== void 0 ? _c : 'null') === "" ? "null" : String((_d = request.getUserId()) !== null && _d !== void 0 ? _d : 'null'));
        ...
        var body = {
            'contextStack': (_g = request.getContextStack()) !== null && _g !== void 0 ? _g : null,
            'banned': (_h = request.getBanned()) !== null && _h !== void 0 ? _h : null,
        };
        return axios_1.default.put(url, body, {
            headers: headers,
        }).then(function (response) {
    ...
    Gs2AccountRestClient.prototype.addBan = function (request) {
        ...
        var url = (model_1.Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/account/{userId}/ban')
            .replace('{service}', 'account')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'))
            .replace('{userId}', String((_c = request.getUserId()) !== null && _c !== void 0 ? _c : 'null') === "" ? "null" : String((_d = request.getUserId()) !== null && _d !== void 0 ? _d : 'null'));
        ...
        var body = {
            'contextStack': (_g = request.getContextStack()) !== null && _g !== void 0 ? _g : null,
            'banStatus': (_j = (_h = request.getBanStatus()) === null || _h === void 0 ? void 0 : _h.toDict()) !== null && _j !== void 0 ? _j : null,
        };
        return axios_1.default.post(url, body, {
            headers: headers,
        }).then(function (response) {
    ...
    Gs2AccountRestClient.prototype.removeBan = function (request) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j;
        var url = (model_1.Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/account/{userId}/ban/{banStatusName}')
            .replace('{service}', 'account')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'))
            .replace('{userId}', String((_c = request.getUserId()) !== null && _c !== void 0 ? _c : 'null') === "" ? "null" : String((_d = request.getUserId()) !== null && _d !== void 0 ? _d : 'null'))
            .replace('{banStatusName}', String((_e = request.getBanStatusName()) !== null && _e !== void 0 ? _e : 'null') === "" ? "null" : String((_f = request.getBanStatusName()) !== null && _f !== void 0 ? _f : 'null'));
        var headers = this.createAuthorizedHeaders();
        if (request.getRequestId()) {
            headers['X-GS2-REQUEST-ID'] = request.getRequestId();
        }
    ...
    Gs2AccountRestClient.prototype.createTakeOverOpenIdConnect = function (request) {
        var _a, _b, _c, _d, _e, _f, _g;
        var url = (model_1.Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/account/me/takeover/openIdConnect')
            .replace('{service}', 'account')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'));
        var headers = this.createAuthorizedHeaders();
    ...
    Gs2AccountRestClient.prototype.createTakeOverOpenIdConnectAndByUserId = function (request) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j;
        var url = (model_1.Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/account/{userId}/takeover/openIdConnect')
            .replace('{service}', 'account')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'))
            .replace('{userId}', String((_c = request.getUserId()) !== null && _c !== void 0 ? _c : 'null') === "" ? "null" : String((_d = request.getUserId()) !== null && _d !== void 0 ? _d : 'null'));
        ...
        var body = {
            'contextStack': (_g = request.getContextStack()) !== null && _g !== void 0 ? _g : null,
            'type': (_h = request.getType()) !== null && _h !== void 0 ? _h : null,
            'idToken': (_j = request.getIdToken()) !== null && _j !== void 0 ? _j : null,
        };
        return axios_1.default.post(url, body, {
            headers: headers,
        }).then(function (response) {
    ...
    Gs2AccountRestClient.prototype.updateTakeOverByUserId = function (request) {
        ...
        var body = {
            'contextStack': (_j = request.getContextStack()) !== null && _j !== void 0 ? _j : null,
            'oldPassword': (_k = request.getOldPassword()) !== null && _k !== void 0 ? _k : null,
    ...
    Gs2AccountRestClient.prototype.deleteTakeOverByUserId = function (request) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j;
        var url = (model_1.Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/account/{userId}/takeover/type/{type}/takeover')
            .replace('{service}', 'account')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'))
            .replace('{userId}', String((_c = request.getUserId()) !== null && _c !== void 0 ? _c : 'null') === "" ? "null" : String((_d = request.getUserId()) !== null && _d !== void 0 ? _d : 'null'))
    ...
    Gs2AccountRestClient.prototype.doTakeOver = function (request) {
        var _a, _b, _c, _d, _e, _f, _g;
        var url = (model_1.Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/takeover/type/{type}')
            .replace('{service}', 'account')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'))
            .replace('{type}', String((_c = request.getType()) !== null && _c !== void 0 ? _c : 'null') === "" ? "null" : String((_d = request.getType()) !== null && _d !== void 0 ? _d : 'null'));
    ...
    Gs2AccountRestClient.prototype.doTakeOverOpenIdConnect = function (request) {
        var _a, _b, _c, _d, _e, _f;
        var url = (model_1.Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/takeover/type/{type}/openIdConnect')
            .replace('{service}', 'account')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'))
            .replace('{type}', String((_c = request.getType()) !== null && _c !== void 0 ? _c : 'null') === "" ? "null" : String((_d = request.getType()) !== null && _d !== void 0 ? _d : 'null'));
        ...
        var body = {
            'contextStack': (_e = request.getContextStack()) !== null && _e !== void 0 ? _e : null,
            'idToken': (_f = request.getIdToken()) !== null && _f !== void 0 ? _f : null,
        };
        return axios_1.default.post(url, body, {
            headers: headers,
        }).then(function (response) {
    ...
    Gs2AccountRestClient.prototype.getTakeOverTypeModel = function (request) {
        var _a, _b, _c, _d, _e;
        var url = (model_1.Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/model/{type}')
            .replace('{service}', 'account')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'))
            .replace('{type}', String((_c = request.getType()) !== null && _c !== void 0 ? _c : 'null') === "" ? "null" : String((_d = request.getType()) !== null && _d !== void 0 ? _d : 'null'));
    ...
    Gs2AccountRestClient.prototype.createTakeOverTypeModelMaster = function (request) {
        ...
        var body = {
            ...
            'openIdConnectSetting': (_h = (_g = request.getOpenIdConnectSetting()) === null || _g === void 0 ? void 0 : _g.toDict()) !== null && _h !== void 0 ? _h : null,
        };
        return axios_1.default.post(url, body, {
            headers: headers,
        }).then(function (response) {
    ...
    Gs2AccountRestClient.prototype.getTakeOverTypeModelMaster = function (request) {
        var _a, _b, _c, _d, _e;
        var url = (model_1.Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/master/model/{type}')
            .replace('{service}', 'account')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'))
            .replace('{type}', String((_c = request.getType()) !== null && _c !== void 0 ? _c : 'null') === "" ? "null" : String((_d = request.getType()) !== null && _d !== void 0 ? _d : 'null'));
