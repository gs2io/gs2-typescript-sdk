...
export default class Gs2AccountRestClient extends AbstractGs2RestClient {
    ...
    getAuthorizationUrl(request: Request.GetAuthorizationUrlRequest): Promise<Result.GetAuthorizationUrlResult>;
    ...
    updateDataOwnerByUserId(request: Request.UpdateDataOwnerByUserIdRequest): Promise<Result.UpdateDataOwnerByUserIdResult>;
