...
export default class QueryAccessLogResult implements IResult {
    private items: Gs2Log.AccessLog[]|null = null;
    private nextPageToken: string|null = null;
    private totalCount: number|null = null;
    private scanSize: number|null = null;

    public getItems(): Gs2Log.AccessLog[]|null {
        return this.items;
    }

    public setItems(items: Gs2Log.AccessLog[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Log.AccessLog[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): QueryAccessLogResult {
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2Log.AccessLog) => {
                    return item.toDict();
                }
            ) : null,
