...
export default class QueryExecuteStampTaskLogResult implements IResult {
    private items: Gs2Log.ExecuteStampTaskLog[]|null = null;
    private nextPageToken: string|null = null;
    private totalCount: number|null = null;
    private scanSize: number|null = null;

    public getItems(): Gs2Log.ExecuteStampTaskLog[]|null {
        return this.items;
    }

    public setItems(items: Gs2Log.ExecuteStampTaskLog[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Log.ExecuteStampTaskLog[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): QueryExecuteStampTaskLogResult {
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2Log.ExecuteStampTaskLog) => {
                    return item.toDict();
                }
            ) : [],
