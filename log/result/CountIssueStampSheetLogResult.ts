...
export default class CountIssueStampSheetLogResult implements IResult {
    private items: Gs2Log.IssueStampSheetLogCount[]|null = null;
    private nextPageToken: string|null = null;
    private totalCount: number|null = null;
    private scanSize: number|null = null;

    public getItems(): Gs2Log.IssueStampSheetLogCount[]|null {
        return this.items;
    }

    public setItems(items: Gs2Log.IssueStampSheetLogCount[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Log.IssueStampSheetLogCount[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): CountIssueStampSheetLogResult {
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2Log.IssueStampSheetLogCount) => {
                    return item.toDict();
                }
            ) : null,
