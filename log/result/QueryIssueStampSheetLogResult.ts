...
export default class QueryIssueStampSheetLogResult implements IResult {
    private items: Gs2Log.IssueStampSheetLog[]|null = null;
    private nextPageToken: string|null = null;
    private totalCount: number|null = null;
    private scanSize: number|null = null;

    public getItems(): Gs2Log.IssueStampSheetLog[]|null {
        return this.items;
    }

    public setItems(items: Gs2Log.IssueStampSheetLog[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Log.IssueStampSheetLog[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): QueryIssueStampSheetLogResult {
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2Log.IssueStampSheetLog) => {
                    return item.toDict();
                }
            ) : [],
