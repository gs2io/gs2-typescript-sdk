...
export default class CountExecuteStampTaskLogResult implements IResult {
    ...
    public getItems(): Gs2Log.ExecuteStampTaskLogCount[]|null {
        return this.items;
    }

    public setItems(items: Gs2Log.ExecuteStampTaskLogCount[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Log.ExecuteStampTaskLogCount[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): CountExecuteStampTaskLogResult {
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2Log.ExecuteStampTaskLogCount) => {
                    return item.toDict();
                }
            ) : [],
