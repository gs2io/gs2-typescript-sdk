...
export default class QueryAccessLogWithTelemetryResult implements IResult {
    private items: Gs2Log.AccessLogWithTelemetry[]|null = null;
    private nextPageToken: string|null = null;
    private totalCount: number|null = null;
    private scanSize: number|null = null;

    public getItems(): Gs2Log.AccessLogWithTelemetry[]|null {
        return this.items;
    }

    public setItems(items: Gs2Log.AccessLogWithTelemetry[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Log.AccessLogWithTelemetry[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): QueryAccessLogWithTelemetryResult {
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2Log.AccessLogWithTelemetry) => {
                    return item.toDict();
                }
            ) : null,
