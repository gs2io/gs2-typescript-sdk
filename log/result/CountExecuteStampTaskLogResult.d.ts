...
export default class CountExecuteStampTaskLogResult implements IResult {
    ...
    private totalCount;
    private scanSize;
    getItems(): Gs2Log.ExecuteStampTaskLogCount[] | null;
    setItems(items: Gs2Log.ExecuteStampTaskLogCount[] | null): this;
    withItems(items: Gs2Log.ExecuteStampTaskLogCount[] | null): this;
