...
export default class GetMissionMissionGroupModelMetricsRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetMissionMissionGroupModelMetricsRequest {
