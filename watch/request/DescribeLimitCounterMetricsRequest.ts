...
export default class DescribeLimitCounterMetricsRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeLimitCounterMetricsRequest {
