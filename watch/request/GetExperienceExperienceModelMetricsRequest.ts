...
export default class GetExperienceExperienceModelMetricsRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetExperienceExperienceModelMetricsRequest {
