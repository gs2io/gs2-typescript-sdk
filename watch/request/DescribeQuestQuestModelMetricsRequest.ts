...
export default class DescribeQuestQuestModelMetricsRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeQuestQuestModelMetricsRequest {
