...
export default class GetShowcaseShowcaseMetricsRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetShowcaseShowcaseMetricsRequest {
