...
export default class DescribeInventoryItemSetMetricsRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeInventoryItemSetMetricsRequest {
