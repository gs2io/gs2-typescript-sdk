...
export default class GetShowcaseDisplayItemMetricsRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetShowcaseDisplayItemMetricsRequest {
