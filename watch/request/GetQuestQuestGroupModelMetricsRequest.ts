...
export default class GetQuestQuestGroupModelMetricsRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetQuestQuestGroupModelMetricsRequest {
