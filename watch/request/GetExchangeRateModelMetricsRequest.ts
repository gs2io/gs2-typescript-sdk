...
export default class GetExchangeRateModelMetricsRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetExchangeRateModelMetricsRequest {
