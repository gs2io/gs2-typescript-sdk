...
export default class DescribeShowcaseDisplayItemMetricsRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeShowcaseDisplayItemMetricsRequest {
