...
export default class GetStaminaStaminaModelMetricsRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetStaminaStaminaModelMetricsRequest {
