...
export default class DescribeBillingActivitiesResult implements IResult {
    private items: Gs2Watch.BillingActivity[]|null = null;
    private nextPageToken: string|null = null;

    public getItems(): Gs2Watch.BillingActivity[]|null {
        return this.items;
    }

    public setItems(items: Gs2Watch.BillingActivity[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Watch.BillingActivity[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeBillingActivitiesResult {
