...
export default class ExchangeRateModelAmountDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): ExchangeRateModelAmountDistributionSegment|null {
