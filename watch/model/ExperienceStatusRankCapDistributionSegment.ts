...
export default class ExperienceStatusRankCapDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): ExperienceStatusRankCapDistributionSegment|null {
