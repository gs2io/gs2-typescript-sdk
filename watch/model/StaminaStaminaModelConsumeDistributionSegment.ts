...
export default class StaminaStaminaModelConsumeDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): StaminaStaminaModelConsumeDistributionSegment|null {
