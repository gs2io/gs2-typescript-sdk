...
export default class StaminaNamespaceConsumeDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): StaminaNamespaceConsumeDistributionStatistics|null {
