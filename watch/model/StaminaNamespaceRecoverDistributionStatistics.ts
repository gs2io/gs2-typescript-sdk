...
export default class StaminaNamespaceRecoverDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): StaminaNamespaceRecoverDistributionStatistics|null {
