...
export default class LimitLimitModelIncreaseAmountByUserDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): LimitLimitModelIncreaseAmountByUserDistributionSegment|null {
