...
export default class LotteryNamespaceDrawDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): LotteryNamespaceDrawDistributionStatistics|null {
