...
export default class InventoryInventoryConsumeAmountDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): InventoryInventoryConsumeAmountDistributionStatistics|null {
