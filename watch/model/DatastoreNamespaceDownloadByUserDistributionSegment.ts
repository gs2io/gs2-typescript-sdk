...
export default class DatastoreNamespaceDownloadByUserDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): DatastoreNamespaceDownloadByUserDistributionSegment|null {
