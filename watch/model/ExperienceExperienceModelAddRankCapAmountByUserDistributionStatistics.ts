...
export default class ExperienceExperienceModelAddRankCapAmountByUserDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): ExperienceExperienceModelAddRankCapAmountByUserDistributionStatistics|null {
