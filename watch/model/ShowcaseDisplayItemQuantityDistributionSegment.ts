...
export default class ShowcaseDisplayItemQuantityDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): ShowcaseDisplayItemQuantityDistributionSegment|null {
