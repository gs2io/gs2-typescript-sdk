...
const grnFormat: string = "grn:gs2:{region}:{ownerId}:watch:metrics:{year}:{month}:{day}:formation:namespace:{namespaceName}";
...
export default class FormationNamespace implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): FormationNamespace|null {
