...
export default class InventoryNamespaceConsumeDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): InventoryNamespaceConsumeDistributionStatistics|null {
