...
export default class ExchangeNamespaceExchangeAmountByUserDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): ExchangeNamespaceExchangeAmountByUserDistributionStatistics|null {
