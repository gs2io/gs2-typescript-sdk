...
export default class RankingNamespacePutDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): RankingNamespacePutDistributionStatistics|null {
