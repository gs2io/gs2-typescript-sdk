...
export default class LimitNamespaceIncreaseDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): LimitNamespaceIncreaseDistributionStatistics|null {
