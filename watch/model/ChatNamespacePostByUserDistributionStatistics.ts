...
export default class ChatNamespacePostByUserDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): ChatNamespacePostByUserDistributionStatistics|null {
