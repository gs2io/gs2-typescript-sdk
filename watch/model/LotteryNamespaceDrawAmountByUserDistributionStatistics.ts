...
export default class LotteryNamespaceDrawAmountByUserDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): LotteryNamespaceDrawAmountByUserDistributionStatistics|null {
