...
export default class InventoryItemSetCountDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): InventoryItemSetCountDistributionStatistics|null {
