...
export default class MoneyWalletPaidDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): MoneyWalletPaidDistributionStatistics|null {
