...
export default class QuestQuestModelPlayTimeSecondsDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): QuestQuestModelPlayTimeSecondsDistributionSegment|null {
