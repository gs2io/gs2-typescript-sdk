...
export default class InventoryNamespaceConsumeAmountDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): InventoryNamespaceConsumeAmountDistributionStatistics|null {
