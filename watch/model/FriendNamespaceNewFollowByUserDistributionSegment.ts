...
export default class FriendNamespaceNewFollowByUserDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): FriendNamespaceNewFollowByUserDistributionSegment|null {
