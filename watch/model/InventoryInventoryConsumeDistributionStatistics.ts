...
export default class InventoryInventoryConsumeDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): InventoryInventoryConsumeDistributionStatistics|null {
