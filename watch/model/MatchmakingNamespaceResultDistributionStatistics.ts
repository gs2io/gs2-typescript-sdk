...
export default class MatchmakingNamespaceResultDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): MatchmakingNamespaceResultDistributionStatistics|null {
