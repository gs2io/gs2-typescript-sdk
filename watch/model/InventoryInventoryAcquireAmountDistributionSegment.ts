...
export default class InventoryInventoryAcquireAmountDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): InventoryInventoryAcquireAmountDistributionSegment|null {
