...
export default class StaminaStaminaModelRecoverDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): StaminaStaminaModelRecoverDistributionSegment|null {
