...
export default class RankingCategoryModelScoreDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): RankingCategoryModelScoreDistributionSegment|null {
