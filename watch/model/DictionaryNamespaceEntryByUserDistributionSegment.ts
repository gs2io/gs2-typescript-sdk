...
export default class DictionaryNamespaceEntryByUserDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): DictionaryNamespaceEntryByUserDistributionSegment|null {
