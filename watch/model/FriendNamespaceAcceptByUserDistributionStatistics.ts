...
export default class FriendNamespaceAcceptByUserDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): FriendNamespaceAcceptByUserDistributionStatistics|null {
