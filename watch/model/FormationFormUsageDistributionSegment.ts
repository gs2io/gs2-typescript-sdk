...
export default class FormationFormUsageDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): FormationFormUsageDistributionSegment|null {
