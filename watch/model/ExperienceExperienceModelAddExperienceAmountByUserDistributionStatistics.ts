...
export default class ExperienceExperienceModelAddExperienceAmountByUserDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): ExperienceExperienceModelAddExperienceAmountByUserDistributionStatistics|null {
