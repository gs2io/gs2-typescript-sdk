...
export default class InventoryInventoryAcquireDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): InventoryInventoryAcquireDistributionStatistics|null {
