...
export default class RankingCategoryScoreDistribution implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): RankingCategoryScoreDistribution|null {
