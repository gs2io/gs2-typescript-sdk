...
export default class RankingCategoryModelScoreDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): RankingCategoryModelScoreDistributionStatistics|null {
