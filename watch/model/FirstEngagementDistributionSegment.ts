...
export default class FirstEngagementDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): FirstEngagementDistributionSegment|null {
