...
export default class MissionNamespaceIncreaseDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): MissionNamespaceIncreaseDistributionStatistics|null {
