...
const grnFormat: string = "grn:gs2:{region}:{ownerId}:watch:metrics:{year}:{month}:{day}:stamina:namespace:{namespaceName}";
...
export default class StaminaNamespace implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): StaminaNamespace|null {
