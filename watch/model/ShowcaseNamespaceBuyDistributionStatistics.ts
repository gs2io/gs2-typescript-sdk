...
export default class ShowcaseNamespaceBuyDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): ShowcaseNamespaceBuyDistributionStatistics|null {
