...
export default class InboxNamespaceSendByUserDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): InboxNamespaceSendByUserDistributionStatistics|null {
