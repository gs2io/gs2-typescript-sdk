...
export default class LotteryNamespaceDrawAmountDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): LotteryNamespaceDrawAmountDistributionStatistics|null {
