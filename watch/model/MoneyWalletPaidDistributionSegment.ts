...
export default class MoneyWalletPaidDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): MoneyWalletPaidDistributionSegment|null {
