...
export default class MissionMissionGroupModelReceiveDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): MissionMissionGroupModelReceiveDistributionStatistics|null {
