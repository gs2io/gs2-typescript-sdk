...
export default class FriendNamespaceSendRequestByUserDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): FriendNamespaceSendRequestByUserDistributionSegment|null {
