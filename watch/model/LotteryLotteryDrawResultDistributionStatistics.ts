...
export default class LotteryLotteryDrawResultDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): LotteryLotteryDrawResultDistributionStatistics|null {
