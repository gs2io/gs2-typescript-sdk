...
export default class InventoryInventoryAcquireAmountDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): InventoryInventoryAcquireAmountDistributionStatistics|null {
