...
export default class AccountNamespaceTypeDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): AccountNamespaceTypeDistributionStatistics|null {
