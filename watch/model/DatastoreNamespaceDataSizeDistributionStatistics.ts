...
export default class DatastoreNamespaceDataSizeDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): DatastoreNamespaceDataSizeDistributionStatistics|null {
