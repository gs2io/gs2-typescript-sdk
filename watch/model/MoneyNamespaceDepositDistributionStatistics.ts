...
export default class MoneyNamespaceDepositDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): MoneyNamespaceDepositDistributionStatistics|null {
