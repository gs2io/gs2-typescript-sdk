...
export default class QuestQuestGroupModelQuestDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): QuestQuestGroupModelQuestDistributionStatistics|null {
