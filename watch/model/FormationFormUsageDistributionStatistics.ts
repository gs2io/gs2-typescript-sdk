...
export default class FormationFormUsageDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): FormationFormUsageDistributionStatistics|null {
