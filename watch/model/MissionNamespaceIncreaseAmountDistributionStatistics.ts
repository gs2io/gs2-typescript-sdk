...
export default class MissionNamespaceIncreaseAmountDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): MissionNamespaceIncreaseAmountDistributionStatistics|null {
