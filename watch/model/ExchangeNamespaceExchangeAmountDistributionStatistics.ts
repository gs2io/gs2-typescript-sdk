...
export default class ExchangeNamespaceExchangeAmountDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): ExchangeNamespaceExchangeAmountDistributionStatistics|null {
