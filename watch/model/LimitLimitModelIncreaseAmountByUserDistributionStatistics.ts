...
export default class LimitLimitModelIncreaseAmountByUserDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): LimitLimitModelIncreaseAmountByUserDistributionStatistics|null {
