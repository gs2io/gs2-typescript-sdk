...
export default class InventoryNamespaceIncreaseCapacityAmountDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): InventoryNamespaceIncreaseCapacityAmountDistributionStatistics|null {
