...
export default class LimitLimitModelIncreaseByUserDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): LimitLimitModelIncreaseByUserDistributionSegment|null {
