...
export default class ExchangeRateModelAmountDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): ExchangeRateModelAmountDistributionStatistics|null {
