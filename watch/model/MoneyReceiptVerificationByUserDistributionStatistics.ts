...
export default class MoneyReceiptVerificationByUserDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): MoneyReceiptVerificationByUserDistributionStatistics|null {
