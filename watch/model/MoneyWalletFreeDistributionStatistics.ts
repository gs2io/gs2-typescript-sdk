...
export default class MoneyWalletFreeDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): MoneyWalletFreeDistributionStatistics|null {
