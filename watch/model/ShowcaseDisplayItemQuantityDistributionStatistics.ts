...
export default class ShowcaseDisplayItemQuantityDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): ShowcaseDisplayItemQuantityDistributionStatistics|null {
