...
export default class InventoryInventoryCapacityDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): InventoryInventoryCapacityDistributionStatistics|null {
