...
export default class DatastoreNamespaceUploadByUserDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): DatastoreNamespaceUploadByUserDistributionStatistics|null {
