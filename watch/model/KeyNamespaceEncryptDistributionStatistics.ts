...
export default class KeyNamespaceEncryptDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): KeyNamespaceEncryptDistributionStatistics|null {
