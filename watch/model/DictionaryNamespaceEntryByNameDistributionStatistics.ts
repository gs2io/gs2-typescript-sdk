...
export default class DictionaryNamespaceEntryByNameDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): DictionaryNamespaceEntryByNameDistributionStatistics|null {
