...
export default class MatchmakingNamespaceWaitElapsedSecondsDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): MatchmakingNamespaceWaitElapsedSecondsDistributionSegment|null {
