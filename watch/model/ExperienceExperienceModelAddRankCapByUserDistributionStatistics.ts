...
export default class ExperienceExperienceModelAddRankCapByUserDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): ExperienceExperienceModelAddRankCapByUserDistributionStatistics|null {
