...
export default class FormationMoldCapacityDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): FormationMoldCapacityDistributionStatistics|null {
