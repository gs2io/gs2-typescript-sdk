...
export default class FriendNamespaceRejectByUserDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): FriendNamespaceRejectByUserDistributionStatistics|null {
