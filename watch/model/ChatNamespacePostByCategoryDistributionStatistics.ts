...
export default class ChatNamespacePostByCategoryDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): ChatNamespacePostByCategoryDistributionStatistics|null {
