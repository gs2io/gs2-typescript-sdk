...
export default class QuestQuestModelPlayTimeSecondsDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): QuestQuestModelPlayTimeSecondsDistributionStatistics|null {
