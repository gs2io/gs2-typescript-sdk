...
export default class ExperienceNamespaceAddExperienceByExperienceDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): ExperienceNamespaceAddExperienceByExperienceDistributionStatistics|null {
