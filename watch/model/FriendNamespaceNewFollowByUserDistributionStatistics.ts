...
export default class FriendNamespaceNewFollowByUserDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): FriendNamespaceNewFollowByUserDistributionStatistics|null {
