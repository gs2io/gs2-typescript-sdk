...
export default class LimitLimitModelIncreaseAmountDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): LimitLimitModelIncreaseAmountDistributionStatistics|null {
