...
export default class MoneyNamespaceRevenueDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): MoneyNamespaceRevenueDistributionStatistics|null {
