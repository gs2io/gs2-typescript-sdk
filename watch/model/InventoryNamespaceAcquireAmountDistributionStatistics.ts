...
export default class InventoryNamespaceAcquireAmountDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): InventoryNamespaceAcquireAmountDistributionStatistics|null {
