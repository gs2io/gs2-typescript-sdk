...
export default class MissionCounterCounterDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): MissionCounterCounterDistributionStatistics|null {
