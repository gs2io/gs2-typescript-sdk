...
export default class DictionaryNamespaceEntryByUserDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): DictionaryNamespaceEntryByUserDistributionStatistics|null {
