...
export default class StaminaStaminaModelRecoverDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): StaminaStaminaModelRecoverDistributionStatistics|null {
