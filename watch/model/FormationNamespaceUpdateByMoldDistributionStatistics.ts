...
export default class FormationNamespaceUpdateByMoldDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): FormationNamespaceUpdateByMoldDistributionStatistics|null {
