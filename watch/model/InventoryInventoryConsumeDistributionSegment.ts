...
export default class InventoryInventoryConsumeDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): InventoryInventoryConsumeDistributionSegment|null {
