...
export default class ExchangeNamespaceExchangeAmountByUserDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): ExchangeNamespaceExchangeAmountByUserDistributionSegment|null {
