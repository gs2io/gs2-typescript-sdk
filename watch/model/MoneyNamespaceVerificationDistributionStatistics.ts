...
export default class MoneyNamespaceVerificationDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): MoneyNamespaceVerificationDistributionStatistics|null {
