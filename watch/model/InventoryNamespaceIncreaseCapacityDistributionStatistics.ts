...
export default class InventoryNamespaceIncreaseCapacityDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): InventoryNamespaceIncreaseCapacityDistributionStatistics|null {
