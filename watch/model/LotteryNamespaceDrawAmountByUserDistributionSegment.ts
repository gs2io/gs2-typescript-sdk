...
export default class LotteryNamespaceDrawAmountByUserDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): LotteryNamespaceDrawAmountByUserDistributionSegment|null {
