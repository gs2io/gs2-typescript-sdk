...
export default class ExperienceExperienceModelAddExperienceByUserDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): ExperienceExperienceModelAddExperienceByUserDistributionStatistics|null {
