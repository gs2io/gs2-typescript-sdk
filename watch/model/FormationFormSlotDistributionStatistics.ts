...
export default class FormationFormSlotDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): FormationFormSlotDistributionStatistics|null {
