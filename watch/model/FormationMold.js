...
var grnFormat = "grn:gs2:{region}:{ownerId}:watch:metrics:{year}:{month}:{day}:formation:namespace:{namespaceName}:mold:{moldName}";
var FormationMold = /** @class */ (function () {
    ...
    FormationMold.getMoldName = function (grn) {
        var match = grn.match(grnFormat
            .replace('{region}', '.*')
            .replace('{ownerId}', '.*')
            .replace('{year}', '.*')
    ...
    FormationMold.createGrn = function (region, ownerId, year, month, day, namespaceName, moldName) {
        return grnFormat
    ...
    FormationMold.prototype.getMoldName = function () {
        return this.moldName;
    };
    FormationMold.prototype.setMoldName = function (moldName) {
        this.moldName = moldName;
        return this;
    };
    FormationMold.prototype.withMoldName = function (moldName) {
        this.moldName = moldName;
        return this;
    };
