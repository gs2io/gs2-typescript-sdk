...
export default class InventoryInventoryCapacityDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): InventoryInventoryCapacityDistributionSegment|null {
