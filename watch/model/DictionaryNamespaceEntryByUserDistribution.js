...
var DictionaryNamespaceEntryByUserDistribution = /** @class */ (function () {
    ...
    DictionaryNamespaceEntryByUserDistribution.fromDict = function (data) {
        ...
        return new DictionaryNamespaceEntryByUserDistribution()
            .withStatistics(DictionaryNamespaceEntryByUserDistributionStatistics_1.default.fromDict(data["statistics"]))
            .withDistribution(data.distribution ?
            data.distribution.map(function (item) {
                return DictionaryNamespaceEntryByUserDistributionSegment_1.default.fromDict(item);
            }) : []);
    };
