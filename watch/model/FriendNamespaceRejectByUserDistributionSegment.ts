...
export default class FriendNamespaceRejectByUserDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): FriendNamespaceRejectByUserDistributionSegment|null {
