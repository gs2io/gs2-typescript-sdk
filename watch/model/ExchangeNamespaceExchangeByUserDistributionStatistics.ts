...
export default class ExchangeNamespaceExchangeByUserDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): ExchangeNamespaceExchangeByUserDistributionStatistics|null {
