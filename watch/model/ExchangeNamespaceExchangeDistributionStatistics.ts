...
export default class ExchangeNamespaceExchangeDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): ExchangeNamespaceExchangeDistributionStatistics|null {
