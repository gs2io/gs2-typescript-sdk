...
export default class DatastoreNamespaceDataSizeDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): DatastoreNamespaceDataSizeDistributionSegment|null {
