...
const grnFormat: string = "grn:gs2:{region}:{ownerId}:watch:metrics:{year}:{month}:{day}:key:namespace:{namespaceName}";
...
export default class KeyNamespace implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): KeyNamespace|null {
