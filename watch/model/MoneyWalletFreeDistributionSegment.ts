...
export default class MoneyWalletFreeDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): MoneyWalletFreeDistributionSegment|null {
