...
export default class DatastoreNamespaceDownloadByUserDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): DatastoreNamespaceDownloadByUserDistributionStatistics|null {
