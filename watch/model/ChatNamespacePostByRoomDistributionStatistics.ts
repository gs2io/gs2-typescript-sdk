...
export default class ChatNamespacePostByRoomDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): ChatNamespacePostByRoomDistributionStatistics|null {
