...
export default class DatastoreNamespaceUploadByUserDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): DatastoreNamespaceUploadByUserDistributionSegment|null {
