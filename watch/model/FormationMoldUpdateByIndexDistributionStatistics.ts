...
export default class FormationMoldUpdateByIndexDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): FormationMoldUpdateByIndexDistributionStatistics|null {
