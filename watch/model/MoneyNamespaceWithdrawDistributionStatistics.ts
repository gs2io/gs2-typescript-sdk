...
export default class MoneyNamespaceWithdrawDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): MoneyNamespaceWithdrawDistributionStatistics|null {
