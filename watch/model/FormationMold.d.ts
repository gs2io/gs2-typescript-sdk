...
export default class FormationMold implements IModel {
    ...
    static createGrn(region: string | null, ownerId: string | null, year: string | null, month: string | null, day: string | null, namespaceName: string | null, moldName: string | null): string | null;
