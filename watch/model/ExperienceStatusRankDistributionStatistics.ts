...
export default class ExperienceStatusRankDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): ExperienceStatusRankDistributionStatistics|null {
