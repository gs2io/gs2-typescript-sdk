...
export default class FriendNamespaceAcceptByUserDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): FriendNamespaceAcceptByUserDistributionSegment|null {
