...
export default class LimitLimitModelIncreaseByUserDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): LimitLimitModelIncreaseByUserDistributionStatistics|null {
