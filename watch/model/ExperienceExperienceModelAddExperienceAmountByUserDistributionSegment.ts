...
export default class ExperienceExperienceModelAddExperienceAmountByUserDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): ExperienceExperienceModelAddExperienceAmountByUserDistributionSegment|null {
