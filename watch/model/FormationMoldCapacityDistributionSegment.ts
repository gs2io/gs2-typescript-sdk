...
export default class FormationMoldCapacityDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): FormationMoldCapacityDistributionSegment|null {
