...
const grnFormat: string = "grn:gs2:{region}:{ownerId}:watch:metrics:{year}:{month}:{day}:chat:namespace:{namespaceName}";
...
export default class ChatNamespace implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): ChatNamespace|null {
