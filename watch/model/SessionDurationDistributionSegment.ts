...
export default class SessionDurationDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): SessionDurationDistributionSegment|null {
