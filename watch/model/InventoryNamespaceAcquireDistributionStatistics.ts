...
export default class InventoryNamespaceAcquireDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): InventoryNamespaceAcquireDistributionStatistics|null {
