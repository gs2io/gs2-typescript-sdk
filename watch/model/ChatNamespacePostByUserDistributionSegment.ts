...
export default class ChatNamespacePostByUserDistributionSegment implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): ChatNamespacePostByUserDistributionSegment|null {
