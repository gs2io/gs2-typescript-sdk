...
export default class QuestNamespaceQuestDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): QuestNamespaceQuestDistributionStatistics|null {
