...
export default class MatchmakingNamespaceWaitElapsedSecondsDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): MatchmakingNamespaceWaitElapsedSecondsDistributionStatistics|null {
