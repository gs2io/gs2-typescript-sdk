...
export default class KeyNamespaceDecryptDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): KeyNamespaceDecryptDistributionStatistics|null {
