...
export default class FriendNamespaceSendRequestByUserDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): FriendNamespaceSendRequestByUserDistributionStatistics|null {
