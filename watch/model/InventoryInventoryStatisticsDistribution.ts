...
export default class InventoryInventoryStatisticsDistribution implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): InventoryInventoryStatisticsDistribution|null {
