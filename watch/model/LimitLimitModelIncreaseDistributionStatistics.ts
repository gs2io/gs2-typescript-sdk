...
export default class LimitLimitModelIncreaseDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): LimitLimitModelIncreaseDistributionStatistics|null {
