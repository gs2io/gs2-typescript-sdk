...
export default class ExperienceNamespaceAddRankCapByExperienceDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): ExperienceNamespaceAddRankCapByExperienceDistributionStatistics|null {
