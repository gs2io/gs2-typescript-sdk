...
export default class InboxNamespaceReadElapsedMinutesDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): InboxNamespaceReadElapsedMinutesDistributionStatistics|null {
