...
export default class LotteryNamespaceDrawByUserDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): LotteryNamespaceDrawByUserDistributionStatistics|null {
