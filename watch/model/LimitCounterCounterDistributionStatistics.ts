...
export default class LimitCounterCounterDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): LimitCounterCounterDistributionStatistics|null {
