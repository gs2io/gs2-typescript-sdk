...
export default class ExperienceStatusRankCapDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): ExperienceStatusRankCapDistributionStatistics|null {
