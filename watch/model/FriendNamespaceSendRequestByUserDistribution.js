...
var FriendNamespaceSendRequestByUserDistribution = /** @class */ (function () {
    ...
    FriendNamespaceSendRequestByUserDistribution.fromDict = function (data) {
        ...
        return new FriendNamespaceSendRequestByUserDistribution()
            .withStatistics(FriendNamespaceSendRequestByUserDistributionStatistics_1.default.fromDict(data["statistics"]))
            .withDistribution(data.distribution ?
            data.distribution.map(function (item) {
                return FriendNamespaceSendRequestByUserDistributionSegment_1.default.fromDict(item);
            }) : []);
    };
