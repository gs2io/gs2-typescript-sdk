...
export default class FormationNamespaceIncreaseCapacityByMoldDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): FormationNamespaceIncreaseCapacityByMoldDistributionStatistics|null {
