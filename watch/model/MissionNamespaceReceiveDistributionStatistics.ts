...
export default class MissionNamespaceReceiveDistributionStatistics implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): MissionNamespaceReceiveDistributionStatistics|null {
