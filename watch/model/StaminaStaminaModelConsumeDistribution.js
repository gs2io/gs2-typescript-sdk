...
var StaminaStaminaModelConsumeDistribution = /** @class */ (function () {
    ...
    StaminaStaminaModelConsumeDistribution.fromDict = function (data) {
        ...
        return new StaminaStaminaModelConsumeDistribution()
            .withStatistics(StaminaStaminaModelConsumeDistributionStatistics_1.default.fromDict(data["statistics"]))
            .withDistribution(data.distribution ?
            data.distribution.map(function (item) {
                return StaminaStaminaModelConsumeDistributionSegment_1.default.fromDict(item);
            }) : []);
    };
