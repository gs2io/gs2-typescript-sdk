...
export default class FirstEngagementStatisticsLoginDays implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): FirstEngagementStatisticsLoginDays|null {
