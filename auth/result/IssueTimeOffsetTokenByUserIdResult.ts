...
export default class IssueTimeOffsetTokenByUserIdResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): IssueTimeOffsetTokenByUserIdResult {
