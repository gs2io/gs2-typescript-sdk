...
export default class FederationRequest implements IRequest {
    ...
    private originalUserId: string|null = null;
    ...
    public setOriginalUserId(originalUserId: string|null) {
        this.originalUserId = originalUserId;
        return this;
    }
    public withOriginalUserId(originalUserId: string|null): this {
        this.originalUserId = originalUserId;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): FederationRequest {
