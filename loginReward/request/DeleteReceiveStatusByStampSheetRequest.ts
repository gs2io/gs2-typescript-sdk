...
export default class DeleteReceiveStatusByStampSheetRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteReceiveStatusByStampSheetRequest {
