...
export default class DeleteReceiveStatusByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteReceiveStatusByUserIdRequest {
