...
export default class UnmarkReceivedByStampSheetRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): UnmarkReceivedByStampSheetRequest {
