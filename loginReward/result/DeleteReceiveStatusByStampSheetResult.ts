...
export default class DeleteReceiveStatusByStampSheetResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteReceiveStatusByStampSheetResult {
