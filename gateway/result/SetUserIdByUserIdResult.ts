...
export default class SetUserIdByUserIdResult implements IResult {
    ...
    public setItem(item: Gs2Gateway.WebSocketSession|null) {
        this.item = item;
        return this;
    }

    public withItem(item: Gs2Gateway.WebSocketSession|null): this {
        this.item = item;
        return this;
    }

    public static fromDict(data: {[key: string]: any}): SetUserIdByUserIdResult {
