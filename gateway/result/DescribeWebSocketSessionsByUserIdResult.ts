...
export default class DescribeWebSocketSessionsByUserIdResult implements IResult {
    private items: Gs2Gateway.WebSocketSession[]|null = null;
    private nextPageToken: string|null = null;

    public getItems(): Gs2Gateway.WebSocketSession[]|null {
        return this.items;
    }

    public setItems(items: Gs2Gateway.WebSocketSession[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Gateway.WebSocketSession[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeWebSocketSessionsByUserIdResult {
