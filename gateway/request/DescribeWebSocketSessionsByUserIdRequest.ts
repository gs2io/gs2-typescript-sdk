...
export default class DescribeWebSocketSessionsByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeWebSocketSessionsByUserIdRequest {
