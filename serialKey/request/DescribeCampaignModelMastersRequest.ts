...
export default class DescribeCampaignModelMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeCampaignModelMastersRequest {
