...
export default class DescribeIssueJobsResult implements IResult {
    private items: Gs2SerialKey.IssueJob[]|null = null;
    private nextPageToken: string|null = null;

    public getItems(): Gs2SerialKey.IssueJob[]|null {
        return this.items;
    }

    public setItems(items: Gs2SerialKey.IssueJob[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2SerialKey.IssueJob[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeIssueJobsResult {
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2SerialKey.IssueJob) => {
                    return item.toDict();
                }
            ) : [],
