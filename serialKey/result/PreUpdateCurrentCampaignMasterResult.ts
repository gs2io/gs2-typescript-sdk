...
export default class PreUpdateCurrentCampaignMasterResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): PreUpdateCurrentCampaignMasterResult {
