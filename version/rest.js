...
var Gs2VersionRestClient = /** @class */ (function (_super) {
    __extends(Gs2VersionRestClient, _super);
    ...
    Gs2VersionRestClient.prototype.createNamespace = function (request) {
        ...
        var body = {
            ...
            'acceptVersionScript': (_f = (_e = request.getAcceptVersionScript()) === null || _e === void 0 ? void 0 : _e.toDict()) !== null && _f !== void 0 ? _f : null,
            'checkVersionTriggerScriptId': (_g = request.getCheckVersionTriggerScriptId()) !== null && _g !== void 0 ? _g : null,
    ...
    Gs2VersionRestClient.prototype.updateNamespace = function (request) {
        ...
        var body = {
            ...
            'acceptVersionScript': (_g = (_f = request.getAcceptVersionScript()) === null || _f === void 0 ? void 0 : _f.toDict()) !== null && _g !== void 0 ? _g : null,
            'checkVersionTriggerScriptId': (_h = request.getCheckVersionTriggerScriptId()) !== null && _h !== void 0 ? _h : null,
    ...
    Gs2VersionRestClient.prototype.describeVersionModelMasters = function (request) {
        var _a, _b, _c, _d, _e;
        var url = (Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/master/version')
            .replace('{service}', 'version')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'));
        var headers = this.createAuthorizedHeaders();
    ...
    Gs2VersionRestClient.prototype.getVersionModelMaster = function (request) {
        var _a, _b, _c, _d, _e;
        var url = (Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/master/version/{versionName}')
            .replace('{service}', 'version')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'))
            .replace('{versionName}', String((_c = request.getVersionName()) !== null && _c !== void 0 ? _c : 'null') === "" ? "null" : String((_d = request.getVersionName()) !== null && _d !== void 0 ? _d : 'null'));
        var headers = this.createAuthorizedHeaders();
        if (request.getRequestId()) {
            headers['X-GS2-REQUEST-ID'] = request.getRequestId();
        }
    ...
    Gs2VersionRestClient.prototype.describeVersionModels = function (request) {
        var _a, _b, _c;
        var url = (Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/version')
            .replace('{service}', 'version')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'));
        var headers = this.createAuthorizedHeaders();
    ...
    Gs2VersionRestClient.prototype.getVersionModel = function (request) {
        var _a, _b, _c, _d, _e;
        var url = (Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/version/{versionName}')
            .replace('{service}', 'version')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'))
            .replace('{versionName}', String((_c = request.getVersionName()) !== null && _c !== void 0 ? _c : 'null') === "" ? "null" : String((_d = request.getVersionName()) !== null && _d !== void 0 ? _d : 'null'));
    ...
    Gs2VersionRestClient.prototype.describeAcceptVersions = function (request) {
        ...
        var url = (Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/user/me/acceptVersion')
            .replace('{service}', 'version')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'));
        var headers = this.createAuthorizedHeaders();
    ...
    Gs2VersionRestClient.prototype.describeAcceptVersionsByUserId = function (request) {
        var _a, _b, _c, _d, _e, _f;
        var url = (Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/acceptVersion')
            .replace('{service}', 'version')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'));
        var headers = this.createAuthorizedHeaders();
    ...
    Gs2VersionRestClient.prototype.acceptByUserId = function (request) {
        var _a, _b, _c, _d, _e, _f;
        var url = (Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/user/{userId}/acceptVersion')
            .replace('{service}', 'version')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'))
    ...
    Gs2VersionRestClient.prototype.getAcceptVersion = function (request) {
        var _a, _b, _c, _d, _e, _f;
        var url = (Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/user/me/{versionName}')
            .replace('{service}', 'version')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'))
            .replace('{versionName}', String((_c = request.getVersionName()) !== null && _c !== void 0 ? _c : 'null') === "" ? "null" : String((_d = request.getVersionName()) !== null && _d !== void 0 ? _d : 'null'));
    ...
    Gs2VersionRestClient.prototype.getAcceptVersionByUserId = function (request) {
        ...
        var url = (Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/user/{userId}/{versionName}')
            .replace('{service}', 'version')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'))
            .replace('{userId}', String((_c = request.getUserId()) !== null && _c !== void 0 ? _c : 'null') === "" ? "null" : String((_d = request.getUserId()) !== null && _d !== void 0 ? _d : 'null'))
            .replace('{versionName}', String((_e = request.getVersionName()) !== null && _e !== void 0 ? _e : 'null') === "" ? "null" : String((_f = request.getVersionName()) !== null && _f !== void 0 ? _f : 'null'));
        var headers = this.createAuthorizedHeaders();
        if (request.getRequestId()) {
            headers['X-GS2-REQUEST-ID'] = request.getRequestId();
        }
    ...
    Gs2VersionRestClient.prototype.checkVersion = function (request) {
        var _a, _b, _c, _d, _e, _f;
        var url = (Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/user/me/check')
            .replace('{service}', 'version')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'));
        var headers = this.createAuthorizedHeaders();
    ...
    Gs2VersionRestClient.prototype.checkVersionByUserId = function (request) {
        var _a, _b, _c, _d, _e, _f, _g;
        var url = (Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/user/{userId}/check')
            .replace('{service}', 'version')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'))
            .replace('{userId}', String((_c = request.getUserId()) !== null && _c !== void 0 ? _c : 'null') === "" ? "null" : String((_d = request.getUserId()) !== null && _d !== void 0 ? _d : 'null'));
    ...
    Gs2VersionRestClient.prototype.calculateSignature = function (request) {
        var _a, _b, _c, _d, _e, _f, _g;
        var url = (Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/version/{versionName}/calculate/signature')
            .replace('{service}', 'version')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'))
            .replace('{versionName}', String((_c = request.getVersionName()) !== null && _c !== void 0 ? _c : 'null') === "" ? "null" : String((_d = request.getVersionName()) !== null && _d !== void 0 ? _d : 'null'));
        ...
        var body = {
            'contextStack': (_e = request.getContextStack()) !== null && _e !== void 0 ? _e : null,
            'version': (_g = (_f = request.getVersion()) === null || _f === void 0 ? void 0 : _f.toDict()) !== null && _g !== void 0 ? _g : null,
        };
        return axios.post(url, body, {
            headers: headers,
        }).then(function (response) {
...
export default Gs2VersionRestClient;
