...
export default class GetBneAgreementUrlByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetBneAgreementUrlByUserIdRequest {
        return new GetBneAgreementUrlByUserIdRequest()
