...
export default class DescribeVersionModelMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeVersionModelMastersRequest {
