...
export default class GetBneAgreementByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetBneAgreementByUserIdRequest {
        return new GetBneAgreementByUserIdRequest()
