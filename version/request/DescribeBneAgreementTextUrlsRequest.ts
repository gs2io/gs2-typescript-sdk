...
export default class DescribeBneAgreementTextUrlsRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeBneAgreementTextUrlsRequest {
        return new DescribeBneAgreementTextUrlsRequest()
