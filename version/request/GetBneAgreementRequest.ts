...
export default class GetBneAgreementRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetBneAgreementRequest {
        return new GetBneAgreementRequest()
