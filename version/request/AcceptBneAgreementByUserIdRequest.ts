...
export default class AcceptBneAgreementByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): AcceptBneAgreementByUserIdRequest {
        return new AcceptBneAgreementByUserIdRequest()
