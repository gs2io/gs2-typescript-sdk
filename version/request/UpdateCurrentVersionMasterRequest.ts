...
export default class UpdateCurrentVersionMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): UpdateCurrentVersionMasterRequest {
