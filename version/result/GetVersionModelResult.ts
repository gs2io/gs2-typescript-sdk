...
export default class GetVersionModelResult implements IResult {
    ...
    public setItem(item: Gs2Version.VersionModel|null) {
        this.item = item;
        return this;
    }

    public withItem(item: Gs2Version.VersionModel|null): this {
        this.item = item;
        return this;
    }

    public static fromDict(data: {[key: string]: any}): GetVersionModelResult {
