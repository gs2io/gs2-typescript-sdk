...
var DescribeStatusesByUserIdRequest = /** @class */ (function () {
    ...
    DescribeStatusesByUserIdRequest.prototype.getStatus = function () {
        return this.status;
    };
    DescribeStatusesByUserIdRequest.prototype.setStatus = function (status) {
        this.status = status;
        return this;
    };
    DescribeStatusesByUserIdRequest.prototype.withStatus = function (status) {
        this.status = status;
        return this;
    };
