...
export default class ReportRequest implements IRequest {
    ...
    private events: Gs2StateMachine.Event[]|null = null;
    ...
    public getEvents(): Gs2StateMachine.Event[]|null {
        return this.events;
    }
    public setEvents(events: Gs2StateMachine.Event[]|null) {
        this.events = events;
        return this;
    }
    public withEvents(events: Gs2StateMachine.Event[]|null): this {
        this.events = events;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): ReportRequest {
