...
var DescribeStatusesRequest = /** @class */ (function () {
    ...
    DescribeStatusesRequest.prototype.getStatus = function () {
        return this.status;
    };
    DescribeStatusesRequest.prototype.setStatus = function (status) {
        this.status = status;
        return this;
    };
    DescribeStatusesRequest.prototype.withStatus = function (status) {
        this.status = status;
        return this;
    };
