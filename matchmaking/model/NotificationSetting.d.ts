...
export default class NotificationSetting implements IModel {
    ...
    getMobileNotificationMessages(): Gs2Matchmaking.MobileNotificationMessage[] | null;
    setMobileNotificationMessages(mobileNotificationMessages: Gs2Matchmaking.MobileNotificationMessage[] | null): this;
    withMobileNotificationMessages(mobileNotificationMessages: Gs2Matchmaking.MobileNotificationMessage[] | null): this;
