...
const grnFormat: string = "grn:gs2:{region}:{ownerId}:matchmaking:{namespaceName}:model:{seasonName}";
...
export default class SeasonModelMaster implements IModel {
    ...
    private maximumParticipants: number|null = null;
    ...
    public getMaximumParticipants(): number|null {
        return this.maximumParticipants;
    }
    public setMaximumParticipants(maximumParticipants: number|null) {
        this.maximumParticipants = maximumParticipants;
        return this;
    }
    public withMaximumParticipants(maximumParticipants: number|null): this {
        this.maximumParticipants = maximumParticipants;
        return this;
    }
