...
var CurrentRatingModelMaster = /** @class */ (function () {
    ...
    CurrentRatingModelMaster.getRegion = function (grn) {
    ...
    CurrentRatingModelMaster.getOwnerId = function (grn) {
        var match = grn.match(grnFormat
            .replace('{region}', '.*')
            .replace('{ownerId}', '(.*)')
            .replace('{namespaceName}', '.*'));
    ...
    CurrentRatingModelMaster.getNamespaceName = function (grn) {
        var match = grn.match(grnFormat
            .replace('{region}', '.*')
            .replace('{ownerId}', '.*')
            .replace('{namespaceName}', '(.*)'));
    ...
    CurrentRatingModelMaster.isValid = function (grn) {
    ...
    CurrentRatingModelMaster.createGrn = function (region, ownerId, namespaceName) {
        return grnFormat
...
exports.default = CurrentRatingModelMaster;
