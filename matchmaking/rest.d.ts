...
export default class Gs2MatchmakingRestClient extends AbstractGs2RestClient {
    ...
    getCurrentRatingModelMaster(request: Request.GetCurrentRatingModelMasterRequest): Promise<Result.GetCurrentRatingModelMasterResult>;
    updateCurrentRatingModelMaster(request: Request.UpdateCurrentRatingModelMasterRequest): Promise<Result.UpdateCurrentRatingModelMasterResult>;
    updateCurrentRatingModelMasterFromGitHub(request: Request.UpdateCurrentRatingModelMasterFromGitHubRequest): Promise<Result.UpdateCurrentRatingModelMasterFromGitHubResult>;
