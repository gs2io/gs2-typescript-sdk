...
export default class UpdateCurrentRatingModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): UpdateCurrentRatingModelMasterRequest {
