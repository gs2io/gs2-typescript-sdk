...
export default class DescribeJoinedSeasonGatheringsByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeJoinedSeasonGatheringsByUserIdRequest {
