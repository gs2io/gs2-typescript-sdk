...
export default class VerifyIncludeParticipantByStampTaskRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): VerifyIncludeParticipantByStampTaskRequest {
