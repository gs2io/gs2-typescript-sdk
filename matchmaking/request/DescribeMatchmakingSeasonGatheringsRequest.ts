...
export default class DescribeMatchmakingSeasonGatheringsRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeMatchmakingSeasonGatheringsRequest {
