...
export default class DescribeJoinedSeasonGatheringsRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeJoinedSeasonGatheringsRequest {
