...
export default class DescribeRatingModelMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeRatingModelMastersRequest {
