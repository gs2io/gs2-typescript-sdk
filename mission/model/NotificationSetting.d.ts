...
export default class NotificationSetting implements IModel {
    ...
    getMobileNotificationMessages(): Gs2Mission.MobileNotificationMessage[] | null;
    setMobileNotificationMessages(mobileNotificationMessages: Gs2Mission.MobileNotificationMessage[] | null): this;
    withMobileNotificationMessages(mobileNotificationMessages: Gs2Mission.MobileNotificationMessage[] | null): this;
