...
export default class DescribeMissionGroupModelMastersResult implements IResult {
    private items: Gs2Mission.MissionGroupModelMaster[]|null = null;
    private nextPageToken: string|null = null;

    public getItems(): Gs2Mission.MissionGroupModelMaster[]|null {
        return this.items;
    }

    public setItems(items: Gs2Mission.MissionGroupModelMaster[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Mission.MissionGroupModelMaster[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeMissionGroupModelMastersResult {
