...
export default class PreUpdateCurrentMissionMasterResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): PreUpdateCurrentMissionMasterResult {
