...
export default class CreateMissionGroupModelMasterResult implements IResult {
    ...
    public setItem(item: Gs2Mission.MissionGroupModelMaster|null) {
        this.item = item;
        return this;
    }

    public withItem(item: Gs2Mission.MissionGroupModelMaster|null): this {
        this.item = item;
        return this;
    }

    public static fromDict(data: {[key: string]: any}): CreateMissionGroupModelMasterResult {
