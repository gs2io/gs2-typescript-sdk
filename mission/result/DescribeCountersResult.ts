...
export default class DescribeCountersResult implements IResult {
    ...
    public getItems(): Gs2Mission.Counter[]|null {
        return this.items;
    }

    public setItems(items: Gs2Mission.Counter[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Mission.Counter[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2Mission.Counter) => {
                    return item.toDict();
                }
            ) : null,
