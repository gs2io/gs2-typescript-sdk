...
export default class UpdateCurrentMissionMasterFromGitHubResult implements IResult {
    ...
    public setItem(item: Gs2Mission.CurrentMissionMaster|null) {
        this.item = item;
        return this;
    }

    public withItem(item: Gs2Mission.CurrentMissionMaster|null): this {
        this.item = item;
        return this;
    }

    public static fromDict(data: {[key: string]: any}): UpdateCurrentMissionMasterFromGitHubResult {
