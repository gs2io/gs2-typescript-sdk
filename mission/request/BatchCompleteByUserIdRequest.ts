...
export default class BatchCompleteByUserIdRequest implements IRequest {
    ...
    private missionTaskNames: string[]|null = null;
    ...
    public getMissionTaskNames(): string[]|null {
        return this.missionTaskNames;
    }
    public setMissionTaskNames(missionTaskNames: string[]|null) {
        this.missionTaskNames = missionTaskNames;
        return this;
    }
    public withMissionTaskNames(missionTaskNames: string[]|null): this {
        this.missionTaskNames = missionTaskNames;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): BatchCompleteByUserIdRequest {
