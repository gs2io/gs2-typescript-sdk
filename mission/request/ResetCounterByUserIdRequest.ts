...
export default class ResetCounterByUserIdRequest implements IRequest {
    ...
    private scopes: Gs2Mission.ScopedValue[]|null = null;
    ...
    public getScopes(): Gs2Mission.ScopedValue[]|null {
        return this.scopes;
    }
    public setScopes(scopes: Gs2Mission.ScopedValue[]|null) {
        this.scopes = scopes;
        return this;
    }
    public withScopes(scopes: Gs2Mission.ScopedValue[]|null): this {
        this.scopes = scopes;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): ResetCounterByUserIdRequest {
    ...
    public toDict(): {[key: string]: any} {
        return {
            ...
            "scopes": this.getScopes() ?
                this.getScopes()!.map((item: Gs2Mission.ScopedValue) => {
                    return item.toDict();
                }
            ) : null,
