...
export default class VerifyCounterValueByStampTaskRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): VerifyCounterValueByStampTaskRequest {
