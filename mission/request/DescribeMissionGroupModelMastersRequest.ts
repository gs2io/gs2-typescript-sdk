...
export default class DescribeMissionGroupModelMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeMissionGroupModelMastersRequest {
