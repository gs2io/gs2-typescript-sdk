...
export default class DescribeCounterModelMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeCounterModelMastersRequest {
