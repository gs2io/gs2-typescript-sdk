...
export default class DeleteMissionGroupModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteMissionGroupModelMasterRequest {
