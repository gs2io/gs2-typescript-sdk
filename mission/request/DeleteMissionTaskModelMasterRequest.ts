...
export default class DeleteMissionTaskModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteMissionTaskModelMasterRequest {
