...
export default class GetMissionGroupModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetMissionGroupModelMasterRequest {
