...
var Gs2MissionRestClient = /** @class */ (function (_super) {
    ...
    Gs2MissionRestClient.prototype.batchComplete = function (request) {
        ...
        var url = (model_1.Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/user/me/complete/group/{missionGroupName}/task/any/batch')
            .replace('{service}', 'mission')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'))
            .replace('{missionGroupName}', String((_c = request.getMissionGroupName()) !== null && _c !== void 0 ? _c : 'null') === "" ? "null" : String((_d = request.getMissionGroupName()) !== null && _d !== void 0 ? _d : 'null'));
        ...
        var body = {
            ...
            'missionTaskNames': (_h = request.getMissionTaskNames()) !== null && _h !== void 0 ? _h : null,
    ...
    Gs2MissionRestClient.prototype.batchCompleteByUserId = function (request) {
        ...
        var url = (model_1.Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/user/{userId}/complete/group/{missionGroupName}/task/any/batch')
            .replace('{service}', 'mission')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'))
            .replace('{missionGroupName}', String((_c = request.getMissionGroupName()) !== null && _c !== void 0 ? _c : 'null') === "" ? "null" : String((_d = request.getMissionGroupName()) !== null && _d !== void 0 ? _d : 'null'))
        ...
        var body = {
            'contextStack': (_j = request.getContextStack()) !== null && _j !== void 0 ? _j : null,
            'missionTaskNames': (_k = request.getMissionTaskNames()) !== null && _k !== void 0 ? _k : null,
    ...
    Gs2MissionRestClient.prototype.batchReceiveByUserId = function (request) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
        var url = (model_1.Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/user/{userId}/complete/group/{missionGroupName}/task/any/receive/batch')
            .replace('{service}', 'mission')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'))
            .replace('{missionGroupName}', String((_c = request.getMissionGroupName()) !== null && _c !== void 0 ? _c : 'null') === "" ? "null" : String((_d = request.getMissionGroupName()) !== null && _d !== void 0 ? _d : 'null'))
    ...
    Gs2MissionRestClient.prototype.revertReceiveByUserId = function (request) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l;
        var url = (model_1.Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/user/{userId}/complete/group/{missionGroupName}/task/{missionTaskName}/revert')
            .replace('{service}', 'mission')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'))
            .replace('{missionGroupName}', String((_c = request.getMissionGroupName()) !== null && _c !== void 0 ? _c : 'null') === "" ? "null" : String((_d = request.getMissionGroupName()) !== null && _d !== void 0 ? _d : 'null'))
    ...
    Gs2MissionRestClient.prototype.verifyComplete = function (request) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o;
        var url = (model_1.Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/user/me/complete/group/{missionGroupName}/task/{missionTaskName}/verify/{verifyType}')
            .replace('{service}', 'mission')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'))
            .replace('{missionGroupName}', String((_c = request.getMissionGroupName()) !== null && _c !== void 0 ? _c : 'null') === "" ? "null" : String((_d = request.getMissionGroupName()) !== null && _d !== void 0 ? _d : 'null'))
            ...
            .replace('{missionTaskName}', String((_g = request.getMissionTaskName()) !== null && _g !== void 0 ? _g : 'null') === "" ? "null" : String((_h = request.getMissionTaskName()) !== null && _h !== void 0 ? _h : 'null'))
            .replace('{multiplyValueSpecifyingQuantity}', String((_j = request.getMultiplyValueSpecifyingQuantity()) !== null && _j !== void 0 ? _j : 'null') === "" ? "null" : String((_k = request.getMultiplyValueSpecifyingQuantity()) !== null && _k !== void 0 ? _k : 'null'));
        var headers = this.createAuthorizedHeaders();
        if (request.getRequestId()) {
            headers['X-GS2-REQUEST-ID'] = request.getRequestId();
        }
    ...
    Gs2MissionRestClient.prototype.verifyCompleteByUserId = function (request) {
        ...
        var url = (model_1.Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/user/{userId}/complete/group/{missionGroupName}/task/{missionTaskName}/verify/{verifyType}')
            .replace('{service}', 'mission')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'))
            .replace('{missionGroupName}', String((_c = request.getMissionGroupName()) !== null && _c !== void 0 ? _c : 'null') === "" ? "null" : String((_d = request.getMissionGroupName()) !== null && _d !== void 0 ? _d : 'null'))
            ...
            .replace('{missionTaskName}', String((_j = request.getMissionTaskName()) !== null && _j !== void 0 ? _j : 'null') === "" ? "null" : String((_k = request.getMissionTaskName()) !== null && _k !== void 0 ? _k : 'null'))
            .replace('{multiplyValueSpecifyingQuantity}', String((_l = request.getMultiplyValueSpecifyingQuantity()) !== null && _l !== void 0 ? _l : 'null') === "" ? "null" : String((_m = request.getMultiplyValueSpecifyingQuantity()) !== null && _m !== void 0 ? _m : 'null'));
        var headers = this.createAuthorizedHeaders();
        if (request.getRequestId()) {
            headers['X-GS2-REQUEST-ID'] = request.getRequestId();
        }
    ...
    Gs2MissionRestClient.prototype.revertReceiveByStampSheet = function (request) {
        var _a, _b, _c;
        var url = (model_1.Gs2Constant.ENDPOINT_HOST + '/stamp/revert')
            .replace('{service}', 'mission')
            .replace('{region}', this.session.region);
        var headers = this.createAuthorizedHeaders();
        if (request.getRequestId()) {
    ...
    Gs2MissionRestClient.prototype.verifyCompleteByStampTask = function (request) {
        var _a, _b, _c;
        var url = (model_1.Gs2Constant.ENDPOINT_HOST + '/stamp/complete/verify')
            .replace('{service}', 'mission')
            .replace('{region}', this.session.region);
        var headers = this.createAuthorizedHeaders();
        if (request.getRequestId()) {
    ...
    Gs2MissionRestClient.prototype.createNamespace = function (request) {
        ...
        var body = {
            ...
            'missionCompleteScript': (_g = (_f = request.getMissionCompleteScript()) === null || _f === void 0 ? void 0 : _f.toDict()) !== null && _g !== void 0 ? _g : null,
            'counterIncrementScript': (_j = (_h = request.getCounterIncrementScript()) === null || _h === void 0 ? void 0 : _h.toDict()) !== null && _j !== void 0 ? _j : null,
            'receiveRewardsScript': (_l = (_k = request.getReceiveRewardsScript()) === null || _k === void 0 ? void 0 : _k.toDict()) !== null && _l !== void 0 ? _l : null,
    ...
    Gs2MissionRestClient.prototype.setCounterByUserId = function (request) {
        ...
        var body = {
            'contextStack': (_j = request.getContextStack()) !== null && _j !== void 0 ? _j : null,
            'values': (_l = (_k = request.getValues()) === null || _k === void 0 ? void 0 : _k.map(function (item) { return item.toDict(); })) !== null && _l !== void 0 ? _l : null,
        };
        return axios_1.default.put(url, body, {
            headers: headers,
        }).then(function (response) {
    ...
    Gs2MissionRestClient.prototype.decreaseCounter = function (request) {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        var url = (model_1.Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/user/me/counter/{counterName}/decrease')
            .replace('{service}', 'mission')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'))
            .replace('{counterName}', String((_c = request.getCounterName()) !== null && _c !== void 0 ? _c : 'null') === "" ? "null" : String((_d = request.getCounterName()) !== null && _d !== void 0 ? _d : 'null'));
    ...
    Gs2MissionRestClient.prototype.decreaseCounterByUserId = function (request) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
        var url = (model_1.Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/user/{userId}/counter/{counterName}/decrease')
            .replace('{service}', 'mission')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'))
            .replace('{counterName}', String((_c = request.getCounterName()) !== null && _c !== void 0 ? _c : 'null') === "" ? "null" : String((_d = request.getCounterName()) !== null && _d !== void 0 ? _d : 'null'))
    ...
    Gs2MissionRestClient.prototype.resetCounter = function (request) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j;
        var url = (model_1.Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/user/me/counter/{counterName}/reset')
            .replace('{service}', 'mission')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'))
            .replace('{counterName}', String((_c = request.getCounterName()) !== null && _c !== void 0 ? _c : 'null') === "" ? "null" : String((_d = request.getCounterName()) !== null && _d !== void 0 ? _d : 'null'));
    ...
    Gs2MissionRestClient.prototype.resetCounterByUserId = function (request) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l;
        var url = (model_1.Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/user/{userId}/counter/{counterName}/reset')
            .replace('{service}', 'mission')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'))
            .replace('{userId}', String((_c = request.getUserId()) !== null && _c !== void 0 ? _c : 'null') === "" ? "null" : String((_d = request.getUserId()) !== null && _d !== void 0 ? _d : 'null'))
        ...
        var body = {
            'contextStack': (_j = request.getContextStack()) !== null && _j !== void 0 ? _j : null,
            'scopes': (_l = (_k = request.getScopes()) === null || _k === void 0 ? void 0 : _k.map(function (item) { return item.toDict(); })) !== null && _l !== void 0 ? _l : null,
        };
        return axios_1.default.post(url, body, {
            headers: headers,
        }).then(function (response) {
    ...
    Gs2MissionRestClient.prototype.setByStampSheet = function (request) {
        var _a, _b, _c;
        var url = (model_1.Gs2Constant.ENDPOINT_HOST + '/stamp/set')
            .replace('{service}', 'mission')
            .replace('{region}', this.session.region);
        var headers = this.createAuthorizedHeaders();
        if (request.getRequestId()) {
    ...
    Gs2MissionRestClient.prototype.decreaseByStampTask = function (request) {
        var _a, _b, _c;
        var url = (model_1.Gs2Constant.ENDPOINT_HOST + '/stamp/decrease')
            .replace('{service}', 'mission')
            .replace('{region}', this.session.region);
        var headers = this.createAuthorizedHeaders();
        if (request.getRequestId()) {
    ...
    Gs2MissionRestClient.prototype.resetByStampTask = function (request) {
        var _a, _b, _c;
        var url = (model_1.Gs2Constant.ENDPOINT_HOST + '/stamp/reset')
            .replace('{service}', 'mission')
            .replace('{region}', this.session.region);
        var headers = this.createAuthorizedHeaders();
        if (request.getRequestId()) {
