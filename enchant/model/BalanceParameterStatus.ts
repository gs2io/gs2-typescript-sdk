...
export default class BalanceParameterStatus implements IModel {
    private balanceParameterStatusId: string|null = null;
    ...
    public getBalanceParameterStatusId(): string|null {
        return this.balanceParameterStatusId;
    }
    public setBalanceParameterStatusId(balanceParameterStatusId: string|null) {
        this.balanceParameterStatusId = balanceParameterStatusId;
        return this;
    }
    public withBalanceParameterStatusId(balanceParameterStatusId: string|null): this {
        this.balanceParameterStatusId = balanceParameterStatusId;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): BalanceParameterStatus|null {
