...
export default class SetBalanceParameterStatusByUserIdResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): SetBalanceParameterStatusByUserIdResult {
