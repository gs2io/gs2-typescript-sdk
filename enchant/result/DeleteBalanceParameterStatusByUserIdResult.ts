...
export default class DeleteBalanceParameterStatusByUserIdResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteBalanceParameterStatusByUserIdResult {
