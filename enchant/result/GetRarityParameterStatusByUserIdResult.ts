...
export default class GetRarityParameterStatusByUserIdResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): GetRarityParameterStatusByUserIdResult {
