...
export default class AddRarityParameterStatusByUserIdResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): AddRarityParameterStatusByUserIdResult {
