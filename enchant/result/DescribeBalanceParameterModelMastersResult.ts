...
export default class DescribeBalanceParameterModelMastersResult implements IResult {
    private items: Gs2Enchant.BalanceParameterModelMaster[]|null = null;
    private nextPageToken: string|null = null;

    public getItems(): Gs2Enchant.BalanceParameterModelMaster[]|null {
        return this.items;
    }

    public setItems(items: Gs2Enchant.BalanceParameterModelMaster[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Enchant.BalanceParameterModelMaster[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeBalanceParameterModelMastersResult {
