...
export default class GetBalanceParameterStatusByUserIdResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): GetBalanceParameterStatusByUserIdResult {
