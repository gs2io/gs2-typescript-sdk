...
export default class DescribeRarityParameterModelMastersResult implements IResult {
    private items: Gs2Enchant.RarityParameterModelMaster[]|null = null;
    private nextPageToken: string|null = null;

    public getItems(): Gs2Enchant.RarityParameterModelMaster[]|null {
        return this.items;
    }

    public setItems(items: Gs2Enchant.RarityParameterModelMaster[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Enchant.RarityParameterModelMaster[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeRarityParameterModelMastersResult {
