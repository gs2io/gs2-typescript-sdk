...
export default class PreUpdateCurrentParameterMasterResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): PreUpdateCurrentParameterMasterResult {
