...
export default class DescribeRarityParameterStatusesRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeRarityParameterStatusesRequest {
