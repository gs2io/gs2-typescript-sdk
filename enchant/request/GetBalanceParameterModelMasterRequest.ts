...
export default class GetBalanceParameterModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetBalanceParameterModelMasterRequest {
