...
export default class GetBalanceParameterStatusByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetBalanceParameterStatusByUserIdRequest {
