...
export default class SetBalanceParameterStatusByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): SetBalanceParameterStatusByUserIdRequest {
