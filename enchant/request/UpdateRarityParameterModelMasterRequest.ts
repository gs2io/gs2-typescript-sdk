...
export default class UpdateRarityParameterModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): UpdateRarityParameterModelMasterRequest {
