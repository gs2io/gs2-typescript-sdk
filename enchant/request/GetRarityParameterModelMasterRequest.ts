...
export default class GetRarityParameterModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetRarityParameterModelMasterRequest {
