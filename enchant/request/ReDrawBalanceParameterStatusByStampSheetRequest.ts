...
export default class ReDrawBalanceParameterStatusByStampSheetRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): ReDrawBalanceParameterStatusByStampSheetRequest {
