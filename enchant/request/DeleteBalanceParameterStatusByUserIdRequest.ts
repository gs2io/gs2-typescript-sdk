...
export default class DeleteBalanceParameterStatusByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteBalanceParameterStatusByUserIdRequest {
