...
export default class AddRarityParameterStatusByStampSheetRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): AddRarityParameterStatusByStampSheetRequest {
