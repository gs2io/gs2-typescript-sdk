...
export default class DeleteBalanceParameterModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteBalanceParameterModelMasterRequest {
