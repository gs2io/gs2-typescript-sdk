...
export default class SetRarityParameterStatusByStampSheetRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): SetRarityParameterStatusByStampSheetRequest {
