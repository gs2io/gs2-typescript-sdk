...
export default class DeleteRarityParameterModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteRarityParameterModelMasterRequest {
