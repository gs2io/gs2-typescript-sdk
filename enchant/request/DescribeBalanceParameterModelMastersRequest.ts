...
export default class DescribeBalanceParameterModelMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeBalanceParameterModelMastersRequest {
