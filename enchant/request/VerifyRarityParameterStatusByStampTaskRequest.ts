...
export default class VerifyRarityParameterStatusByStampTaskRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): VerifyRarityParameterStatusByStampTaskRequest {
