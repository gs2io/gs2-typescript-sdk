...
export default class DeleteRarityParameterStatusByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteRarityParameterStatusByUserIdRequest {
