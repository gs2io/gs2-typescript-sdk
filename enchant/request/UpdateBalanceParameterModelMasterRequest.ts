...
export default class UpdateBalanceParameterModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): UpdateBalanceParameterModelMasterRequest {
