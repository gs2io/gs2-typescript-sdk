...
export default class DescribeBalanceParameterStatusesRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeBalanceParameterStatusesRequest {
