...
export default class IncrementalExchangeByStampSheetResult implements IResult {
    private item: Gs2Exchange.IncrementalRateModel|null = null;
    ...
    public getItem(): Gs2Exchange.IncrementalRateModel|null {
        return this.item;
    }

    public setItem(item: Gs2Exchange.IncrementalRateModel|null) {
        this.item = item;
        return this;
    }

    public withItem(item: Gs2Exchange.IncrementalRateModel|null): this {
        this.item = item;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): IncrementalExchangeByStampSheetResult {
