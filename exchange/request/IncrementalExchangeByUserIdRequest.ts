...
export default class IncrementalExchangeByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): IncrementalExchangeByUserIdRequest {
