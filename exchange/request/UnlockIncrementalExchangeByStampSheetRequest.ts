...
export default class UnlockIncrementalExchangeByStampSheetRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): UnlockIncrementalExchangeByStampSheetRequest {
