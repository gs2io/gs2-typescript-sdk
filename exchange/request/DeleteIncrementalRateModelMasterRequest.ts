...
export default class DeleteIncrementalRateModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteIncrementalRateModelMasterRequest {
