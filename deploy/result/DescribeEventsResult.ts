...
export default class DescribeEventsResult implements IResult {
    private items: Gs2Deploy.Event[]|null = null;
    private nextPageToken: string|null = null;

    public getItems(): Gs2Deploy.Event[]|null {
        return this.items;
    }

    public setItems(items: Gs2Deploy.Event[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Deploy.Event[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeEventsResult {
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2Deploy.Event) => {
                    return item.toDict();
                }
            ) : null,
