...
export default class DescribeStacksResult implements IResult {
    private items: Gs2Deploy.Stack[]|null = null;
    private nextPageToken: string|null = null;

    public getItems(): Gs2Deploy.Stack[]|null {
        return this.items;
    }

    public setItems(items: Gs2Deploy.Stack[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Deploy.Stack[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeStacksResult {
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2Deploy.Stack) => {
                    return item.toDict();
                }
            ) : [],
