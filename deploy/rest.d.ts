...
export default class Gs2DeployRestClient extends AbstractGs2RestClient {
    ...
    preCreateStack(request: Request.PreCreateStackRequest): Promise<Result.PreCreateStackResult>;
    ...
    preValidate(request: Request.PreValidateRequest): Promise<Result.PreValidateResult>;
    ...
    preUpdateStack(request: Request.PreUpdateStackRequest): Promise<Result.PreUpdateStackResult>;
    updateStack(request: Request.UpdateStackRequest): Promise<Result.UpdateStackResult>;
    preChangeSet(request: Request.PreChangeSetRequest): Promise<Result.PreChangeSetResult>;
