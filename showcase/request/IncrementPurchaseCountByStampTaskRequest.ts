...
export default class IncrementPurchaseCountByStampTaskRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): IncrementPurchaseCountByStampTaskRequest {
