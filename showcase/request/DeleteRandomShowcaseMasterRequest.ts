...
export default class DeleteRandomShowcaseMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteRandomShowcaseMasterRequest {
