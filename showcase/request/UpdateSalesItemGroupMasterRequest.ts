...
export default class UpdateSalesItemGroupMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): UpdateSalesItemGroupMasterRequest {
