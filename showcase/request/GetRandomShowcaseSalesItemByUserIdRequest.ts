...
export default class GetRandomShowcaseSalesItemByUserIdRequest implements IRequest {

    private requestId: string|null = null;
    private contextStack: string|null = null;
    private namespaceName: string|null = null;
    private showcaseName: string|null = null;
    private displayItemName: string|null = null;
    ...
    public getDisplayItemName(): string|null {
        return this.displayItemName;
    }
    public setDisplayItemName(displayItemName: string|null) {
        this.displayItemName = displayItemName;
        return this;
    }
    public withDisplayItemName(displayItemName: string|null): this {
        this.displayItemName = displayItemName;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): GetRandomShowcaseSalesItemByUserIdRequest {
