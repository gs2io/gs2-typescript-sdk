...
export default class DescribeSalesItemGroupMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeSalesItemGroupMastersRequest {
