...
export default class DecrementPurchaseCountByStampSheetRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DecrementPurchaseCountByStampSheetRequest {
