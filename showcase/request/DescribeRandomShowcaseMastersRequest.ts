...
export default class DescribeRandomShowcaseMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeRandomShowcaseMastersRequest {
