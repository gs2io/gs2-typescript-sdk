...
export default class CreateRandomShowcaseMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): CreateRandomShowcaseMasterRequest {
