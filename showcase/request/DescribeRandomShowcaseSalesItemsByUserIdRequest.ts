...
export default class DescribeRandomShowcaseSalesItemsByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeRandomShowcaseSalesItemsByUserIdRequest {
