...
export default class ForceReDrawByUserIdByStampSheetRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): ForceReDrawByUserIdByStampSheetRequest {
