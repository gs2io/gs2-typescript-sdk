...
export default class DescribeRandomShowcaseSalesItemsRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeRandomShowcaseSalesItemsRequest {
