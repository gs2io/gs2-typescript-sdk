...
export default class DecrementPurchaseCountByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DecrementPurchaseCountByUserIdRequest {
