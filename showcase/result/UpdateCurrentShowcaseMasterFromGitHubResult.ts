...
export default class UpdateCurrentShowcaseMasterFromGitHubResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): UpdateCurrentShowcaseMasterFromGitHubResult {
