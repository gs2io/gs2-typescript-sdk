...
export default class PreUpdateCurrentShowcaseMasterResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): PreUpdateCurrentShowcaseMasterResult {
