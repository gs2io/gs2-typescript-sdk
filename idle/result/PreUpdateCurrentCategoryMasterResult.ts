...
export default class PreUpdateCurrentCategoryMasterResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): PreUpdateCurrentCategoryMasterResult {
