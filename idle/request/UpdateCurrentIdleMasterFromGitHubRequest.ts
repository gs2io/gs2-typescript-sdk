...
export default class UpdateCurrentIdleMasterFromGitHubRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): UpdateCurrentIdleMasterFromGitHubRequest {
