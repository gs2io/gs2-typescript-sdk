...
export default class ReceiveByUserIdRequest implements IRequest {
    ...
    private config: Gs2Idle.Config[]|null = null;
    ...
    public getConfig(): Gs2Idle.Config[]|null {
        return this.config;
    }
    public setConfig(config: Gs2Idle.Config[]|null) {
        this.config = config;
        return this;
    }
    public withConfig(config: Gs2Idle.Config[]|null): this {
        this.config = config;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): ReceiveByUserIdRequest {
