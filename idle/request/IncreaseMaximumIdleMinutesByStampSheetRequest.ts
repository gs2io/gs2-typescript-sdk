...
export default class IncreaseMaximumIdleMinutesByStampSheetRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): IncreaseMaximumIdleMinutesByStampSheetRequest {
