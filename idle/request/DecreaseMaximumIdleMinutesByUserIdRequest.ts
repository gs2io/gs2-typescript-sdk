...
export default class DecreaseMaximumIdleMinutesByUserIdRequest implements IRequest {
    ...
    private decreaseMinutes: number|null = null;
    ...
    public getDecreaseMinutes(): number|null {
        return this.decreaseMinutes;
    }
    public setDecreaseMinutes(decreaseMinutes: number|null) {
        this.decreaseMinutes = decreaseMinutes;
        return this;
    }
    public withDecreaseMinutes(decreaseMinutes: number|null): this {
        this.decreaseMinutes = decreaseMinutes;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DecreaseMaximumIdleMinutesByUserIdRequest {
