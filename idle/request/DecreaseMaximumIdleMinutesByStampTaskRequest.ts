...
export default class DecreaseMaximumIdleMinutesByStampTaskRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DecreaseMaximumIdleMinutesByStampTaskRequest {
