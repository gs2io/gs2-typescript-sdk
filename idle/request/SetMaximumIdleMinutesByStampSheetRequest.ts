...
export default class SetMaximumIdleMinutesByStampSheetRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): SetMaximumIdleMinutesByStampSheetRequest {
