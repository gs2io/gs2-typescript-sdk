...
export default class DescribeWalletsByUserIdResult implements IResult {
    private items: Gs2Money2.Wallet[]|null = null;
    private nextPageToken: string|null = null;

    public getItems(): Gs2Money2.Wallet[]|null {
        return this.items;
    }

    public setItems(items: Gs2Money2.Wallet[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Money2.Wallet[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeWalletsByUserIdResult {
