...
export default class DescribeEventsByUserIdResult implements IResult {
    private items: Gs2Money2.Event[]|null = null;
    private nextPageToken: string|null = null;

    public getItems(): Gs2Money2.Event[]|null {
        return this.items;
    }

    public setItems(items: Gs2Money2.Event[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Money2.Event[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeEventsByUserIdResult {
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2Money2.Event) => {
                    return item.toDict();
                }
            ) : [],
