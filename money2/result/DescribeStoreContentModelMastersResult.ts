...
export default class DescribeStoreContentModelMastersResult implements IResult {
    private items: Gs2Money2.StoreContentModelMaster[]|null = null;
    private nextPageToken: string|null = null;

    public getItems(): Gs2Money2.StoreContentModelMaster[]|null {
        return this.items;
    }

    public setItems(items: Gs2Money2.StoreContentModelMaster[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Money2.StoreContentModelMaster[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeStoreContentModelMastersResult {
