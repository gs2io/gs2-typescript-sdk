...
export default class DescribeUnusedBalancesResult implements IResult {
    private items: Gs2Money2.UnusedBalance[]|null = null;
    private nextPageToken: string|null = null;

    public getItems(): Gs2Money2.UnusedBalance[]|null {
        return this.items;
    }

    public setItems(items: Gs2Money2.UnusedBalance[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Money2.UnusedBalance[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeUnusedBalancesResult {
