...
export default class GetStoreContentModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetStoreContentModelMasterRequest {
