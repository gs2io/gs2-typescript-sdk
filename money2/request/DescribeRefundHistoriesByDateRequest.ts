...
export default class DescribeRefundHistoriesByDateRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeRefundHistoriesByDateRequest {
