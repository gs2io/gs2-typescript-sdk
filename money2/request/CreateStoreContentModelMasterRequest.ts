...
export default class CreateStoreContentModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): CreateStoreContentModelMasterRequest {
