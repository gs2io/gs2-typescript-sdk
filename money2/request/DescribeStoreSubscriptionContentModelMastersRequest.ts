...
export default class DescribeStoreSubscriptionContentModelMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeStoreSubscriptionContentModelMastersRequest {
