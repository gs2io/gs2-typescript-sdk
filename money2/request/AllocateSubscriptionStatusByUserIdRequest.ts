...
export default class AllocateSubscriptionStatusByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): AllocateSubscriptionStatusByUserIdRequest {
