...
export default class DescribeStoreContentModelMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeStoreContentModelMastersRequest {
