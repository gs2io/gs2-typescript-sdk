...
export default class DeleteStoreContentModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteStoreContentModelMasterRequest {
