...
export default class DeleteStoreSubscriptionContentModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteStoreSubscriptionContentModelMasterRequest {
