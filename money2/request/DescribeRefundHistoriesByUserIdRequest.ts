...
export default class DescribeRefundHistoriesByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeRefundHistoriesByUserIdRequest {
