...
export default class NotificationSetting implements IModel {
    ...
    getMobileNotificationMessages(): Gs2Money2.MobileNotificationMessage[] | null;
    setMobileNotificationMessages(mobileNotificationMessages: Gs2Money2.MobileNotificationMessage[] | null): this;
    withMobileNotificationMessages(mobileNotificationMessages: Gs2Money2.MobileNotificationMessage[] | null): this;
