...
export default class DescribeSubscribesByRoomNameRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeSubscribesByRoomNameRequest {
