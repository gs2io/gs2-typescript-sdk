...
var Gs2ScriptRestClient = /** @class */ (function (_super) {
    ...
    Gs2ScriptRestClient.prototype.getScript = function (request) {
        ...
        var url = (model_1.Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/script/{scriptName}')
            ...
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_a = request.getNamespaceName()) !== null && _a !== void 0 ? _a : 'null') === "" ? "null" : String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null'))
            .replace('{scriptName}', String((_c = request.getScriptName()) !== null && _c !== void 0 ? _c : 'null') === "" ? "null" : String((_d = request.getScriptName()) !== null && _d !== void 0 ? _d : 'null'));
        var headers = this.createAuthorizedHeaders();
        if (request.getRequestId()) {
            headers['X-GS2-REQUEST-ID'] = request.getRequestId();
        }
    ...
    Gs2ScriptRestClient.prototype.invokeScript = function (request) {
        ...
        var body = {
            'contextStack': (_c = request.getContextStack()) !== null && _c !== void 0 ? _c : null,
            'scriptId': (_d = request.getScriptId()) !== null && _d !== void 0 ? _d : null,
    ...
    Gs2ScriptRestClient.prototype.invokeByStampSheet = function (request) {
        var _a, _b, _c;
        var url = (model_1.Gs2Constant.ENDPOINT_HOST + '/stamp/script/invoke')
            .replace('{service}', 'script')
            .replace('{region}', this.session.region);
        var headers = this.createAuthorizedHeaders();
        if (request.getRequestId()) {
