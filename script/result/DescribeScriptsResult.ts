...
export default class DescribeScriptsResult implements IResult {
    ...
    public getItems(): Gs2Script.Script[]|null {
        return this.items;
    }

    public setItems(items: Gs2Script.Script[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Script.Script[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeScriptsResult {
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2Script.Script) => {
                    return item.toDict();
                }
            ) : null,
