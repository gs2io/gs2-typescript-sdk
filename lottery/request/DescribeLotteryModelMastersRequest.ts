...
export default class DescribeLotteryModelMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeLotteryModelMastersRequest {
