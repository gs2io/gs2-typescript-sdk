...
export default class DrawWithRandomSeedByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DrawWithRandomSeedByUserIdRequest {
