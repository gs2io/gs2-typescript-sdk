...
export default class PreUpdateCurrentLotteryMasterResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): PreUpdateCurrentLotteryMasterResult {
