...
var CurrentLotteryMaster = /** @class */ (function () {
    ...
    CurrentLotteryMaster.getRegion = function (grn) {
    ...
    CurrentLotteryMaster.getOwnerId = function (grn) {
        var match = grn.match(grnFormat
            .replace('{region}', '.*')
            .replace('{ownerId}', '(.*)')
            .replace('{namespaceName}', '.*'));
    ...
    CurrentLotteryMaster.getNamespaceName = function (grn) {
        var match = grn.match(grnFormat
            .replace('{region}', '.*')
            .replace('{ownerId}', '.*')
            .replace('{namespaceName}', '(.*)'));
    ...
    CurrentLotteryMaster.isValid = function (grn) {
    ...
    CurrentLotteryMaster.createGrn = function (region, ownerId, namespaceName) {
        return grnFormat
