...
export class DeadLetterJobDomain {
    ...
    ): Promise<GetDeadLetterJobByUserIdResult> {
        request.setNamespaceName(this.namespaceName);
        request.setUserId(this.userId);
        request.setDeadLetterJobName(this.deadLetterJobName);
        let r: GetDeadLetterJobByUserIdResult = await this.client.getDeadLetterJobByUserId(
            request
        );
    ...
    ): Promise<DeleteDeadLetterJobByUserIdResult> {
        request.setNamespaceName(this.namespaceName);
        request.setUserId(this.userId);
        request.setDeadLetterJobName(this.deadLetterJobName);
        let r: DeleteDeadLetterJobByUserIdResult = await this.client.deleteDeadLetterJobByUserId(
            request
        );
