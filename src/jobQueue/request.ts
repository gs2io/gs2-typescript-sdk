...
export class CreateNamespaceRequest extends Gs2Request {
  ...
  public withPushNotification(pushNotification?: NotificationSetting): this {
    this.pushNotification = pushNotification as NotificationSetting;
    return this;
  }
...
export class DescribeJobsByUserIdRequest extends Gs2Request {
  /** ネームスペース名 */
  public namespaceName?: string;
  /** ユーザーID */
...
export class GetJobByUserIdRequest extends Gs2Request {
  /** ネームスペース名 */
  public namespaceName?: string;
  /** ユーザーID */
  public userId?: string;
  ...
  constructor(
    ...
    if (data && data.jobName !== undefined) {
      this.jobName = data.jobName as string;
    } else {
  ...
  public withJobName(jobName?: string): this {
...
export class PushByUserIdRequest extends Gs2Request {
  /** ネームスペース名 */
  public namespaceName?: string;
  /** ユーザーID */
  public userId?: string;
  ...
  constructor(
    ...
    if (data && data.jobs !== undefined) {
      this.jobs = data.jobs as JobEntry[];
      for (let i = 0; i < data.jobs.length; i++) {
        this.jobs[i] = new JobEntry(data.jobs[i]);
      }
    } else {
      this.jobs = undefined;
    }
  ...
  public withJobs(jobs?: JobEntry[]): this {
    this.jobs = jobs as JobEntry[];
    if (jobs) {
      for (let i = 0; i < jobs!.length; i++) {
        this.jobs[i] = new JobEntry(jobs![i]);
      }
    }
    return this;
  }
  ...
  public toDict(): {[key: string]: any} {
    ...
    data.userId = this.userId;
    if (this.jobs) {
      data.jobs = this.jobs.map((item) => item.toDict());
    }
    data.xGs2DuplicationAvoider = this.xGs2DuplicationAvoider;
    return data;
  }
...
export class RunRequest extends Gs2Request {
  /** ネームスペース名 */
  public namespaceName?: string;
  /** 重複実行回避機能に使用するID */
  public xGs2DuplicationAvoider?: string;
...
export class RunByUserIdRequest extends Gs2Request {
  /** ネームスペース名 */
  public namespaceName?: string;
  /** ユーザーID */
  public userId?: string;
...
export class DeleteJobByUserIdRequest extends Gs2Request {
  /** ネームスペース名 */
  public namespaceName?: string;
  /** ユーザーID */
  public userId?: string;
...
export class PushByStampSheetRequest extends Gs2Request {
  /** スタンプシート */
...
export class DescribeDeadLetterJobsByUserIdRequest extends Gs2Request {
  /** ネームスペース名 */
  public namespaceName?: string;
  /** ユーザーID */
  public userId?: string;
...
export class GetDeadLetterJobByUserIdRequest extends Gs2Request {
  /** ネームスペース名 */
  public namespaceName?: string;
  /** ユーザーID */
  public userId?: string;
  /** ジョブの名前 */
  public deadLetterJobName?: string;
  /** 重複実行回避機能に使用するID */
  public xGs2DuplicationAvoider?: string;
  ...
  constructor(
    ...
    if (data && data.deadLetterJobName !== undefined) {
      this.deadLetterJobName = data.deadLetterJobName as string;
    } else {
      this.deadLetterJobName = undefined;
    }
    if (data && data.xGs2DuplicationAvoider !== undefined) {
      this.xGs2DuplicationAvoider = data.xGs2DuplicationAvoider as string;
    } else {
  ...
  public withDeadLetterJobName(deadLetterJobName?: string): this {
    this.deadLetterJobName = deadLetterJobName as string;
    return this;
  }
  ...
  public toDict(): {[key: string]: any} {
    ...
    data.namespaceName = this.namespaceName;
    data.userId = this.userId;
    data.deadLetterJobName = this.deadLetterJobName;
    data.xGs2DuplicationAvoider = this.xGs2DuplicationAvoider;
    return data;
  }
...
export class DeleteDeadLetterJobByUserIdRequest extends Gs2Request {
  /** ネームスペース名 */
  public namespaceName?: string;
  /** ユーザーID */
  public userId?: string;
