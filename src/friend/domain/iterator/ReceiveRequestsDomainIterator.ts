...
import { DescribeReceiveRequestsRequest } from "@/gs2/friend/request";
import { DescribeReceiveRequestsResult } from "@/gs2/friend/result";
import { AccessToken } from "@/gs2/auth/model";

export class DescribeReceiveRequestsIterator {
    ...
    private async load(): Promise<any> {
        let r: DescribeReceiveRequestsResult = await this.client.describeReceiveRequests(
