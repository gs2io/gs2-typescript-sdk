...
import { DescribeSendRequestsByUserIdRequest } from "@/gs2/friend/request";
import { DescribeSendRequestsByUserIdResult } from "@/gs2/friend/result";
import { AccessToken } from "@/gs2/auth/model";

export class DescribeSendRequestsByUserIdIterator {
    ...
    private async load(): Promise<any> {
        let r: DescribeSendRequestsByUserIdResult = await this.client.describeSendRequestsByUserId(
