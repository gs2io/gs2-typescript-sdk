...
export default class Follow implements IModel {
    ...
    public getFollowId(): string|null {
        return this.followId;
    }

    public setFollowId(followId: string|null) {
        this.followId = followId;
        return this;
    }

    public withFollowId(followId: string|null): this {
        this.followId = followId;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): Follow|null {
