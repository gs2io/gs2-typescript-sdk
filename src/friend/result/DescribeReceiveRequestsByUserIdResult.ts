...
export default class DescribeReceiveRequestsByUserIdResult implements IResult {
    ...
    public setItems(items: Gs2Friend.FriendRequest[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Friend.FriendRequest[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2Friend.FriendRequest) => {
                    return item.toDict();
                }
            ) : [],
