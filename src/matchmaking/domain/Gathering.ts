...
export class GatheringDomain {
    ...
    ): Promise<UpdateGatheringByUserIdResult> {
        request.setNamespaceName(this.namespaceName);
        request.setUserId(this.userId);
        request.setGatheringName(this.gatheringName);
        let r: UpdateGatheringByUserIdResult = await this.client.updateGatheringByUserId(
            request
        );
    ...
    ): Promise<GetGatheringResult> {
        request.setNamespaceName(this.namespaceName);
        request.setGatheringName(this.gatheringName);
        let r: GetGatheringResult = await this.client.getGathering(
            request
        );
        this.gatheringCache.update(r.getItem()!);
        return r;
    ...
    ): Promise<CancelMatchmakingByUserIdResult> {
        request.setNamespaceName(this.namespaceName);
        request.setUserId(this.userId);
        request.setGatheringName(this.gatheringName);
        let r: CancelMatchmakingByUserIdResult = await this.client.cancelMatchmakingByUserId(
            request
        );
        this.gatheringCache.update(r.getItem()!);
        return r;
