...
import { DescribeStatusesRequest } from "@/gs2/experience/request";
import { DescribeStatusesResult } from "@/gs2/experience/result";
import { AccessToken } from "@/gs2/auth/model";

export class DescribeStatusesIterator {
    ...
    private async load(): Promise<any> {
        let r: DescribeStatusesResult = await this.client.describeStatuses(
