...
export default class DeleteExperienceModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteExperienceModelMasterRequest {
