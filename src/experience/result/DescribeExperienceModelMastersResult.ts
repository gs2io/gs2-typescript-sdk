...
export class DescribeExperienceModelMastersResult implements IResult {
    ...
    public getItems(): Gs2Experience.ExperienceModelMaster[]|null {
        return this.items;
    }

    public setItems(items: Gs2Experience.ExperienceModelMaster[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Experience.ExperienceModelMaster[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeExperienceModelMastersResult {
