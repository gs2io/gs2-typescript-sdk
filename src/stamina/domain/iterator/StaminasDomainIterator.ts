...
import { DescribeStaminasRequest } from "@/gs2/stamina/request";
import { DescribeStaminasResult } from "@/gs2/stamina/result";
import { AccessToken } from "@/gs2/auth/model";

export class DescribeStaminasIterator {
    ...
    private async load(): Promise<any> {
        let r: DescribeStaminasResult = await this.client.describeStaminas(
