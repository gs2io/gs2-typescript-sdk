...
export class DescribeRecoverIntervalTableMastersResult implements IResult {
    private items: Gs2Stamina.RecoverIntervalTableMaster[]|null = null;
    private nextPageToken: string|null = null;

    public getItems(): Gs2Stamina.RecoverIntervalTableMaster[]|null {
        return this.items;
    }

    public setItems(items: Gs2Stamina.RecoverIntervalTableMaster[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Stamina.RecoverIntervalTableMaster[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeRecoverIntervalTableMastersResult {
