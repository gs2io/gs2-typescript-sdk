...
export default class GetRecoverValueTableMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetRecoverValueTableMasterRequest {
