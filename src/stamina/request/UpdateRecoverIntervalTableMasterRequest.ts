...
export class UpdateRecoverIntervalTableMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): UpdateRecoverIntervalTableMasterRequest {
