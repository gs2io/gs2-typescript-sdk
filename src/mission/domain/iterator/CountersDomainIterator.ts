 ...
 */
import { Counter } from "@/gs2/mission/model";
import { CounterDomainCache } from "@/gs2/mission/domain/cache/CounterDomainCache";
import { Gs2MissionRestClient } from "@/gs2/mission";
import { DescribeCountersRequest } from "@/gs2/mission/request";
import { DescribeCountersResult } from "@/gs2/mission/result";
import { AccessToken } from "@/gs2/auth/model";

export class DescribeCountersIterator {
    ...
    private async load(): Promise<any> {
        let r: DescribeCountersResult = await this.client.describeCounters(
