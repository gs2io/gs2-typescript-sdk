...
import { DescribeCompletesByUserIdRequest } from "@/gs2/mission/request";
import { DescribeCompletesByUserIdResult } from "@/gs2/mission/result";
import { AccessToken } from "@/gs2/auth/model";

export class DescribeCompletesByUserIdIterator {
    ...
    private async load(): Promise<any> {
        let r: DescribeCompletesByUserIdResult = await this.client.describeCompletesByUserId(
