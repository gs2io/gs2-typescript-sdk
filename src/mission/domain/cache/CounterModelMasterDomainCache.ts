...
export class CounterModelMasterDomainCache {

    private readonly items: Map<String, CounterModelMaster>;

    public constructor() {
        this.items = new Map<String, CounterModelMaster>();
    }

    public update(
        item: CounterModelMaster
    ): void {
        let keys: string = [
