...
export class MissionTaskModelMasterDomainCache {

    private readonly items: Map<String, MissionTaskModelMaster>;

    public constructor() {
        this.items = new Map<String, MissionTaskModelMaster>();
    }

    public update(
        item: MissionTaskModelMaster
    ): void {
        let keys: string = [
