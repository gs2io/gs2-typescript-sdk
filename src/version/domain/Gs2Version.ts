...
import { DescribeNamespacesIterator } from "@/gs2/version/domain/iterator/NamespacesDomainIterator";
import { NamespaceDomain } from "@/gs2/version/domain/Namespace";
...
import { CreateNamespaceRequest } from "@/gs2/version/request";
import { CreateNamespaceResult } from "@/gs2/version/result";
import { CalculateSignatureRequest } from "@/gs2/version/request";
import { CalculateSignatureResult } from "@/gs2/version/result";

export class Gs2Version {
    ...
    ): Promise<CalculateSignatureResult> {
        let r: CalculateSignatureResult = await this.client.calculateSignature(
            request
        );
        return r;
    }
