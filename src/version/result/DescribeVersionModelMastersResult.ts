...
export default class DescribeVersionModelMastersResult implements IResult {
    ...
    public getItems(): Gs2Version.VersionModelMaster[]|null {
        return this.items;
    }

    public setItems(items: Gs2Version.VersionModelMaster[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Version.VersionModelMaster[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeVersionModelMastersResult {
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2Version.VersionModelMaster) => {
                    return item.toDict();
                }
            ) : [],
