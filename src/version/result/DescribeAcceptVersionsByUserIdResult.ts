...
export class DescribeAcceptVersionsByUserIdResult implements IResult {
    ...
    public getItems(): Gs2Version.AcceptVersion[]|null {
        return this.items;
    }

    public setItems(items: Gs2Version.AcceptVersion[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Version.AcceptVersion[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeAcceptVersionsByUserIdResult {
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2Version.AcceptVersion) => {
                    return item.toDict();
                }
            ) : [],
