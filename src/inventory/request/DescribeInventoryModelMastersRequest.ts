...
export default class DescribeInventoryModelMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeInventoryModelMastersRequest {
