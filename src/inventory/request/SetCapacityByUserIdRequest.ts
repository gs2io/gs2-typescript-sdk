...
export class SetCapacityByUserIdRequest implements IRequest {
    ...
    public getNewCapacityValue(): number|null {
        return this.newCapacityValue;
    }

    public setNewCapacityValue(newCapacityValue: number|null) {
        this.newCapacityValue = newCapacityValue;
        return this;
    }

    public withNewCapacityValue(newCapacityValue: number|null): this {
        this.newCapacityValue = newCapacityValue;
        return this;
    }

    public static fromDict(data: {[key: string]: any}): SetCapacityByUserIdRequest {
