...
export class ReferenceOfAccessTokenDomain {
    ...
    public async load(
        ...
        let r: GetReferenceOfResult = await this.client.getReferenceOf(
            request
        );
        return r;
    }
    ...
    ): Promise<VerifyReferenceOfResult> {
        request.setNamespaceName(this.namespaceName);
        request.setAccessToken(this.accessToken != null ? this.accessToken.getToken() : null);
        request.setInventoryName(this.inventoryName);
        request.setItemName(this.itemName);
        request.setItemSetName(this.itemSetName);
        let r: VerifyReferenceOfResult = await this.client.verifyReferenceOf(
            request
        );
        return r;
    }
    ...
    ): Promise<AddReferenceOfResult> {
        request.setNamespaceName(this.namespaceName);
        request.setAccessToken(this.accessToken != null ? this.accessToken.getToken() : null);
        request.setInventoryName(this.inventoryName);
        request.setItemName(this.itemName);
        request.setItemSetName(this.itemSetName);
        let r: AddReferenceOfResult = await this.client.addReferenceOf(
            request
        );
        return r;
    }
    ...
    ): Promise<DeleteReferenceOfResult> {
        request.setNamespaceName(this.namespaceName);
        request.setAccessToken(this.accessToken != null ? this.accessToken.getToken() : null);
        request.setInventoryName(this.inventoryName);
        request.setItemName(this.itemName);
        request.setItemSetName(this.itemSetName);
        let r: DeleteReferenceOfResult = await this.client.deleteReferenceOf(
            request
        );
        return r;
    }
