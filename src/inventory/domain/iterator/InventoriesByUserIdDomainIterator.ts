...
import { DescribeInventoriesByUserIdRequest } from "@/gs2/inventory/request";
import { DescribeInventoriesByUserIdResult } from "@/gs2/inventory/result";
import { AccessToken } from "@/gs2/auth/model";

export class DescribeInventoriesByUserIdIterator {
    ...
    private async load(): Promise<any> {
        let r: DescribeInventoriesByUserIdResult = await this.client.describeInventoriesByUserId(
