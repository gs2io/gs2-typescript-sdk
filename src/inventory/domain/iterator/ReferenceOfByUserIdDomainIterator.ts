...
import { DescribeReferenceOfByUserIdRequest } from "@/gs2/inventory/request";
import { DescribeReferenceOfByUserIdResult } from "@/gs2/inventory/result";
import { AccessToken } from "@/gs2/auth/model";

export class DescribeReferenceOfByUserIdIterator {
    ...
    private async load(): Promise<any> {
        let r: DescribeReferenceOfByUserIdResult = await this.client.describeReferenceOfByUserId(
