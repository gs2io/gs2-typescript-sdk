...
export class ReceiptDomain {
    ...
    public async getByUserIdAndTransactionId(
        request: GetByUserIdAndTransactionIdRequest
    ): Promise<GetByUserIdAndTransactionIdResult> {
        request.setNamespaceName(this.namespaceName);
        request.setUserId(this.userId);
        request.setTransactionId(this.transactionId);
        let r: GetByUserIdAndTransactionIdResult = await this.client.getByUserIdAndTransactionId(
            request
        );
