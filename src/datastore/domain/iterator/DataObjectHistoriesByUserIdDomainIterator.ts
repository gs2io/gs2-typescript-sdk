...
import { DescribeDataObjectHistoriesByUserIdRequest } from "@/gs2/datastore/request";
import { DescribeDataObjectHistoriesByUserIdResult } from "@/gs2/datastore/result";
import { AccessToken } from "@/gs2/auth/model";

export class DescribeDataObjectHistoriesByUserIdIterator {
    ...
    private async load(): Promise<any> {
        let r: DescribeDataObjectHistoriesByUserIdResult = await this.client.describeDataObjectHistoriesByUserId(
