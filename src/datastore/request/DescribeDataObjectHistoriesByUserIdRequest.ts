...
export class DescribeDataObjectHistoriesByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeDataObjectHistoriesByUserIdRequest {
