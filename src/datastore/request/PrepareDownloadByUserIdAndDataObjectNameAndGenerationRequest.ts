...
export default class PrepareDownloadByUserIdAndDataObjectNameAndGenerationRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): PrepareDownloadByUserIdAndDataObjectNameAndGenerationRequest {
