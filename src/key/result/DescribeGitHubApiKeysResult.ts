...
export class DescribeGitHubApiKeysResult implements IResult {
    ...
    public getItems(): Gs2Key.GitHubApiKey[]|null {
        return this.items;
    }

    public setItems(items: Gs2Key.GitHubApiKey[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Key.GitHubApiKey[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeGitHubApiKeysResult {
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2Key.GitHubApiKey) => {
                    return item.toDict();
                }
            ) : [],
