...
export class GetEventResult implements IResult {
    private item: Gs2Deploy.Event|null = null;

    public getItem(): Gs2Deploy.Event|null {
        return this.item;
    }

    public setItem(item: Gs2Deploy.Event|null) {
        this.item = item;
        return this;
    }

    public withItem(item: Gs2Deploy.Event|null): this {
        this.item = item;
        return this;
    }
