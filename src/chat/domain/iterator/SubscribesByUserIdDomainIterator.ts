...
import { DescribeSubscribesByUserIdRequest } from "@/gs2/chat/request";
import { DescribeSubscribesByUserIdResult } from "@/gs2/chat/result";
import { AccessToken } from "@/gs2/auth/model";

export class DescribeSubscribesByUserIdIterator {
    ...
    private async load(): Promise<any> {
        let r: DescribeSubscribesByUserIdResult = await this.client.describeSubscribesByUserId(
