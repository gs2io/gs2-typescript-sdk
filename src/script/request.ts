...
export class DescribeScriptsRequest extends Gs2Request {
  /** ネームスペース名 */
  public namespaceName?: string;
  /** データの取得を開始する位置を指定するトークン */
  public pageToken?: string;
...
export class CreateScriptRequest extends Gs2Request {
  /** ネームスペース名 */
  public namespaceName?: string;
  /** スクリプト名 */
  public name?: string;
  ...
  constructor(
    ...
    if (data && data.script !== undefined) {
      this.script = data.script as string;
    } else {
...
export class CreateScriptFromGitHubRequest extends Gs2Request {
  /** ネームスペース名 */
  public namespaceName?: string;
  /** スクリプト名 */
  public name?: string;
...
export class GetScriptRequest extends Gs2Request {
  /** ネームスペース名 */
  public namespaceName?: string;
  /** スクリプト名 */
  ...
  constructor(
    ...
    if (data && data.scriptName !== undefined) {
      this.scriptName = data.scriptName as string;
    } else {
  ...
  public withScriptName(scriptName?: string): this {
    this.scriptName = scriptName as string;
    return this;
  }
...
export class UpdateScriptRequest extends Gs2Request {
  /** ネームスペース名 */
  public namespaceName?: string;
  /** スクリプト名 */
  public scriptName?: string;
...
export class UpdateScriptFromGitHubRequest extends Gs2Request {
  /** ネームスペース名 */
  public namespaceName?: string;
  /** スクリプト名 */
  public scriptName?: string;
...
export class DeleteScriptRequest extends Gs2Request {
  /** ネームスペース名 */
  public namespaceName?: string;
  /** スクリプト名 */
  public scriptName?: string;
...
export class InvokeScriptRequest extends Gs2Request {
  /** スクリプト */
  ...
  constructor(
    ...
    if (data && data.args !== undefined) {
      this.args = data.args as {[key: string]: any};
    } else {
      this.args = undefined;
    }
  }
  ...
  public withScriptId(scriptId?: string): this {
    this.scriptId = scriptId as string;
    return this;
  }

  public withArgs(args?: {[key: string]: any}): this {
    this.args = args as {[key: string]: any};
    return this;
  }
...
export class DebugInvokeRequest extends Gs2Request {
  /** スクリプト */
  public script?: string;
  /** None */
  public args?: string;
