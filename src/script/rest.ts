...
export class Gs2ScriptRestClient extends AbstractGs2RestClient {

  public static ENDPOINT: string = 'script';
   ...
   * @return 結果
   */
  public describeScripts(request: DescribeScriptsRequest): Promise<DescribeScriptsResult> {
    ...
    return axios.get(
      ...
      .then((response: any) => {
        return new DescribeScriptsResult(response.data);
      }).catch((error: any) => {
        throw JSON.parse(error.response.data.message);
      });
  }
   ...
   * @return 結果
   */
  public createScript(request: CreateScriptRequest): Promise<CreateScriptResult> {
    const url = (Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/script')
      .replace('{service}', 'script')
      .replace('{region}', this.session.region)
      .replace(
    ...
    if (request.script !== undefined && request.script !== '') {
    ...
    return axios.post(
      ...
      .then((response: any) => {
        return new CreateScriptResult(response.data);
      }).catch((error: any) => {
        if (error.response) {
          throw JSON.parse(error.response.data.message);
        } else {
   ...
   * @return 結果
   */
  public createScriptFromGitHub(request: CreateScriptFromGitHubRequest): Promise<CreateScriptFromGitHubResult> {
    ...
    return axios.post(
      ...
      .then((response: any) => {
        return new CreateScriptFromGitHubResult(response.data);
      }).catch((error: any) => {
        if (error.response) {
          throw JSON.parse(error.response.data.message);
        } else {
   ...
   * @return 結果
   */
  public getScript(request: GetScriptRequest): Promise<GetScriptResult> {
    const url = (Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/script/{scriptName}')
      ...
      .replace(
        '{scriptName}',
        request.scriptName ? String(request.scriptName) : 'null',
      );
    ...
    return axios.get(
      ...
      .then((response: any) => {
        return new GetScriptResult(response.data);
      }).catch((error: any) => {
        throw JSON.parse(error.response.data.message);
      });
  }
   ...
   * @return 結果
   */
  public updateScript(request: UpdateScriptRequest): Promise<UpdateScriptResult> {
    const url = (Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/script/{scriptName}')
      .replace('{service}', 'script')
      .replace('{region}', this.session.region)
      .replace(
    ...
    return axios.put(
      ...
      .then((response: any) => {
        return new UpdateScriptResult(response.data);
      }).catch((error: any) => {
        if (error.response) {
          throw JSON.parse(error.response.data.message);
        } else {
   ...
   * @return 結果
   */
  public updateScriptFromGitHub(request: UpdateScriptFromGitHubRequest): Promise<UpdateScriptFromGitHubResult> {
    ...
    return axios.put(
      ...
      .then((response: any) => {
        return new UpdateScriptFromGitHubResult(response.data);
      }).catch((error: any) => {
        if (error.response) {
          throw JSON.parse(error.response.data.message);
        } else {
   ...
   * @return 結果
   */
  public deleteScript(request: DeleteScriptRequest): Promise<DeleteScriptResult> {
    const url = (Gs2Constant.ENDPOINT_HOST + '/{namespaceName}/script/{scriptName}')
      .replace('{service}', 'script')
      .replace('{region}', this.session.region)
      .replace(
    ...
    return axios.delete(
      ...
      .then((response: any) => {
        return new DeleteScriptResult(response.data);
      }).catch((error: any) => {
        throw JSON.parse(error.response.data.message);
      });
  }
   ...
   * @return 結果
   */
  public invokeScript(request: InvokeScriptRequest): Promise<InvokeScriptResult> {
    ...
    const headers = this.createAuthorizedHeaders();
    const body: {[key: string]: any} = {};
    if (request.scriptId !== undefined && request.scriptId !== '') {
    ...
    return axios.post(
      ...
      .then((response: any) => {
        return new InvokeScriptResult(response.data);
      }).catch((error: any) => {
        if (error.response) {
          throw JSON.parse(error.response.data.message);
        } else {
   ...
   * @return 結果
   */
  public debugInvoke(request: DebugInvokeRequest): Promise<DebugInvokeResult> {
    ...
    return axios.post(
      ...
      .then((response: any) => {
        return new DebugInvokeResult(response.data);
      }).catch((error: any) => {
        if (error.response) {
          throw JSON.parse(error.response.data.message);
        } else {
