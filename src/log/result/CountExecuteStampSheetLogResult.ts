...
export default class CountExecuteStampSheetLogResult implements IResult {
    private items: Gs2Log.ExecuteStampSheetLogCount[]|null = null;
    private nextPageToken: string|null = null;
    private totalCount: number|null = null;
    private scanSize: number|null = null;

    public getItems(): Gs2Log.ExecuteStampSheetLogCount[]|null {
        return this.items;
    }

    public setItems(items: Gs2Log.ExecuteStampSheetLogCount[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Log.ExecuteStampSheetLogCount[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): CountExecuteStampSheetLogResult {
