...
export class ShowcaseDomain {
    ...
    ): Promise<GetShowcaseByUserIdResult> {
        request.setNamespaceName(this.namespaceName);
        request.setUserId(this.userId);
        request.setShowcaseName(this.showcaseName);
        let r: GetShowcaseByUserIdResult = await this.client.getShowcaseByUserId(
            request
        );
    ...
    ): Promise<BuyByUserIdResult> {
        request.setNamespaceName(this.namespaceName);
        request.setUserId(this.userId);
        request.setShowcaseName(this.showcaseName);
        let r: BuyByUserIdResult = await this.client.buyByUserId(
            request
        );
        return r;
    }
