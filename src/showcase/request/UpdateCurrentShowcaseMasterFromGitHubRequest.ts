...
export class UpdateCurrentShowcaseMasterFromGitHubRequest implements IRequest {

    private requestId: string|null = null;
    private contextStack: string|null = null;
    private namespaceName: string|null = null;
    private checkoutSetting: Gs2Showcase.GitHubCheckoutSetting|null = null;
    ...
    public static fromDict(data: {[key: string]: any}): UpdateCurrentShowcaseMasterFromGitHubRequest {
