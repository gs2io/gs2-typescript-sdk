...
import { DescribeAwaitsRequest } from "@/gs2/exchange/request";
import { DescribeAwaitsResult } from "@/gs2/exchange/result";
import { AccessToken } from "@/gs2/auth/model";

export class DescribeAwaitsIterator {
    ...
    private async load(): Promise<any> {
        let r: DescribeAwaitsResult = await this.client.describeAwaits(
