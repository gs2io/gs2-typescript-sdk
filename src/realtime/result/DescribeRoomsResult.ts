...
export class DescribeRoomsResult implements IResult {
    private items: Gs2Realtime.Room[]|null = null;
    private nextPageToken: string|null = null;

    public getItems(): Gs2Realtime.Room[]|null {
        return this.items;
    }

    public setItems(items: Gs2Realtime.Room[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Realtime.Room[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeRoomsResult {
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2Realtime.Room) => {
                    return item.toDict();
                }
            ) : [],
