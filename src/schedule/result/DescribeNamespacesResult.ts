...
export class DescribeNamespacesResult implements IResult {
    private items: Gs2Schedule.Namespace[]|null = null;
    private nextPageToken: string|null = null;

    public getItems(): Gs2Schedule.Namespace[]|null {
        return this.items;
    }

    public setItems(items: Gs2Schedule.Namespace[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Schedule.Namespace[]|null): this {
        this.items = items;
        return this;
    }
