...
export default class UpdateCurrentEventMasterFromGitHubResult implements IResult {
    ...
    public setItem(item: Gs2Schedule.CurrentEventMaster|null) {
        this.item = item;
        return this;
    }

    public withItem(item: Gs2Schedule.CurrentEventMaster|null): this {
        this.item = item;
        return this;
    }

    public static fromDict(data: {[key: string]: any}): UpdateCurrentEventMasterFromGitHubResult {
