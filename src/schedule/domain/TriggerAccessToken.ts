...
export class TriggerAccessTokenDomain {
    ...
    ): Promise<GetTriggerResult> {
        request.setNamespaceName(this.namespaceName);
        request.setAccessToken(this.accessToken != null ? this.accessToken.getToken() : null);
        request.setTriggerName(this.triggerName);
        let r: GetTriggerResult = await this.client.getTrigger(
            request
        );
    ...
    public async delete(
        ...
        request.setAccessToken(this.accessToken != null ? this.accessToken.getToken() : null);
        request.setTriggerName(this.triggerName);
        let r: DeleteTriggerResult = await this.client.deleteTrigger(
            request
        );
