...
import { DescribeTriggersByUserIdRequest } from "@/gs2/schedule/request";
import { DescribeTriggersByUserIdResult } from "@/gs2/schedule/result";
import { AccessToken } from "@/gs2/auth/model";

export class DescribeTriggersByUserIdIterator {
    ...
    private async load(): Promise<any> {
        let r: DescribeTriggersByUserIdResult = await this.client.describeTriggersByUserId(
