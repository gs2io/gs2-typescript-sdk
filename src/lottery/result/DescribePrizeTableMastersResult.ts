...
export class DescribePrizeTableMastersResult implements IResult {
    ...
    public getItems(): Gs2Lottery.PrizeTableMaster[]|null {
        return this.items;
    }

    public setItems(items: Gs2Lottery.PrizeTableMaster[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Lottery.PrizeTableMaster[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribePrizeTableMastersResult {
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2Lottery.PrizeTableMaster) => {
                    return item.toDict();
                }
            ) : [],
