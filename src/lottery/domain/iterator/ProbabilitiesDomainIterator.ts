...
import { DescribeProbabilitiesRequest } from "@/gs2/lottery/request";
import { DescribeProbabilitiesResult } from "@/gs2/lottery/result";
import { AccessToken } from "@/gs2/auth/model";

export class DescribeProbabilitiesIterator {
    ...
    private async load(): Promise<any> {
        let r: DescribeProbabilitiesResult = await this.client.describeProbabilities(
