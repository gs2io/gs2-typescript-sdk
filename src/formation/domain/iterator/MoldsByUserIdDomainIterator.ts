...
import { DescribeMoldsByUserIdRequest } from "@/gs2/formation/request";
import { DescribeMoldsByUserIdResult } from "@/gs2/formation/result";
import { AccessToken } from "@/gs2/auth/model";

export class DescribeMoldsByUserIdIterator {
    ...
    private async load(): Promise<any> {
        let r: DescribeMoldsByUserIdResult = await this.client.describeMoldsByUserId(
