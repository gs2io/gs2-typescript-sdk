...
import { DescribeFormsByUserIdRequest } from "@/gs2/formation/request";
import { DescribeFormsByUserIdResult } from "@/gs2/formation/result";
import { AccessToken } from "@/gs2/auth/model";

export class DescribeFormsByUserIdIterator {
    ...
    private async load(): Promise<any> {
        let r: DescribeFormsByUserIdResult = await this.client.describeFormsByUserId(
