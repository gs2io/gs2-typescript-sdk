...
export class WebSocketSessionDomain {
    ...
    ): Promise<SetUserIdByUserIdResult> {
        request.setNamespaceName(this.namespaceName);
        request.setUserId(this.userId);
        let r: SetUserIdByUserIdResult = await this.client.setUserIdByUserId(
            request
        );
    ...
    public async sendNotification(
        ...
        request.setNamespaceName(this.namespaceName);
        request.setUserId(this.userId);
        let r: SendNotificationResult = await this.client.sendNotification(
            request
        );
        return r;
    }
