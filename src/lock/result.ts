...
export class DescribeMutexesResult implements IResult {
  ...
  constructor(
    ...
    if (data) {
      this.items = data.items.map((item: { [key: string]: any }) => {
        return new Mutex(item);
      });
      this.nextPageToken = data.nextPageToken;
    }
  }

  public withItems(items?: Mutex[]): this {
    this.items = items;
    return this;
  }
...
export class DescribeMutexesByUserIdResult implements IResult {
  /** ミューテックスのリスト */
  public items?: Mutex[];
  /** リストの続きを取得するためのページトークン */
  public nextPageToken?: string;
...
export class LockResult implements IResult {
  /** ミューテックス */
  public item?: Mutex;
  ...
  constructor(
    ...
    if (data) {
      this.item = new Mutex(data.item);
    }
  }

  public withItem(item?: Mutex): this {
    this.item = item;
    return this;
  }
...
export class LockByUserIdResult implements IResult {
  /** ミューテックス */
  public item?: Mutex;
...
export class UnlockByUserIdResult implements IResult {
  /** ミューテックス */
  public item?: Mutex;
...
export class GetMutexResult implements IResult {
  /** ミューテックス */
  public item?: Mutex;
...
export class GetMutexByUserIdResult implements IResult {
  /** ミューテックス */
  public item?: Mutex;
...
export class DeleteMutexByUserIdResult implements IResult {
  /** ミューテックス */
  public item?: Mutex;
