...
export default class DescribeCategoryModelMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeCategoryModelMastersRequest {
