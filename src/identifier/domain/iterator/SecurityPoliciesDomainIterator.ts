...
import { DescribeSecurityPoliciesRequest } from "@/gs2/identifier/request";
import { DescribeSecurityPoliciesResult } from "@/gs2/identifier/result";
import { AccessToken } from "@/gs2/auth/model";

export class DescribeSecurityPoliciesIterator {
    ...
    private async load(): Promise<any> {
        let r: DescribeSecurityPoliciesResult = await this.client.describeSecurityPolicies(
