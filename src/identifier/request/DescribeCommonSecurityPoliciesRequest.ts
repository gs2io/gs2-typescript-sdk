...
export default class DescribeCommonSecurityPoliciesRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeCommonSecurityPoliciesRequest {
