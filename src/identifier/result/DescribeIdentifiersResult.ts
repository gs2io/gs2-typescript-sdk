...
export default class DescribeIdentifiersResult implements IResult {
    private items: Gs2Identifier.Identifier[]|null = null;
    private nextPageToken: string|null = null;

    public getItems(): Gs2Identifier.Identifier[]|null {
        return this.items;
    }

    public setItems(items: Gs2Identifier.Identifier[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Identifier.Identifier[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeIdentifiersResult {
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2Identifier.Identifier) => {
                    return item.toDict();
                }
            ) : [],
