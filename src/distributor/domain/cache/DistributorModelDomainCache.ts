...
export class DistributorModelDomainCache {

    private readonly items: Map<String, DistributorModel>;

    public constructor() {
        this.items = new Map<String, DistributorModel>();
    }

    public update(
        item: DistributorModel
    ): void {
        let keys: string = [
