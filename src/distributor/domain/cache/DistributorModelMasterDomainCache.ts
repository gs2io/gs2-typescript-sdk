...
export class DistributorModelMasterDomainCache {

    private readonly items: Map<String, DistributorModelMaster>;

    public constructor() {
        this.items = new Map<String, DistributorModelMaster>();
    }

    public update(
        item: DistributorModelMaster
    ): void {
        let keys: string = [
