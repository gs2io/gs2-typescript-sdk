...
export class DescribeDistributorModelMastersRequest extends Gs2Request {
  /** ネームスペース名 */
  public namespaceName?: string;
  /** データの取得を開始する位置を指定するトークン */
  public pageToken?: string;
...
export class CreateDistributorModelMasterRequest extends Gs2Request {
  /** ネームスペース名 */
  public namespaceName?: string;
  /** 配信設定名 */
  public name?: string;
  ...
  constructor(
    ...
    if (data && data.inboxNamespaceId !== undefined) {
      this.inboxNamespaceId = data.inboxNamespaceId as string;
    } else {
    ...
    if (data && data.whiteListTargetIds !== undefined) {
      ...
      for (let i = 0; i < data.whiteListTargetIds.length; i++) {
        this.whiteListTargetIds[i] = data.whiteListTargetIds[i] as string;
      }
    } else {
  ...
  public withInboxNamespaceId(inboxNamespaceId?: string): this {
    this.inboxNamespaceId = inboxNamespaceId as string;
    return this;
  }
  ...
  public withWhiteListTargetIds(whiteListTargetIds?: string[]): this {
    ...
    if (whiteListTargetIds) {
      for (let i = 0; i < whiteListTargetIds!.length; i++) {
        this.whiteListTargetIds[i] = whiteListTargetIds![i] as string;
      }
    }
    return this;
  }
...
export class GetDistributorModelMasterRequest extends Gs2Request {
  /** ネームスペース名 */
  public namespaceName?: string;
  /** 配信設定名 */
  ...
  constructor(
    ...
    if (data && data.distributorName !== undefined) {
      this.distributorName = data.distributorName as string;
    } else {
  ...
  public withDistributorName(distributorName?: string): this {
    this.distributorName = distributorName as string;
    return this;
  }
...
export class UpdateDistributorModelMasterRequest extends Gs2Request {
  /** ネームスペース名 */
  public namespaceName?: string;
  /** 配信設定名 */
  public distributorName?: string;
...
export class DeleteDistributorModelMasterRequest extends Gs2Request {
  /** ネームスペース名 */
  public namespaceName?: string;
  /** 配信設定名 */
  public distributorName?: string;
...
export class DescribeDistributorModelsRequest extends Gs2Request {
  /** ネームスペース名 */
  public namespaceName?: string;
...
export class GetDistributorModelRequest extends Gs2Request {
  /** ネームスペース名 */
  public namespaceName?: string;
  /** 配信設定名 */
  public distributorName?: string;
...
export class GetCurrentDistributorMasterRequest extends Gs2Request {
  /** ネームスペース名 */
  public namespaceName?: string;
...
export class UpdateCurrentDistributorMasterRequest extends Gs2Request {
  /** ネームスペース名 */
  public namespaceName?: string;
  /** マスターデータ */
...
export class UpdateCurrentDistributorMasterFromGitHubRequest extends Gs2Request {
  /** ネームスペース名 */
  public namespaceName?: string;
...
export class DistributeRequest extends Gs2Request {
  /** ネームスペース名 */
  public namespaceName?: string;
  /** ディストリビューターの種類名 */
  public distributorName?: string;
  ...
  constructor(
    ...
    if (data && data.distributeResource !== undefined && Object.keys(data.distributeResource).length > 0) {
      this.distributeResource = new DistributeResource(data.distributeResource);
    } else {
      this.distributeResource = undefined;
    }
  ...
  public withDistributeResource(distributeResource?: DistributeResource): this {
    this.distributeResource = distributeResource as DistributeResource;
    return this;
  }
  ...
  public toDict(): {[key: string]: any} {
    ...
    data.namespaceName = this.namespaceName;
    data.distributorName = this.distributorName;
    if (this.distributeResource) {
      data.distributeResource = this.distributeResource.toDict();
    }
...
export class DistributeWithoutOverflowProcessRequest extends Gs2Request {
  /** 加算するリソース */
  public distributeResource?: DistributeResource;
  /** 重複実行回避機能に使用するID */
  public xGs2DuplicationAvoider?: string;
...
export class RunStampTaskRequest extends Gs2Request {
  /** ネームスペース名 */
  public namespaceName?: string;
  /** 実行するスタンプタスク */
...
export class RunStampSheetRequest extends Gs2Request {
  /** ネームスペース名 */
  public namespaceName?: string;
  /** 実行するスタンプタスク */
...
export class RunStampTaskWithoutNamespaceRequest extends Gs2Request {
  /** 実行するスタンプタスク */
  public stampTask?: string;
  /** スタンプシートの暗号化に使用した暗号鍵GRN */
  public keyId?: string;
...
export class RunStampSheetWithoutNamespaceRequest extends Gs2Request {
  /** 実行するスタンプタスク */
  public stampSheet?: string;
  /** スタンプシートの暗号化に使用した暗号鍵GRN */
  public keyId?: string;
