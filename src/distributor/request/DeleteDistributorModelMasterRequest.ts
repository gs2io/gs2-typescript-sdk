...
export default class DeleteDistributorModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteDistributorModelMasterRequest {
