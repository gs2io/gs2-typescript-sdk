...
export default class RunStampTaskWithoutNamespaceRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): RunStampTaskWithoutNamespaceRequest {
