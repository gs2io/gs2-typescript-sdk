...
export default class DeleteTakeOverByUserIdentifierResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteTakeOverByUserIdentifierResult {
