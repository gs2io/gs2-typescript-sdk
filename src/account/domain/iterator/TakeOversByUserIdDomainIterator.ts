...
import { DescribeTakeOversByUserIdRequest } from "@/gs2/account/request";
import { DescribeTakeOversByUserIdResult } from "@/gs2/account/result";
import { AccessToken } from "@/gs2/auth/model";

export class DescribeTakeOversByUserIdIterator {
    ...
    private async load(): Promise<any> {
        let r: DescribeTakeOversByUserIdResult = await this.client.describeTakeOversByUserId(
