...
export class QuestGroupModelMasterDomainCache {

    private readonly items: Map<String, QuestGroupModelMaster>;

    public constructor() {
        this.items = new Map<String, QuestGroupModelMaster>();
    }

    public update(
        item: QuestGroupModelMaster
    ): void {
        let keys: string = [
