...
import { DescribeCompletedQuestListsRequest } from "@/gs2/quest/request";
import { DescribeCompletedQuestListsResult } from "@/gs2/quest/result";
import { AccessToken } from "@/gs2/auth/model";

export class DescribeCompletedQuestListsIterator {
    ...
    private async load(): Promise<any> {
        let r: DescribeCompletedQuestListsResult = await this.client.describeCompletedQuestLists(
