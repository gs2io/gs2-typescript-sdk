...
export default class DeleteQuestGroupModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteQuestGroupModelMasterRequest {
