...
export default class DescribeQuestGroupModelMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeQuestGroupModelMastersRequest {
