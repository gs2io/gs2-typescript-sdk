...
export class DeleteCompletedQuestListByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteCompletedQuestListByUserIdRequest {
