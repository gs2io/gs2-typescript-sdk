...
const grnFormat: string = "grn:gs2:{region}:{ownerId}:inventory:{namespaceName}:simple:model:{inventoryName}:item:{itemName}";

export default class SimpleItemModel implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): SimpleItemModel|null {
