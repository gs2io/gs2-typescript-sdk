...
const grnFormat: string = "grn:gs2:{region}:{ownerId}:inventory:{namespaceName}:user:{userId}:big:inventory:{inventoryName}:item:{itemName}";
...
export default class BigItem implements IModel {
    ...
    public setCount(count: string|null) {
        this.count = count;
        return this;
    }
    public withCount(count: string|null): this {
        this.count = count;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): BigItem|null {
