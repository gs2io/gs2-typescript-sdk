...
export default class DeleteReferenceOfItemSetByStampSheetResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteReferenceOfItemSetByStampSheetResult {
