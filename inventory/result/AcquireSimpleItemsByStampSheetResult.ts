...
export default class AcquireSimpleItemsByStampSheetResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): AcquireSimpleItemsByStampSheetResult {
