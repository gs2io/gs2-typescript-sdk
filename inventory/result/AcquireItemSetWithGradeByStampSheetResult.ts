...
export default class AcquireItemSetWithGradeByStampSheetResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): AcquireItemSetWithGradeByStampSheetResult {
