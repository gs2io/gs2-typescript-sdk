...
export default class GetBigItemByUserIdResult implements IResult {
    ...
    private itemModel: Gs2Inventory.BigItemModel|null = null;
    ...
    public getItemModel(): Gs2Inventory.BigItemModel|null {
        return this.itemModel;
    }

    public setItemModel(itemModel: Gs2Inventory.BigItemModel|null) {
        this.itemModel = itemModel;
        return this;
    }

    public withItemModel(itemModel: Gs2Inventory.BigItemModel|null): this {
        this.itemModel = itemModel;
        return this;
    }

    public static fromDict(data: {[key: string]: any}): GetBigItemByUserIdResult {
