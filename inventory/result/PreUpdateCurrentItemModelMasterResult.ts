...
export default class PreUpdateCurrentItemModelMasterResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): PreUpdateCurrentItemModelMasterResult {
