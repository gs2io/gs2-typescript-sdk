...
export default class DescribeSimpleInventoryModelMastersResult implements IResult {
    private items: Gs2Inventory.SimpleInventoryModelMaster[]|null = null;
    private nextPageToken: string|null = null;

    public getItems(): Gs2Inventory.SimpleInventoryModelMaster[]|null {
        return this.items;
    }

    public setItems(items: Gs2Inventory.SimpleInventoryModelMaster[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Inventory.SimpleInventoryModelMaster[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeSimpleInventoryModelMastersResult {
