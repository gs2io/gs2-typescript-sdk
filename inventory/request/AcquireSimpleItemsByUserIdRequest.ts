...
export default class AcquireSimpleItemsByUserIdRequest implements IRequest {
    ...
    public getAcquireCounts(): Gs2Inventory.AcquireCount[]|null {
        return this.acquireCounts;
    }
    public setAcquireCounts(acquireCounts: Gs2Inventory.AcquireCount[]|null) {
        this.acquireCounts = acquireCounts;
        return this;
    }
    public withAcquireCounts(acquireCounts: Gs2Inventory.AcquireCount[]|null): this {
        this.acquireCounts = acquireCounts;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): AcquireSimpleItemsByUserIdRequest {
    ...
    public toDict(): {[key: string]: any} {
        return {
            ...
            "acquireCounts": this.getAcquireCounts() ?
                this.getAcquireCounts()!.map((item: Gs2Inventory.AcquireCount) => {
                    return item.toDict();
                }
            ) : null,
