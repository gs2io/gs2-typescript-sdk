...
export default class VerifyInventoryCurrentMaxCapacityByStampTaskRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): VerifyInventoryCurrentMaxCapacityByStampTaskRequest {
