...
export default class UpdateSimpleInventoryModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): UpdateSimpleInventoryModelMasterRequest {
