...
export default class VerifyReferenceOfByStampTaskRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): VerifyReferenceOfByStampTaskRequest {
