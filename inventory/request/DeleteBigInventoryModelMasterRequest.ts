...
export default class DeleteBigInventoryModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteBigInventoryModelMasterRequest {
