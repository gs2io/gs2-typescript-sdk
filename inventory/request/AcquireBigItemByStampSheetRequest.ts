...
export default class AcquireBigItemByStampSheetRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): AcquireBigItemByStampSheetRequest {
