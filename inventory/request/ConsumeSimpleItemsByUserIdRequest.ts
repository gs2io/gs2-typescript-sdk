...
export default class ConsumeSimpleItemsByUserIdRequest implements IRequest {
    ...
    private consumeCounts: Gs2Inventory.ConsumeCount[]|null = null;
    ...
    public getConsumeCounts(): Gs2Inventory.ConsumeCount[]|null {
        return this.consumeCounts;
    }
    public setConsumeCounts(consumeCounts: Gs2Inventory.ConsumeCount[]|null) {
        this.consumeCounts = consumeCounts;
        return this;
    }
    public withConsumeCounts(consumeCounts: Gs2Inventory.ConsumeCount[]|null): this {
        this.consumeCounts = consumeCounts;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): ConsumeSimpleItemsByUserIdRequest {
