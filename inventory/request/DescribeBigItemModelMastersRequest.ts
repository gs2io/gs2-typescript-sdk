...
export default class DescribeBigItemModelMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeBigItemModelMastersRequest {
