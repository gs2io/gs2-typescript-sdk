...
export default class CreateInventoryModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): CreateInventoryModelMasterRequest {
