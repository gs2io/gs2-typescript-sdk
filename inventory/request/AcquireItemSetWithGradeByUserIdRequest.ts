...
export default class AcquireItemSetWithGradeByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): AcquireItemSetWithGradeByUserIdRequest {
