...
export default class AcquireItemSetByStampSheetRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): AcquireItemSetByStampSheetRequest {
