...
export default class VerifySimpleItemByStampTaskRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): VerifySimpleItemByStampTaskRequest {
