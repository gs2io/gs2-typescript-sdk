...
export default class GetSimpleItemWithSignatureRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetSimpleItemWithSignatureRequest {
