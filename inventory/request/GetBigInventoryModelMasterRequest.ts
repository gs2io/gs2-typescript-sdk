...
export default class GetBigInventoryModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetBigInventoryModelMasterRequest {
