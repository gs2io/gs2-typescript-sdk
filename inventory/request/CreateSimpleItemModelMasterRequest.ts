...
export default class CreateSimpleItemModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): CreateSimpleItemModelMasterRequest {
