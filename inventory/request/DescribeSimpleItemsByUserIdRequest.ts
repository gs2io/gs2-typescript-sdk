...
export default class DescribeSimpleItemsByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeSimpleItemsByUserIdRequest {
