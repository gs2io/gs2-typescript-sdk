...
export default class DescribeBigInventoryModelMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeBigInventoryModelMastersRequest {
