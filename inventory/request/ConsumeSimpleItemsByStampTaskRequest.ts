...
export default class ConsumeSimpleItemsByStampTaskRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): ConsumeSimpleItemsByStampTaskRequest {
