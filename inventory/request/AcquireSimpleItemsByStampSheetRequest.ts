...
export default class AcquireSimpleItemsByStampSheetRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): AcquireSimpleItemsByStampSheetRequest {
