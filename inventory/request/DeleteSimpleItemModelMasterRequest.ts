...
export default class DeleteSimpleItemModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteSimpleItemModelMasterRequest {
