...
export default class DescribeSimpleInventoryModelMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeSimpleInventoryModelMastersRequest {
