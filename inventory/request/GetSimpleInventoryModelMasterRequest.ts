...
export default class GetSimpleInventoryModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetSimpleInventoryModelMasterRequest {
