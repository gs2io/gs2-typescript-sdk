...
export default class UpdateBigInventoryModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): UpdateBigInventoryModelMasterRequest {
