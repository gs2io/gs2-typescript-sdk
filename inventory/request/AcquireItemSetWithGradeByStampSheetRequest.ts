...
export default class AcquireItemSetWithGradeByStampSheetRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): AcquireItemSetWithGradeByStampSheetRequest {
