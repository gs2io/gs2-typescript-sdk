...
export default class AddReferenceOfItemSetByStampSheetRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): AddReferenceOfItemSetByStampSheetRequest {
