...
export default class GetSimpleItemWithSignatureByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetSimpleItemWithSignatureByUserIdRequest {
