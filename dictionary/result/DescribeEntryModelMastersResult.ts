...
export default class DescribeEntryModelMastersResult implements IResult {
    ...
    public getItems(): Gs2Dictionary.EntryModelMaster[]|null {
        return this.items;
    }

    public setItems(items: Gs2Dictionary.EntryModelMaster[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Dictionary.EntryModelMaster[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeEntryModelMastersResult {
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2Dictionary.EntryModelMaster) => {
                    return item.toDict();
                }
            ) : [],
