...
export default class GetEntryWithSignatureByUserIdResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): GetEntryWithSignatureByUserIdResult {
