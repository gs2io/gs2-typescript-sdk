...
var Gs2DictionaryRestClient = /** @class */ (function (_super) {
    ...
    Gs2DictionaryRestClient.prototype.getNamespaceStatus = function (request) {
        var _a, _b, _c, _d;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/{namespaceName}/status')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region)
    ...
    Gs2DictionaryRestClient.prototype.getServiceVersion = function (request) {
        var _a, _b;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/system/version')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region);
        var headers = this.createAuthorizedHeaders();
        if (request.getRequestId()) {
    ...
    Gs2DictionaryRestClient.prototype.dumpUserDataByUserId = function (request) {
        var _a, _b, _c, _d, _e;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/system/dump/user/{userId}')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region)
    ...
    Gs2DictionaryRestClient.prototype.cleanUserDataByUserId = function (request) {
        var _a, _b, _c, _d, _e;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/system/clean/user/{userId}')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region)
            .replace('{userId}', String((_b = request.getUserId()) !== null && _b !== void 0 ? _b : 'null') === "" ? "null" : String((_c = request.getUserId()) !== null && _c !== void 0 ? _c : 'null'));
        var headers = this.createAuthorizedHeaders();
    ...
    Gs2DictionaryRestClient.prototype.prepareImportUserDataByUserId = function (request) {
        var _a, _b, _c, _d, _e;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/system/import/user/{userId}/prepare')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region)
            .replace('{userId}', String((_b = request.getUserId()) !== null && _b !== void 0 ? _b : 'null') === "" ? "null" : String((_c = request.getUserId()) !== null && _c !== void 0 ? _c : 'null'));
        var headers = this.createAuthorizedHeaders();
    ...
    Gs2DictionaryRestClient.prototype.importUserDataByUserId = function (request) {
        ...
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/system/import/user/{userId}')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region)
            .replace('{userId}', String((_b = request.getUserId()) !== null && _b !== void 0 ? _b : 'null') === "" ? "null" : String((_c = request.getUserId()) !== null && _c !== void 0 ? _c : 'null'));
        var headers = this.createAuthorizedHeaders();
    ...
    Gs2DictionaryRestClient.prototype.checkImportUserDataByUserId = function (request) {
        ...
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/system/import/user/{userId}/{uploadToken}')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region)
            .replace('{userId}', String((_b = request.getUserId()) !== null && _b !== void 0 ? _b : 'null') === "" ? "null" : String((_c = request.getUserId()) !== null && _c !== void 0 ? _c : 'null'))
    ...
    Gs2DictionaryRestClient.prototype.describeEntryModels = function (request) {
        var _a, _b, _c, _d;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/{namespaceName}/model')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null') === "" ? "null" : String((_c = request.getNamespaceName()) !== null && _c !== void 0 ? _c : 'null'));
        var headers = this.createAuthorizedHeaders();
        ...
        return this.request('GET', url, headers, params, undefined).then(function (data) {
            return Result.DescribeEntryModelsResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.getEntryModel = function (request) {
        var _a, _b, _c, _d, _e, _f;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/{namespaceName}/model/{entryName}')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null') === "" ? "null" : String((_c = request.getNamespaceName()) !== null && _c !== void 0 ? _c : 'null'))
            .replace('{entryName}', String((_d = request.getEntryName()) !== null && _d !== void 0 ? _d : 'null') === "" ? "null" : String((_e = request.getEntryName()) !== null && _e !== void 0 ? _e : 'null'));
        var headers = this.createAuthorizedHeaders();
        if (request.getRequestId()) {
            headers['X-GS2-REQUEST-ID'] = request.getRequestId();
        }
        ...
        return this.request('GET', url, headers, params, undefined).then(function (data) {
            return Result.GetEntryModelResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.describeEntryModelMasters = function (request) {
        var _a, _b, _c, _d, _e, _f, _g;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/{namespaceName}/master/model')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null') === "" ? "null" : String((_c = request.getNamespaceName()) !== null && _c !== void 0 ? _c : 'null'));
        var headers = this.createAuthorizedHeaders();
        ...
        return this.request('GET', url, headers, params, undefined).then(function (data) {
            return Result.DescribeEntryModelMastersResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.createEntryModelMaster = function (request) {
        ...
        return this.request('POST', url, headers, undefined, body).then(function (data) {
            return Result.CreateEntryModelMasterResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.getEntryModelMaster = function (request) {
        var _a, _b, _c, _d, _e, _f;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/{namespaceName}/master/model/{entryName}')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null') === "" ? "null" : String((_c = request.getNamespaceName()) !== null && _c !== void 0 ? _c : 'null'))
            .replace('{entryName}', String((_d = request.getEntryName()) !== null && _d !== void 0 ? _d : 'null') === "" ? "null" : String((_e = request.getEntryName()) !== null && _e !== void 0 ? _e : 'null'));
        ...
        return this.request('GET', url, headers, params, undefined).then(function (data) {
            return Result.GetEntryModelMasterResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.updateEntryModelMaster = function (request) {
        ...
        return this.request('PUT', url, headers, undefined, body).then(function (data) {
            return Result.UpdateEntryModelMasterResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.deleteEntryModelMaster = function (request) {
        ...
        return this.request('DELETE', url, headers, params, undefined).then(function (data) {
            return Result.DeleteEntryModelMasterResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.describeEntries = function (request) {
        var _a, _b, _c, _d, _e, _f, _g;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/{namespaceName}/user/me/entry')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null') === "" ? "null" : String((_c = request.getNamespaceName()) !== null && _c !== void 0 ? _c : 'null'));
        var headers = this.createAuthorizedHeaders();
        ...
        return this.request('GET', url, headers, params, undefined).then(function (data) {
            return Result.DescribeEntriesResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.describeEntriesByUserId = function (request) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/{namespaceName}/user/{userId}/entry')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null') === "" ? "null" : String((_c = request.getNamespaceName()) !== null && _c !== void 0 ? _c : 'null'))
        ...
        return this.request('GET', url, headers, params, undefined).then(function (data) {
            return Result.DescribeEntriesByUserIdResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.addEntriesByUserId = function (request) {
        ...
        var body = {
            ...
            'entryModelNames': (_j = request.getEntryModelNames()) !== null && _j !== void 0 ? _j : null,
        };
        return this.request('POST', url, headers, undefined, body).then(function (data) {
            return Result.AddEntriesByUserIdResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.getEntry = function (request) {
        var _a, _b, _c, _d, _e, _f, _g;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/{namespaceName}/user/me/entry/{entryModelName}')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null') === "" ? "null" : String((_c = request.getNamespaceName()) !== null && _c !== void 0 ? _c : 'null'))
            .replace('{entryModelName}', String((_d = request.getEntryModelName()) !== null && _d !== void 0 ? _d : 'null') === "" ? "null" : String((_e = request.getEntryModelName()) !== null && _e !== void 0 ? _e : 'null'));
        var headers = this.createAuthorizedHeaders();
        if (request.getRequestId()) {
            headers['X-GS2-REQUEST-ID'] = request.getRequestId();
        }
        ...
        return this.request('GET', url, headers, params, undefined).then(function (data) {
            return Result.GetEntryResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.getEntryByUserId = function (request) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/{namespaceName}/user/{userId}/entry/{entryModelName}')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null') === "" ? "null" : String((_c = request.getNamespaceName()) !== null && _c !== void 0 ? _c : 'null'))
            .replace('{userId}', String((_d = request.getUserId()) !== null && _d !== void 0 ? _d : 'null') === "" ? "null" : String((_e = request.getUserId()) !== null && _e !== void 0 ? _e : 'null'))
            .replace('{entryModelName}', String((_f = request.getEntryModelName()) !== null && _f !== void 0 ? _f : 'null') === "" ? "null" : String((_g = request.getEntryModelName()) !== null && _g !== void 0 ? _g : 'null'));
        var headers = this.createAuthorizedHeaders();
        if (request.getRequestId()) {
            headers['X-GS2-REQUEST-ID'] = request.getRequestId();
        }
        ...
        return this.request('GET', url, headers, params, undefined).then(function (data) {
            return Result.GetEntryByUserIdResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.getEntryWithSignature = function (request) {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/{namespaceName}/user/me/entry/{entryModelName}/signature')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null') === "" ? "null" : String((_c = request.getNamespaceName()) !== null && _c !== void 0 ? _c : 'null'))
            .replace('{entryModelName}', String((_d = request.getEntryModelName()) !== null && _d !== void 0 ? _d : 'null') === "" ? "null" : String((_e = request.getEntryModelName()) !== null && _e !== void 0 ? _e : 'null'));
        ...
        return this.request('GET', url, headers, params, undefined).then(function (data) {
            return Result.GetEntryWithSignatureResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.getEntryWithSignatureByUserId = function (request) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/{namespaceName}/user/{userId}/entry/{entryModelName}/signature')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null') === "" ? "null" : String((_c = request.getNamespaceName()) !== null && _c !== void 0 ? _c : 'null'))
            .replace('{userId}', String((_d = request.getUserId()) !== null && _d !== void 0 ? _d : 'null') === "" ? "null" : String((_e = request.getUserId()) !== null && _e !== void 0 ? _e : 'null'))
        ...
        return this.request('GET', url, headers, params, undefined).then(function (data) {
            return Result.GetEntryWithSignatureByUserIdResult.fromDict(data);
        });
    };
    ...
    Gs2DictionaryRestClient.prototype.verifyEntry = function (request) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/{namespaceName}/user/me/entry/{entryModelName}/verify/{verifyType}')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null') === "" ? "null" : String((_c = request.getNamespaceName()) !== null && _c !== void 0 ? _c : 'null'))
            .replace('{entryModelName}', String((_d = request.getEntryModelName()) !== null && _d !== void 0 ? _d : 'null') === "" ? "null" : String((_e = request.getEntryModelName()) !== null && _e !== void 0 ? _e : 'null'))
        ...
        return this.request('POST', url, headers, undefined, body).then(function (data) {
            return Result.VerifyEntryResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.verifyEntryByUserId = function (request) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/{namespaceName}/user/{userId}/entry/{entryModelName}/verify/{verifyType}')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null') === "" ? "null" : String((_c = request.getNamespaceName()) !== null && _c !== void 0 ? _c : 'null'))
            .replace('{userId}', String((_d = request.getUserId()) !== null && _d !== void 0 ? _d : 'null') === "" ? "null" : String((_e = request.getUserId()) !== null && _e !== void 0 ? _e : 'null'))
        ...
        return this.request('POST', url, headers, undefined, body).then(function (data) {
            return Result.VerifyEntryByUserIdResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.deleteEntries = function (request) {
        var _a, _b, _c, _d, _e, _f, _g;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/{namespaceName}/user/me/entry/delete')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null') === "" ? "null" : String((_c = request.getNamespaceName()) !== null && _c !== void 0 ? _c : 'null'));
        var headers = this.createAuthorizedHeaders();
        ...
        return this.request('POST', url, headers, undefined, body).then(function (data) {
            return Result.DeleteEntriesResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.deleteEntriesByUserId = function (request) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/{namespaceName}/user/{userId}/entry/delete')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null') === "" ? "null" : String((_c = request.getNamespaceName()) !== null && _c !== void 0 ? _c : 'null'))
            .replace('{userId}', String((_d = request.getUserId()) !== null && _d !== void 0 ? _d : 'null') === "" ? "null" : String((_e = request.getUserId()) !== null && _e !== void 0 ? _e : 'null'));
        ...
        return this.request('POST', url, headers, undefined, body).then(function (data) {
            return Result.DeleteEntriesByUserIdResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.addEntriesByStampSheet = function (request) {
        var _a, _b, _c, _d;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/stamp/entry/add')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region);
        var headers = this.createAuthorizedHeaders();
        if (request.getRequestId()) {
        ...
        return this.request('POST', url, headers, undefined, body).then(function (data) {
            return Result.AddEntriesByStampSheetResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.deleteEntriesByStampTask = function (request) {
        var _a, _b, _c, _d;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/stamp/entry/delete')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region);
        var headers = this.createAuthorizedHeaders();
        if (request.getRequestId()) {
        ...
        return this.request('POST', url, headers, undefined, body).then(function (data) {
            return Result.DeleteEntriesByStampTaskResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.verifyEntryByStampTask = function (request) {
        var _a, _b, _c, _d;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/stamp/entry/verify')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region);
        var headers = this.createAuthorizedHeaders();
        if (request.getRequestId()) {
        ...
        return this.request('POST', url, headers, undefined, body).then(function (data) {
            return Result.VerifyEntryByStampTaskResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.describeLikes = function (request) {
        var _a, _b, _c, _d, _e, _f, _g;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/{namespaceName}/user/me/like')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null') === "" ? "null" : String((_c = request.getNamespaceName()) !== null && _c !== void 0 ? _c : 'null'));
        var headers = this.createAuthorizedHeaders();
        ...
        return this.request('GET', url, headers, params, undefined).then(function (data) {
            return Result.DescribeLikesResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.describeLikesByUserId = function (request) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/{namespaceName}/user/{userId}/like')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null') === "" ? "null" : String((_c = request.getNamespaceName()) !== null && _c !== void 0 ? _c : 'null'))
            .replace('{userId}', String((_d = request.getUserId()) !== null && _d !== void 0 ? _d : 'null') === "" ? "null" : String((_e = request.getUserId()) !== null && _e !== void 0 ? _e : 'null'));
        ...
        return this.request('GET', url, headers, params, undefined).then(function (data) {
            return Result.DescribeLikesByUserIdResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.addLikes = function (request) {
        ...
        return this.request('POST', url, headers, undefined, body).then(function (data) {
            return Result.AddLikesResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.addLikesByUserId = function (request) {
        ...
        return this.request('POST', url, headers, undefined, body).then(function (data) {
            return Result.AddLikesByUserIdResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.getLike = function (request) {
        var _a, _b, _c, _d, _e, _f, _g;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/{namespaceName}/user/me/like/{entryModelName}')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null') === "" ? "null" : String((_c = request.getNamespaceName()) !== null && _c !== void 0 ? _c : 'null'))
            .replace('{entryModelName}', String((_d = request.getEntryModelName()) !== null && _d !== void 0 ? _d : 'null') === "" ? "null" : String((_e = request.getEntryModelName()) !== null && _e !== void 0 ? _e : 'null'));
        ...
        return this.request('GET', url, headers, params, undefined).then(function (data) {
            return Result.GetLikeResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.getLikeByUserId = function (request) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/{namespaceName}/user/{userId}/like/{entryModelName}')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null') === "" ? "null" : String((_c = request.getNamespaceName()) !== null && _c !== void 0 ? _c : 'null'))
            .replace('{userId}', String((_d = request.getUserId()) !== null && _d !== void 0 ? _d : 'null') === "" ? "null" : String((_e = request.getUserId()) !== null && _e !== void 0 ? _e : 'null'))
        ...
        return this.request('GET', url, headers, params, undefined).then(function (data) {
            return Result.GetLikeByUserIdResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.resetLikes = function (request) {
        ...
        return this.request('DELETE', url, headers, params, undefined).then(function (data) {
            return Result.ResetLikesResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.resetLikesByUserId = function (request) {
        ...
        return this.request('DELETE', url, headers, params, undefined).then(function (data) {
            return Result.ResetLikesByUserIdResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.deleteLikes = function (request) {
        var _a, _b, _c, _d, _e, _f, _g;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/{namespaceName}/user/me/like/delete')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null') === "" ? "null" : String((_c = request.getNamespaceName()) !== null && _c !== void 0 ? _c : 'null'));
        var headers = this.createAuthorizedHeaders();
        ...
        return this.request('POST', url, headers, undefined, body).then(function (data) {
            return Result.DeleteLikesResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.deleteLikesByUserId = function (request) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/{namespaceName}/user/{userId}/like/delete')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null') === "" ? "null" : String((_c = request.getNamespaceName()) !== null && _c !== void 0 ? _c : 'null'))
            .replace('{userId}', String((_d = request.getUserId()) !== null && _d !== void 0 ? _d : 'null') === "" ? "null" : String((_e = request.getUserId()) !== null && _e !== void 0 ? _e : 'null'));
        ...
        return this.request('POST', url, headers, undefined, body).then(function (data) {
            return Result.DeleteLikesByUserIdResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.exportMaster = function (request) {
        var _a, _b, _c, _d;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/{namespaceName}/master/export')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null') === "" ? "null" : String((_c = request.getNamespaceName()) !== null && _c !== void 0 ? _c : 'null'));
        var headers = this.createAuthorizedHeaders();
    ...
    Gs2DictionaryRestClient.prototype.getCurrentEntryMaster = function (request) {
        var _a, _b, _c, _d;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/{namespaceName}/master')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null') === "" ? "null" : String((_c = request.getNamespaceName()) !== null && _c !== void 0 ? _c : 'null'));
        var headers = this.createAuthorizedHeaders();
        ...
        return this.request('GET', url, headers, params, undefined).then(function (data) {
            return Result.GetCurrentEntryMasterResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.preUpdateCurrentEntryMaster = function (request) {
        var _a, _b, _c, _d;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/{namespaceName}/master')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region)
        ...
        return this.request('POST', url, headers, undefined, body).then(function (data) {
            return Result.PreUpdateCurrentEntryMasterResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.updateCurrentEntryMaster = function (request) {
        ...
        return this.request('PUT', url, headers, undefined, body).then(function (data) {
            return Result.UpdateCurrentEntryMasterResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.prototype.updateCurrentEntryMasterFromGitHub = function (request) {
        var _a, _b, _c, _d, _e, _f;
        var url = (((_a = Gs2DictionaryRestClient.ENDPOINT_HOST) !== null && _a !== void 0 ? _a : model_1.Gs2Constant.ENDPOINT_HOST) + '/{namespaceName}/master/from_git_hub')
            .replace('{service}', 'dictionary')
            .replace('{region}', this.session.region)
            .replace('{namespaceName}', String((_b = request.getNamespaceName()) !== null && _b !== void 0 ? _b : 'null') === "" ? "null" : String((_c = request.getNamespaceName()) !== null && _c !== void 0 ? _c : 'null'));
        var headers = this.createAuthorizedHeaders();
        ...
        return this.request('PUT', url, headers, undefined, body).then(function (data) {
            return Result.UpdateCurrentEntryMasterFromGitHubResult.fromDict(data);
        });
    };
    Gs2DictionaryRestClient.ENDPOINT_HOST = null;
