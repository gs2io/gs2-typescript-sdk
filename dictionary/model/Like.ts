...
const grnFormat: string = "grn:gs2:{region}:{ownerId}:dictionary:{namespaceName}:user:{userId}:like:{entryModelName}";

export default class Like implements IModel {
    private likeId: string|null = null;
    ...
    public getLikeId(): string|null {
        return this.likeId;
    }
    public setLikeId(likeId: string|null) {
        this.likeId = likeId;
        return this;
    }
    public withLikeId(likeId: string|null): this {
        this.likeId = likeId;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): Like|null {
