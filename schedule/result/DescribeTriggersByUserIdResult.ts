...
export default class DescribeTriggersByUserIdResult implements IResult {
    ...
    public getItems(): Gs2Schedule.Trigger[]|null {
        return this.items;
    }

    public setItems(items: Gs2Schedule.Trigger[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Schedule.Trigger[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeTriggersByUserIdResult {
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2Schedule.Trigger) => {
                    return item.toDict();
                }
            ) : [],
