...
const grnFormat: string = "grn:gs2:{region}:{ownerId}:megaField:{namespaceName}:master:area:{areaModelName}";

export default class AreaModelMaster implements IModel {
    private areaModelMasterId: string|null = null;
    ...
    public getAreaModelMasterId(): string|null {
        return this.areaModelMasterId;
    }
    public setAreaModelMasterId(areaModelMasterId: string|null) {
        this.areaModelMasterId = areaModelMasterId;
        return this;
    }
    public withAreaModelMasterId(areaModelMasterId: string|null): this {
        this.areaModelMasterId = areaModelMasterId;
        return this;
    }
