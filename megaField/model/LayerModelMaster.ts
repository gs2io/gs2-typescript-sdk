...
export default class LayerModelMaster implements IModel {
    private layerModelMasterId: string|null = null;
    ...
    public getLayerModelMasterId(): string|null {
        return this.layerModelMasterId;
    }
    public setLayerModelMasterId(layerModelMasterId: string|null) {
        this.layerModelMasterId = layerModelMasterId;
        return this;
    }
    public withLayerModelMasterId(layerModelMasterId: string|null): this {
        this.layerModelMasterId = layerModelMasterId;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): LayerModelMaster|null {
