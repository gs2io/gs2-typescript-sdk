...
export default class DescribeNamespacesResult implements IResult {
    private items: Gs2MegaField.Namespace[]|null = null;
    private nextPageToken: string|null = null;

    public getItems(): Gs2MegaField.Namespace[]|null {
        return this.items;
    }

    public setItems(items: Gs2MegaField.Namespace[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2MegaField.Namespace[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2MegaField.Namespace) => {
                    return item.toDict();
                }
            ) : null,
