...
export default class DescribeUsersResult implements IResult {
    ...
    public getItems(): Gs2Identifier.User[]|null {
        return this.items;
    }

    public setItems(items: Gs2Identifier.User[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Identifier.User[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeUsersResult {
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2Identifier.User) => {
                    return item.toDict();
                }
            ) : null,
