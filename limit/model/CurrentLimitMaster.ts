...
const grnFormat: string = "grn:gs2:{region}:{ownerId}:limit:{namespaceName}";

export default class CurrentLimitMaster implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): CurrentLimitMaster|null {
