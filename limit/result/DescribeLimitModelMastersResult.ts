...
export default class DescribeLimitModelMastersResult implements IResult {
    private items: Gs2Limit.LimitModelMaster[]|null = null;
    private nextPageToken: string|null = null;

    public getItems(): Gs2Limit.LimitModelMaster[]|null {
        return this.items;
    }

    public setItems(items: Gs2Limit.LimitModelMaster[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Limit.LimitModelMaster[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeLimitModelMastersResult {
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2Limit.LimitModelMaster) => {
                    return item.toDict();
                }
            ) : null,
