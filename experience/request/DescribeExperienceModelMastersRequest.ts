...
export default class DescribeExperienceModelMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeExperienceModelMastersRequest {
