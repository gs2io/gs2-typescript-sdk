...
export default class MultiplyAcquireActionsByUserIdRequest implements IRequest {
    ...
    public getAcquireActions(): Gs2Experience.AcquireAction[]|null {
        return this.acquireActions;
    }
    public setAcquireActions(acquireActions: Gs2Experience.AcquireAction[]|null) {
        this.acquireActions = acquireActions;
        return this;
    }
    public withAcquireActions(acquireActions: Gs2Experience.AcquireAction[]|null): this {
        this.acquireActions = acquireActions;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): MultiplyAcquireActionsByUserIdRequest {
