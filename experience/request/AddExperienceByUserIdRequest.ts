...
export default class AddExperienceByUserIdRequest implements IRequest {
    ...
    public getTruncateExperienceWhenRankUp(): boolean|null {
        return this.truncateExperienceWhenRankUp;
    }
    public setTruncateExperienceWhenRankUp(truncateExperienceWhenRankUp: boolean|null) {
        this.truncateExperienceWhenRankUp = truncateExperienceWhenRankUp;
        return this;
    }
    public withTruncateExperienceWhenRankUp(truncateExperienceWhenRankUp: boolean|null): this {
        this.truncateExperienceWhenRankUp = truncateExperienceWhenRankUp;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): AddExperienceByUserIdRequest {
