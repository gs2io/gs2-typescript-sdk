...
export default class UpdateCurrentExperienceMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): UpdateCurrentExperienceMasterRequest {
