...
export default class DeleteThresholdMasterRequest implements IRequest {

    private requestId: string|null = null;
    private contextStack: string|null = null;
    private namespaceName: string|null = null;
    private thresholdName: string|null = null;
    ...
    public static fromDict(data: {[key: string]: any}): DeleteThresholdMasterRequest {
