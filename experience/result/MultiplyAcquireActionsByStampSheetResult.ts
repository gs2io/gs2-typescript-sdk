...
export default class MultiplyAcquireActionsByStampSheetResult implements IResult {
    private items: Gs2Experience.AcquireAction[]|null = null;
    ...
    public getItems(): Gs2Experience.AcquireAction[]|null {
        return this.items;
    }

    public setItems(items: Gs2Experience.AcquireAction[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Experience.AcquireAction[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): MultiplyAcquireActionsByStampSheetResult {
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2Experience.AcquireAction) => {
                    return item.toDict();
                }
            ) : [],
