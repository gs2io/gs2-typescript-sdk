...
export default class DeleteThresholdMasterResult implements IResult {
    ...
    public setItem(item: Gs2Experience.ThresholdMaster|null) {
        this.item = item;
        return this;
    }

    public withItem(item: Gs2Experience.ThresholdMaster|null): this {
        this.item = item;
        return this;
    }

    public static fromDict(data: {[key: string]: any}): DeleteThresholdMasterResult {
