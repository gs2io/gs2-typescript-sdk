...
export default class DescribeFormModelMastersResult implements IResult {
    ...
    public getItems(): Gs2Formation.FormModelMaster[]|null {
        return this.items;
    }

    public setItems(items: Gs2Formation.FormModelMaster[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Formation.FormModelMaster[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeFormModelMastersResult {
