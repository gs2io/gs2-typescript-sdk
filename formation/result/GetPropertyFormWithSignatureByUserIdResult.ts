...
export default class GetPropertyFormWithSignatureByUserIdResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): GetPropertyFormWithSignatureByUserIdResult {
