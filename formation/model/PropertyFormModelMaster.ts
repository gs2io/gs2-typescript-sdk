...
export default class PropertyFormModelMaster implements IModel {
    private propertyFormModelId: string|null = null;
    ...
    public getPropertyFormModelId(): string|null {
        return this.propertyFormModelId;
    }
    public setPropertyFormModelId(propertyFormModelId: string|null) {
        this.propertyFormModelId = propertyFormModelId;
        return this;
    }
    public withPropertyFormModelId(propertyFormModelId: string|null): this {
        this.propertyFormModelId = propertyFormModelId;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): PropertyFormModelMaster|null {
