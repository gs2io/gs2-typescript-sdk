...
export default class CreatePropertyFormModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): CreatePropertyFormModelMasterRequest {
