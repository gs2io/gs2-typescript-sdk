...
export default class GetPropertyFormModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetPropertyFormModelMasterRequest {
