...
export default class DeletePropertyFormByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DeletePropertyFormByUserIdRequest {
