...
export default class AcquireActionToFormPropertiesByStampSheetRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): AcquireActionToFormPropertiesByStampSheetRequest {
