...
export default class DescribePropertyFormModelMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribePropertyFormModelMastersRequest {
