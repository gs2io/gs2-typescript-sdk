...
export default class DescribeClusterRankingScoresRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeClusterRankingScoresRequest {
