...
export default class DescribeSubscribeRankingsByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeSubscribeRankingsByUserIdRequest {
