...
export default class CreateClusterRankingReceivedRewardByStampTaskRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): CreateClusterRankingReceivedRewardByStampTaskRequest {
