...
export default class GetClusterRankingReceivedRewardRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetClusterRankingReceivedRewardRequest {
