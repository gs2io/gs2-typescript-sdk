...
export default class GetGlobalRankingScoreByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetGlobalRankingScoreByUserIdRequest {
