...
export default class DeleteGlobalRankingScoreByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteGlobalRankingScoreByUserIdRequest {
