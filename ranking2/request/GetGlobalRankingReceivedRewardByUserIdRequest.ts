...
export default class GetGlobalRankingReceivedRewardByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetGlobalRankingReceivedRewardByUserIdRequest {
