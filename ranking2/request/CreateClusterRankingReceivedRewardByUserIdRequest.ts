...
export default class CreateClusterRankingReceivedRewardByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): CreateClusterRankingReceivedRewardByUserIdRequest {
