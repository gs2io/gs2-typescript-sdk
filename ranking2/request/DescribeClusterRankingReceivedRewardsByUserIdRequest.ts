...
export default class DescribeClusterRankingReceivedRewardsByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeClusterRankingReceivedRewardsByUserIdRequest {
