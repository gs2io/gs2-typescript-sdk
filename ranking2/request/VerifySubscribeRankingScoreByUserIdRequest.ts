...
export default class VerifySubscribeRankingScoreByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): VerifySubscribeRankingScoreByUserIdRequest {
