...
export default class GetSubscribeRankingModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetSubscribeRankingModelMasterRequest {
