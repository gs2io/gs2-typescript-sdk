...
export default class DescribeGlobalRankingsByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeGlobalRankingsByUserIdRequest {
