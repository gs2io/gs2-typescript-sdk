...
export default class GetSubscribeRankingScoreByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetSubscribeRankingScoreByUserIdRequest {
