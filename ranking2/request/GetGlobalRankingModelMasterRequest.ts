...
export default class GetGlobalRankingModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetGlobalRankingModelMasterRequest {
