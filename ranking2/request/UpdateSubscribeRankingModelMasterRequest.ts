...
export default class UpdateSubscribeRankingModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): UpdateSubscribeRankingModelMasterRequest {
