...
export default class DescribeGlobalRankingReceivedRewardsRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeGlobalRankingReceivedRewardsRequest {
