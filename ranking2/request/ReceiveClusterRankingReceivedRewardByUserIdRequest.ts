...
export default class ReceiveClusterRankingReceivedRewardByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): ReceiveClusterRankingReceivedRewardByUserIdRequest {
