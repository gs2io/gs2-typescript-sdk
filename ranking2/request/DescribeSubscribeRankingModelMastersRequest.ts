...
export default class DescribeSubscribeRankingModelMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeSubscribeRankingModelMastersRequest {
