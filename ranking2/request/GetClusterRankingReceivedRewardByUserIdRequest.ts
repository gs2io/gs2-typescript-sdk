...
export default class GetClusterRankingReceivedRewardByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetClusterRankingReceivedRewardByUserIdRequest {
