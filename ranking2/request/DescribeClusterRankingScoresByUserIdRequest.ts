...
export default class DescribeClusterRankingScoresByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeClusterRankingScoresByUserIdRequest {
