...
export default class DescribeGlobalRankingModelMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeGlobalRankingModelMastersRequest {
