...
export default class DescribeSubscribeRankingScoresByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeSubscribeRankingScoresByUserIdRequest {
