...
export default class DescribeSubscribeRankingScoresRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeSubscribeRankingScoresRequest {
