...
export default class CreateGlobalRankingModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): CreateGlobalRankingModelMasterRequest {
