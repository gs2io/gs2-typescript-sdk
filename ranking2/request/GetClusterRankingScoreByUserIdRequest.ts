...
export default class GetClusterRankingScoreByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetClusterRankingScoreByUserIdRequest {
