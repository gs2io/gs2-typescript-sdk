...
export default class DescribeGlobalRankingScoresRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeGlobalRankingScoresRequest {
