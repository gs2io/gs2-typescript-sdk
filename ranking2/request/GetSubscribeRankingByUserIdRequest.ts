...
export default class GetSubscribeRankingByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetSubscribeRankingByUserIdRequest {
