...
export default class VerifyClusterRankingScoreByStampTaskRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): VerifyClusterRankingScoreByStampTaskRequest {
