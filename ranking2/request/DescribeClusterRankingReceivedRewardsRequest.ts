...
export default class DescribeClusterRankingReceivedRewardsRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeClusterRankingReceivedRewardsRequest {
