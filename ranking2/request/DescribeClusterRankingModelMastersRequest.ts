...
export default class DescribeClusterRankingModelMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeClusterRankingModelMastersRequest {
