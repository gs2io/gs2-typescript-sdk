...
export default class DeleteClusterRankingReceivedRewardByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteClusterRankingReceivedRewardByUserIdRequest {
