...
export default class VerifyGlobalRankingScoreByStampTaskRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): VerifyGlobalRankingScoreByStampTaskRequest {
