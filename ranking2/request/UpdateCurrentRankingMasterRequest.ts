...
export default class UpdateCurrentRankingMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): UpdateCurrentRankingMasterRequest {
