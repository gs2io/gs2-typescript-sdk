...
export default class CreateGlobalRankingReceivedRewardRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): CreateGlobalRankingReceivedRewardRequest {
