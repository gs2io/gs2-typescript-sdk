...
export default class DeleteSubscribeRankingModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteSubscribeRankingModelMasterRequest {
