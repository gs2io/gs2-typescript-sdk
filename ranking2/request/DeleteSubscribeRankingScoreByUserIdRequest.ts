...
export default class DeleteSubscribeRankingScoreByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteSubscribeRankingScoreByUserIdRequest {
