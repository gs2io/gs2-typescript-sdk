...
export default class DescribeGlobalRankingReceivedRewardsByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeGlobalRankingReceivedRewardsByUserIdRequest {
