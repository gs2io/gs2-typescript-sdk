...
export default class VerifyGlobalRankingScoreByUserIdRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): VerifyGlobalRankingScoreByUserIdRequest {
