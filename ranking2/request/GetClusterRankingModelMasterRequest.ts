...
export default class GetClusterRankingModelMasterRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): GetClusterRankingModelMasterRequest {
