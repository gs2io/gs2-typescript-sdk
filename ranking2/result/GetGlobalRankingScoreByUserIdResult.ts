...
export default class GetGlobalRankingScoreByUserIdResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): GetGlobalRankingScoreByUserIdResult {
