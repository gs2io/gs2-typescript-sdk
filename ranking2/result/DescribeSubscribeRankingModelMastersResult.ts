...
export default class DescribeSubscribeRankingModelMastersResult implements IResult {
    private items: Gs2Ranking2.SubscribeRankingModelMaster[]|null = null;
    private nextPageToken: string|null = null;

    public getItems(): Gs2Ranking2.SubscribeRankingModelMaster[]|null {
        return this.items;
    }

    public setItems(items: Gs2Ranking2.SubscribeRankingModelMaster[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Ranking2.SubscribeRankingModelMaster[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeSubscribeRankingModelMastersResult {
