...
export default class ReceiveGlobalRankingReceivedRewardByUserIdResult implements IResult {
    private item: Gs2Ranking2.GlobalRankingModel|null = null;
    ...
    public getItem(): Gs2Ranking2.GlobalRankingModel|null {
        return this.item;
    }

    public setItem(item: Gs2Ranking2.GlobalRankingModel|null) {
        this.item = item;
        return this;
    }

    public withItem(item: Gs2Ranking2.GlobalRankingModel|null): this {
        this.item = item;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): ReceiveGlobalRankingReceivedRewardByUserIdResult {
