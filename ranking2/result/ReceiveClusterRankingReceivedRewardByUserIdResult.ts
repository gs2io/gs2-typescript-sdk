...
export default class ReceiveClusterRankingReceivedRewardByUserIdResult implements IResult {
    private item: Gs2Ranking2.ClusterRankingModel|null = null;
    ...
    public getItem(): Gs2Ranking2.ClusterRankingModel|null {
        return this.item;
    }

    public setItem(item: Gs2Ranking2.ClusterRankingModel|null) {
        this.item = item;
        return this;
    }

    public withItem(item: Gs2Ranking2.ClusterRankingModel|null): this {
        this.item = item;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): ReceiveClusterRankingReceivedRewardByUserIdResult {
