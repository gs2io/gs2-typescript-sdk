...
export default class DeleteGlobalRankingScoreByUserIdResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): DeleteGlobalRankingScoreByUserIdResult {
