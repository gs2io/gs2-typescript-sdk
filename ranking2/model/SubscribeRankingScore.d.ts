...
export default class SubscribeRankingScore implements IModel {
    ...
    getSubscribeRankingScoreId(): string | null;
    setSubscribeRankingScoreId(subscribeRankingScoreId: string | null): this;
    withSubscribeRankingScoreId(subscribeRankingScoreId: string | null): this;
