...
const grnFormat: string = "grn:gs2:{region}:{ownerId}:ranking2:{namespaceName}:user:{userId}:cluster:{rankingName}:{clusterName}:{season}:score";

export default class ClusterRankingScore implements IModel {
    private clusterRankingScoreId: string|null = null;
    ...
    public getClusterRankingScoreId(): string|null {
        return this.clusterRankingScoreId;
    }
    public setClusterRankingScoreId(clusterRankingScoreId: string|null) {
        this.clusterRankingScoreId = clusterRankingScoreId;
        return this;
    }
    public withClusterRankingScoreId(clusterRankingScoreId: string|null): this {
        this.clusterRankingScoreId = clusterRankingScoreId;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): ClusterRankingScore|null {
