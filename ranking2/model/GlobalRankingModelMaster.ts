...
const grnFormat: string = "grn:gs2:{region}:{ownerId}:ranking2:{namespaceName}:master:model:global:{rankingName}";
...
export default class GlobalRankingModelMaster implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): GlobalRankingModelMaster|null {
