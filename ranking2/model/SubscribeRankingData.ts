...
export default class SubscribeRankingData implements IModel {
    private subscribeRankingDataId: string|null = null;
    ...
    public getSubscribeRankingDataId(): string|null {
        return this.subscribeRankingDataId;
    }
    public setSubscribeRankingDataId(subscribeRankingDataId: string|null) {
        this.subscribeRankingDataId = subscribeRankingDataId;
        return this;
    }
    public withSubscribeRankingDataId(subscribeRankingDataId: string|null): this {
        this.subscribeRankingDataId = subscribeRankingDataId;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): SubscribeRankingData|null {
