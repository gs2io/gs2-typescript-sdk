...
export default class GlobalRankingReceivedReward implements IModel {
    ...
    getGlobalRankingReceivedRewardId(): string | null;
    setGlobalRankingReceivedRewardId(globalRankingReceivedRewardId: string | null): this;
    withGlobalRankingReceivedRewardId(globalRankingReceivedRewardId: string | null): this;
    ...
    static fromDict(data: {
        [key: string]: any;
    }): GlobalRankingReceivedReward | null;
    toDict(): {
        [key: string]: any;
    };
}
