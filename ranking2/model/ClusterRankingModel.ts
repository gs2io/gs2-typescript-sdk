...
const grnFormat: string = "grn:gs2:{region}:{ownerId}:ranking2:{namespaceName}:cluster:{rankingName}";
...
export default class ClusterRankingModel implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): ClusterRankingModel|null {
