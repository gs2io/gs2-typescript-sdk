...
const grnFormat: string = "grn:gs2:{region}:{ownerId}:ranking2:{namespaceName}:master:model:subscribe:{rankingName}";

export default class SubscribeRankingModelMaster implements IModel {
    ...
    public static fromDict(data: {[key: string]: any}): SubscribeRankingModelMaster|null {
