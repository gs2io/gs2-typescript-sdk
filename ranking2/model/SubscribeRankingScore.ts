...
const grnFormat: string = "grn:gs2:{region}:{ownerId}:ranking2:{namespaceName}:user:{userId}:ranking:subscribe:{rankingName}:{season}:score";

export default class SubscribeRankingScore implements IModel {
    private subscribeRankingScoreId: string|null = null;
    ...
    public getSubscribeRankingScoreId(): string|null {
        return this.subscribeRankingScoreId;
    }
    public setSubscribeRankingScoreId(subscribeRankingScoreId: string|null) {
        this.subscribeRankingScoreId = subscribeRankingScoreId;
        return this;
    }
    public withSubscribeRankingScoreId(subscribeRankingScoreId: string|null): this {
        this.subscribeRankingScoreId = subscribeRankingScoreId;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): SubscribeRankingScore|null {
