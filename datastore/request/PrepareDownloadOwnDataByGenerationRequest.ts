...
export default class PrepareDownloadOwnDataByGenerationRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): PrepareDownloadOwnDataByGenerationRequest {
