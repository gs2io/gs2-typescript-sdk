...
export default class PrepareDownloadByUserIdAndDataObjectNameRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): PrepareDownloadByUserIdAndDataObjectNameRequest {
