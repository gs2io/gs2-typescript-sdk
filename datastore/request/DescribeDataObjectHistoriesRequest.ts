...
export default class DescribeDataObjectHistoriesRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeDataObjectHistoriesRequest {
