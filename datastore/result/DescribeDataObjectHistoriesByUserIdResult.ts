...
export default class DescribeDataObjectHistoriesByUserIdResult implements IResult {
    ...
    public getItems(): Gs2Datastore.DataObjectHistory[]|null {
        return this.items;
    }

    public setItems(items: Gs2Datastore.DataObjectHistory[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Datastore.DataObjectHistory[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): DescribeDataObjectHistoriesByUserIdResult {
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2Datastore.DataObjectHistory) => {
                    return item.toDict();
                }
            ) : null,
