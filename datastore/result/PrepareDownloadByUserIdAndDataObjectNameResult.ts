...
export default class PrepareDownloadByUserIdAndDataObjectNameResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): PrepareDownloadByUserIdAndDataObjectNameResult {
