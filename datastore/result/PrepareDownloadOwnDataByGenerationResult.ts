...
export default class PrepareDownloadOwnDataByGenerationResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): PrepareDownloadOwnDataByGenerationResult {
