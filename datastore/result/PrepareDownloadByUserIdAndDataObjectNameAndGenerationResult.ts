...
export default class PrepareDownloadByUserIdAndDataObjectNameAndGenerationResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): PrepareDownloadByUserIdAndDataObjectNameAndGenerationResult {
