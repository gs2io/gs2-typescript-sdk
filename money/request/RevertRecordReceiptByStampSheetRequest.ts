...
export default class RevertRecordReceiptByStampSheetRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): RevertRecordReceiptByStampSheetRequest {
