...
export default class DescribeNamespacesResult implements IResult {
    private items: Gs2Money.Namespace[]|null = null;
    private nextPageToken: string|null = null;

    public getItems(): Gs2Money.Namespace[]|null {
        return this.items;
    }

    public setItems(items: Gs2Money.Namespace[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Money.Namespace[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2Money.Namespace) => {
                    return item.toDict();
                }
            ) : [],
