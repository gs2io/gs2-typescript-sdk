...
export default class MultiplyAcquireActionsByStampSheetRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): MultiplyAcquireActionsByStampSheetRequest {
