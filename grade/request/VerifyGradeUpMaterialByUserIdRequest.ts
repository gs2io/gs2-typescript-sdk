...
export default class VerifyGradeUpMaterialByUserIdRequest implements IRequest {
    ...
    public getMaterialPropertyId(): string|null {
        return this.materialPropertyId;
    }
    public setMaterialPropertyId(materialPropertyId: string|null) {
        this.materialPropertyId = materialPropertyId;
        return this;
    }
    public withMaterialPropertyId(materialPropertyId: string|null): this {
        this.materialPropertyId = materialPropertyId;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): VerifyGradeUpMaterialByUserIdRequest {
