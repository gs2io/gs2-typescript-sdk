...
export default class MultiplyAcquireActionsByStampSheetResult implements IResult {
    private items: Gs2Grade.AcquireAction[]|null = null;
    ...
    public getItems(): Gs2Grade.AcquireAction[]|null {
        return this.items;
    }

    public setItems(items: Gs2Grade.AcquireAction[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Grade.AcquireAction[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2Grade.AcquireAction) => {
                    return item.toDict();
                }
            ) : [],
