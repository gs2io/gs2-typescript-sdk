...
export default class DescribeStatusesByUserIdResult implements IResult {
    private items: Gs2Grade.Status[]|null = null;
    private nextPageToken: string|null = null;

    public getItems(): Gs2Grade.Status[]|null {
        return this.items;
    }

    public setItems(items: Gs2Grade.Status[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Grade.Status[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2Grade.Status) => {
                    return item.toDict();
                }
            ) : [],
