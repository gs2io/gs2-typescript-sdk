...
export default class BatchReadMessagesByUserIdRequest implements IRequest {
    ...
    private messageNames: string[]|null = null;
    ...
    public getMessageNames(): string[]|null {
        return this.messageNames;
    }
    public setMessageNames(messageNames: string[]|null) {
        this.messageNames = messageNames;
        return this;
    }
    public withMessageNames(messageNames: string[]|null): this {
        this.messageNames = messageNames;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): BatchReadMessagesByUserIdRequest {
        return new BatchReadMessagesByUserIdRequest()
            .withNamespaceName(data["namespaceName"])
            .withUserId(data["userId"])
            .withMessageNames(data.messageNames ?
                data.messageNames.map((item: {[key: string]: any}) => {
                    return item;
                }
            ) : null)
    ...
    public toDict(): {[key: string]: any} {
        return {
            ...
            "messageNames": this.getMessageNames() ?
                this.getMessageNames()!.map((item: string) => {
                    return item;
                }
            ) : null,
