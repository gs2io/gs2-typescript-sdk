...
export default class DescribeGlobalMessageMastersRequest implements IRequest {
    ...
    public static fromDict(data: {[key: string]: any}): DescribeGlobalMessageMastersRequest {
