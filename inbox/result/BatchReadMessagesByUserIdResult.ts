...
export default class BatchReadMessagesByUserIdResult implements IResult {
    ...
    public getItems(): Gs2Inbox.Message[]|null {
        return this.items;
    }

    public setItems(items: Gs2Inbox.Message[]|null) {
        this.items = items;
        return this;
    }

    public withItems(items: Gs2Inbox.Message[]|null): this {
        this.items = items;
        return this;
    }
    ...
    public static fromDict(data: {[key: string]: any}): BatchReadMessagesByUserIdResult {
    ...
    public toDict(): {[key: string]: any} {
        return {
            "items": this.getItems() ?
                this.getItems()!.map((item: Gs2Inbox.Message) => {
                    return item.toDict();
                }
            ) : null,
