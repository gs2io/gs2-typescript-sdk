...
export default class PreUpdateCurrentMessageMasterResult implements IResult {
    ...
    public static fromDict(data: {[key: string]: any}): PreUpdateCurrentMessageMasterResult {
